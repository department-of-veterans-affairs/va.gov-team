...
--- | --- | --- | ---
New auth 1990 form - canonical URL   | /education/apply-for-benefits-form-22-1990/  | Home > Education and training  >  [H1]  |  **URL IS TBD** <br> The canonical URL Is what will be used for entry links to the form.  The form should resolve to the appropriate first page of the form flow (in this case, it would resolve to /introduction/, in the future this could resolve to /start/ if the wizard is relocated to the form flow)
New auth 1990 form - introduction | .../introduction/ | [same]  | 
New auth 1990 form - Applicant Information  |  | [same]  | 
New auth 1990 form - Contact Information  |  | [same]  | 
New auth 1990 form - Contact Information  |  | [same]  | 
New auth 1990 form - Contact Information  |  | [same]  | 
New auth 1990 form - Service History  |  | [same]  | 
New auth 1990 form - Benefit Selection  |  | [same]  | 
