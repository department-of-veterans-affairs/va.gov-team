...
--- | --- | --- | ---
Static How to apply for COE page | ~~/housing-assistance/home-loans/how-to-apply/~~ <br> /housing-assistance/home-loans/how-to-request-coe/ | Home > Housing assistance > VA-backed home loans > [Page H1] | This is an existing page.  The URL must be modified to reflect the word "request". A redirect will be required. 
