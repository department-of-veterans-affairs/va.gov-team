...
- designed for users to drop a question/note to VA
- put in place in 2003, has grown to support many use cases, 400 backend employees addressing queries and answering questions, 50k inquiries/month
- popular with veterans stationed abroad and those with disabilities
...
- not sure if these will remain 3 separate forms, seems like mhv should be its own form, but looking at IRIS and GI bill forms to bring together but they ask for different info (i.e. GI Bill requires login and stakeholders can't agree)
