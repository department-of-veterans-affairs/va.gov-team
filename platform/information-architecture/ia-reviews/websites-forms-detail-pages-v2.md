...
**Product/Featue:** VA Forms Search Tool Modernization + Forms Detail Pages
...
***This is a revision of the original IA work.  Originally the Forms Search and Forms Detail Pages were separate initiatives and did not connect.  This IA work now reflects a change in UX that makes the detail pages part of the forms search experience.***
...
- All landing pages will have a consistent structured URL that will be dynamically generated from form data. 
  - The form number will be pulled from the forms data and used in the URL preceeded by "/form-"  - exact data field TBD
...
***URL Structure: www.va.gov/find-forms/form-[form-nbr]***

**Breadcrumb** 
- The breadcrumb will have a consistent structured label that is dynamically generated from form data
  - The form number will be pulled from the forms data and used in the breadcrumb preceeded by "Form"
  - Spacing and capitalization will be displayed as it is in the data
  - All characters in the form number coming from the data will be used (i.e. we will not drop extra characters such as "VA") <br>

***Breadcrumb Structure:  Home > Find forms > Form [form number]***
...
No navigational links will be added to these pages, users will access these pages through the Find forms tool, directly through external search and va.gov search.

**User Flows:**  

![image.png](https://images.zenhubusercontent.com/59ca6a73b0222d5de4792f1d/c449c8c0-1311-4265-a2a3-a3e32066663a)

- External search results can/will include a direct link to the online form (preferred), a link to the How to Apply page, a link to the form detail page, a direct link to the pdf (least preferred).
- VA.gov search results can/will include a direct link to the online form (preferred), a link to the How to Apply page, a link to the form detail page, a direct link to the pdf (least preferred).
- The Va.gov Find a Form search tool results will include a direct link to the online form (preferred), a link to the How to Apply page, a direct link to the pdf (least preferred) AND a link to these form detail pages.
