...
- Article titles (H1s) should have a character limit of no more than ~60~ characters  _<--@mikki - we already have a set H1 character limit for articles at 70 max including spaces; this matches the character limit of our section headers (H2s, 3s, etc.)_
