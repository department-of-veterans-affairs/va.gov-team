...
* Issues will be collected as issues in a new ZenHub epic. The accessibility specialist will assign this epic to the program manager (PM) after the audit is complete.
...
* The program manager will email the VA 508 office when their application or content is ready for review. The program manager should notify the VA 508 office by email, and CC their VSP/VFS accessibility specialist. This email will list staging URLs, test user credentials, and any known issues.
* VA 508 office suggestions or defects will be communicated to the program manager who requested the full audit:
...
* VSP/VFS accessibility specialists will work with stakeholders as issues are ready to be re-tested. When an issue has been resolved, the specialist or program manager should close it with a brief comment like _"Issue has been tested, and success criteria met. Moving to close."_
