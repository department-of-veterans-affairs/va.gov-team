...
1. The deaf individual will reply with the standard number displayed on the page, or it will automatically show up on the assistant's screen.
...
1. The other party will usually not know that the deaf or HOH is calling them unless there is a delay in response.
