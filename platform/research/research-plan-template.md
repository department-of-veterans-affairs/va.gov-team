...
### Research questions
<details><summary>Consider bucketing research questions under research goals and think about:</summary>
...
### Hypothesis
<details><summary>What do you intend to learn and measure from this study? Think through these prompts to develop a strong hypothesis.</summary>
...
<details><summary>List the total number and type (Veterans, caregivers, etc.) of participants for this study.</summary>
...
`[Place criteria here between hash marks when in edit mode]`
...
`[Place availability here between hash marks when in edit mode]`
