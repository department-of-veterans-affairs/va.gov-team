...
In order to ensure that KPIs will be tracked for product decisions, please ensure that your KPIs are clearly mapped back to veteran goals/outcomes. W**e highly recommend using the [KPI framework](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/platform/analytics/Analytics%20Playbook/va-gov-platform-analytics-kpi-framework.pdf) to guide your KPI setting.** The product outline template on Github has current guidelines to ensure that your goals are linked back to Findability, Ease of Use, Service Completion, and Trust.
