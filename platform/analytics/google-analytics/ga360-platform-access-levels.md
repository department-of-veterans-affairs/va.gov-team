...
### Find [more information about this topic](https://depo-platform-documentation.scrollhelp.site/analytics-monitoring/Google-Analytics-and-Google-Tag-Manager.1857978529.html) on the Platform website.
...
_Access_: To access Google Analytics, you should have completed VSP orientation or requested access via [#vfs-platform-support](https://dsva.slack.com/channels/vfs-platform-support). Your VA.gov or contractor email address must be [tied to a Google Account](https://accounts.google.com/signup)  before we can provision you with access. 
