...
#### Defining Goals
1. _What is a goal in Google Analytics?_
...
1. _How many goals can each view have?_
...
5. _Where do I find the goals for my product area?_
...
6. _Can I mix events and URLs to form a goal funnel?_
...
7. _From a technical implementation, what happens when a user finishes their form?_ For modernized VA.gov forms, several events are triggered:
...
8. _Should I make my first step required?_ 
...
1. _What happens if a person refreshes their confirmation page in the same session? _
...
2. _Why do I see entrances in the funnel straight to the confirmation page? Does this increment a conversion?_
...
3. _What are other limitations of the goal funnel I should keep in mind for product decisions?_
