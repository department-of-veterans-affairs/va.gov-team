...
Leadership at both the prime contractor and sub contractor companies.
...
* Discrepences in design documentation from Figma, Storybook, and other Drupal tools.
...
* Problems with staffing. Designer was leading research instead of doing design. Designer is currently developing processes on how to work with design instead of designing.
...
* Designer was caught in the middle of trying to complete work, triage work coming in, and manage competing priorities.
...
Low UX maturity makes it difficult for UX to hold their own against many developers. Selling, convincing, and educating can take most of the UX team’s time when they should be spending that time doing design. There has not been the infrastructure in place for them to do design activities, so they need to create a lot of things from scratch. 
...
* Designers need a better understanding of how Drupal works, but explanations from devs is too technical from a Designer’s perspective
    * Ex, Theme, Modules, Content Model, etc
...
* **Better Documentation**
    * An epic has been created for “Create CMS Design-Ops” and any design related process tickets are now being added to this epic as we make new discoveries.
    ...
    * The implementation is being tracked through a spreadsheet that will be updated as we identify new updates and monitor the status of these updates.
...
* **Pre-planning for contract severability**
    ...
    * This information will need to be communicated to the company leadership of the prime and sub contractors to ensure that staffing decisions are fully considered for the project.
    * There is no UX voice for the CMS Team at the prime contractor level. All UX team members are subcontractors for the prime contractor, but all staffing decisions are being made by the prime contractor with very little input given from the people closest to the work.
* **More collaboration amongst our team and with other teams.**
    * Updates are being made to the Collab Flow Documentation and we are currently working on strengthening these processes. There is an epic to ensure that this gets done.
...
* **Improve our agile processes.**
    * Try setting up a monthly meeting with Agile Coach.
...
* A crucial UX role (Design System Specialist) was cut when PTEMS funding was cut.
...
* Until the proper time is given to address design debt and establish CMS design ops processes that will set governance standards, this problem will continue to to grow and become more difficult to fix.
