...
1. If we work closely with new editors from the start (though the content planning group, live training, and close support from Sitewide Content), editors will have an easier time making the transition into using drupal, and their content will be higher quality. 
