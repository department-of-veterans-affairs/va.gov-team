...
CMS content editors tasked with delivering quality, Veteran-centered VA.gov content face many challenges, such as:
- They have to wait to see what their content will look like because the CMS is decoupled from the front end
- Rules and guidelines for their content may be coming from multiple parts of the organization (such as overall content style guidelines as well as product-specific rules) and may be located in multiple locations outside the CMS
