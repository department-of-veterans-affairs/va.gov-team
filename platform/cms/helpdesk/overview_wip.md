...
A javascript widgetized button is embedded on specific pages throughout the CMS that allows Users to create a Case with the Help Desk. Users can track their Case at https://va-gov.atlassian.net/servicedesk/customer/portal/3 
...
All new Cases must be manually entered into the JIRA system often by copying and pasting the related content from the email to a new Case in JIRA.
...
There is currently no real-time, automated notification system to alert Tier 1 when a new Case is created or a User sends an email to the address.

Once a Case enters the Support Channels and is received by Tier 1, Tier 1 is expected to follow the expectation for the Support Channel the Case came through and then follow-up with the User(s) related to the Case with an Initial Response. 

Tier 1’s Initial Response is created by using the “Reply to Customer” feature found at the bottom of the Case notes should be sent no more than 30 minutes after receiving the User’s request. Tier 1’s Initial Response will Acknowledge the User’s issue (often parroting or paraphrasing), Align to the User’s specific situation, and Assure the User the Help Desk is here to help. 

Tier 1 should also ask probing questions to help demonstrate Expertise in the subject matter as well as gather more information to better assist in root cause analysis and in the classification of the severity of the issue.

This should look something similar to, 

> Hello Ero,It looks like you contacted the CMS Help Desk today because of an issue logging into your account over on the Training site for va.gov. You mentioned that you are new to the CMS as well and I can appreciate your eagerness to learn the new tool - we’ve spent a lot of time building it so that our Veteran’s have the best experience with the content you are creating and learning how to use the tools is really important for that to work well! No worries, I’m happy to dive-in here with you. First, I’d like to ask a few questions so that I can get you the best answers and fastest solution, then I’ll put together a quick game plan and for issues like this, we usually have you good-to-go in a few hours but first, can you tell me when the last time you were able to login well was? And, if you recall any new changes to your PC like a software update or …? Thanks for taking the time to dive on those questions, I’ll be looking for your reply and when you do I will review what you share and get back to you right away with those next steps.
>
> Cheers for now,	Tier 1
...
Tier 1 also provides assistance to Training both internally and externally to various requests, and to the various Product Owners and Managers and their various requests as it relates to the CMS. Tier 1 also manages the incoming Support Channel queues by:

Ensure that first responses are delivered to any new Issue between 8:00 a.m. to 8:00 p.m. EST

Any In Progress Issues are being actively worked on and resolved in accordance with the time constraints for the Issue’s Priority. 

Escalate any Issue not in scope by engaging the Slack channel  #cms-product-triagePost the issue to the Slack channel and solicit feedback from Product Owners, Managers, Developers, and Engineers.

Warm Transfer Ownership after gaining agreement on the specific Tier 2 Product Owner, or Manager, Developer, or engineer taking Lead leave notes with that same information on the Case.
...
For any follow-up or clarifying questions Tier 1 may be asked to engage the User or Tier 2 may, Ownership of the Issue does not necessarily absolve Tier 1 from the Issue.
...
[CMS User Management]([https://github.com/department-of-veterans-affairs/va.gov-cms/blob/master/READMES/user_management.md](https://github.com/department-of-veterans-affairs/va.gov-cms/blob/master/READMES/user_management.md))
