...
| Confluence | Sprint reports, demo docs and other team documents are kept in the Agile6 va-gov confluence workspace. Additionally, documentation intended for a Platform-wide audience is kept in the VFS Confluence workspace. | [VAGOV confluence](https://va-gov.atlassian.net/wiki/spaces/VAGOV/overview)[VFS confluence](https://vfs.atlassian.net/wiki/spaces/AP/overview) |
...
| **Sprint priorities & Roadmapping** | Plan the next sprint's priorities with gov't PO and DM, this is also opportunity to talk about upcoming work and collaboratively update the roadmap. | Alternating Thursdays @ 1000 | Mike Chelen | [Zenhub board](https://github.com/department-of-veterans-affairs/va.gov-cms#workspaces/vagov-cms-team-5c0e7b864b5806bc2bfc2087/board?labels=core%20application%20team&repos=154174777) | |
...
| **Content Release PM/PO Sync** | Standing meeting for PMs & POs of team working with CMS content and the CMS Content API to meet and discuss open questions, upcoming changes, scaling required.  | Every 6th Tuesday @ 1430 | Megan Kelly, Dave Conolon, Mike Chelen, Stan Gardner | | [#content-release-engineering](https://dsva.slack.com/archives/C01512KN35G) |
