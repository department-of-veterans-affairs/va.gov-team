...
1. A Security Review, which should happen before development starts
2. A Personally Identifying Information (PII) Review, which should happen early in the development process
3. On-going code reviews in each pull-request. These reviews should happen after the code has been reviewed by another member of your team and before it is merged into the platform
