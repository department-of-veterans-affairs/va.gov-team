...
In a sepearte effort, the code which generates the Facility Banner Alert will be moved from the Metasmith Template to a React Widget.  The React widget will load the JSON file from S3 which was generated by Drupal in the process described above.
