...
*   Not recommended: Production-like builds are required for staging and production environments. NODE_ENV=production environment variable is required to be set when running these build commands
*   Recommended: When running build commands for staging and production environments, set the NODE_ENV=production variable.
...
*   Not recommended: See [Feature toggles](#) for more information.
*   Recommended: For more information, see [Feature toggles](#).
...
*   Not recommended: I love kittens, puppies and bunnies.
*   Recommended: I love kittens, puppies,and bunnies.
...
*   Not recommended: Type your ID, and select OK.
*   Recommended: Type your ID and select OK.
...
*   When a link opens a PDF, YouTube video, XLS or other file format, note that after the link in parentheses. Example: For more information, [download the security features PDF](#).
...
*   Not recommended: Tests will automatically be run against the site running on that server.
*   Recommended: Tests automatically run against the site running on that server.
