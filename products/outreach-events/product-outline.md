...
- I want the capability to provide additional categorical data about events (event category -- health, education, etc.) to help power "filtering" features for users.
