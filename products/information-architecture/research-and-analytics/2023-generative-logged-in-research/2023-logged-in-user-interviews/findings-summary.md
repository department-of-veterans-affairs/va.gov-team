...
## Methodology 
We conducted sessions remotely via Zoom, and asked participants to log into VA.gov to complete tasks. The tasks were a combination of specific tasks based on the participant’s experience with VA, and pre-defined tasks we asked all participants to complete.

## Hypotheses and Conclusions
1. People will struggle finding what they’re looking for if they can’t use the homepage or My VA.
*Somewhat true*
2. People will give up or call VA if they can’t find what they need on the VA.gov.
*Mostly true*
