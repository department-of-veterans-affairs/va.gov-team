...
Header | | Med/Med |  |  | 
Footer | | Med/Med |  | [WIP doc](https://docs.google.com/document/d/1LuLX1dXL01FaCBXDqDmogDgsk50OkmyvPrLk-dl_RMM/edit). [CAIA ticket](https://github.com/department-of-veterans-affairs/va.gov-team/issues/88782) | 
...
Template: Benefit sub-hub | | | Kristin | Should this be a separate template, or a variation on the benefit hub?  Some of these changes will be incorporated into the main hub page.|
...
IA and SEO | [SEO best practices on GH](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/information-architecture/standards/seo-best-practices.md) <br> [Writing for SEO in content styleguide on VADS](https://design.va.gov/content-style-guide/seo) | Low/Low | | Review and determine what is standard to be documented and what is general guidance, determine where each aspect should be documented, format for location appropriately.  Review with OCTO leads for approval. Publish | 
IA and a11y | |  |  | 
