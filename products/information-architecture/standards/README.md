...
--- | --- | --- | --- | --- | ---
URLs | [URL standards in VADS](https://design.va.gov/content-style-guide/url-standards) <br> - [General URL standards (manually curated)](https://design.va.gov/components/url-standards/)
