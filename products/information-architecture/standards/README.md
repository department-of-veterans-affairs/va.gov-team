...
Redirects | [Redirect standards in VADS](https://design.va.gov/components/url-standards/redirects) | --- | Mikki | --- | Review and remove the [GH file on redirect standards](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/information-architecture/standards/redirect-standards.md)
XML sitemap | [Guidance in GH](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/information-architecture/standards/xml-sitemap.md) | | Mikki | | Need to review and update
