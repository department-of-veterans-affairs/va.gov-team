...
Primary navigation** | Probably wont go in VADS, proably will just be our internal guidance. VA healthcare and benefits menu in the header. and the flyout. | Med/Med | Kristin |  | Not Started
Template: [Find a form landing page](https://www.va.gov/find-forms/)* | Internal guidance, not for VADS| Low/Low | Sam | [Draft guidance](https://dvagov-my.sharepoint.com/:w:/g/personal/suzanne_middaugh_va_gov/EaDcyTELxL5Hk7fvpdCcNaABTTtD--NJnOZhW3PU7n86KA?email=Michelle.Northuis%40va.gov&e=Ika3UY) | Not started
Template: About a form detail page* | Internal guidance, not for VADS | Low/Med | Sam | [Draft guidance](https://dvagov-my.sharepoint.com/:w:/g/personal/suzanne_middaugh_va_gov/EaDcyTELxL5Hk7fvpdCcNaABTTtD--NJnOZhW3PU7n86KA?email=Michelle.Northuis%40va.gov&e=Ika3UY) | Not started
Template: Benefit sub-hub |Document current structure for IA use (no VADS).  Will need to determine which aspects may merge with a redesigned hub template. | Med/Med | Kristin | | Not started
Pagination | [Pagination component](https://design.va.gov/components/pagination) Discovery of current usage, any V3 plans, USWDS guidance. Updates intended for VADS| Low/Med | Unassigned|   | Not started
Secondary navigation (left navs) | [Side nav](https://design.va.gov/components/sidenav)Document current state functionality for existing experiences - the different left navs in Benefit hubs vs facilities, and then determine if we can have a standard approach. This might mean making changes to the standard component. | Med/Med| Unassigned |  | Not started
