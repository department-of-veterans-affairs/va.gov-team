...
Template: [Find a form landing page](https://www.va.gov/find-forms/)* | Internal guidance, not for VADS| Low/Low | Sam | [Draft guidance](https://dvagov-my.sharepoint.com/:w:/g/personal/suzanne_middaugh_va_gov/EaDcyTELxL5Hk7fvpdCcNaABTTtD--NJnOZhW3PU7n86KA?email=Michelle.Northuis%40va.gov&e=Ika3UY) | Not started | 11/8 | 12/6 |
...
Template: Benefit sub-hub |Document current structure for IA use (no VADS).  Will need to determine which aspects may merge with a redesigned hub template. | Med/Med | Kristin | | Not started | 11/1 | 11/22 |
