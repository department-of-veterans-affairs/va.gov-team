...
URLs | - [General URL standards (VADS)](https://design.va.gov/components/url-standards/) <br>- [Vanity URLs (VADS)](https://design.va.gov/components/url-standards/#vanity-urls) | - | - | - | [Latest updates communicated out on 9/24/24](https://dsva.slack.com/archives/C0NGDDXME/p1727205735920459)  |- | 
Redirects | - [Redirect guidance](https://design.va.gov/components/url-standards/redirects)<br> - [Platform docs](https://depo-platform-documentation.scrollhelp.site/developer-docs/redirect-implementation-strategies) | - | - | -| [Lastest updates communicated on 8/5/24](https://dsva.slack.com/archives/CE4304QPK/p1722883165574459)  |- | 
Sign-in Widget | | Med/Med | Login team | [CAIA Ticket #78520](https://github.com/department-of-veterans-affairs/va.gov-team/issues/78520) | The login team is taking over documentation - we have feedback.  | -| 
Page titles and title tags | [Page titles](https://design.va.gov/content-style-guide/page-titles-and-section-titles) <br> [Title tags](https://design.va.gov/content-style-guide/title-tags) | -| - |- | [Last updates communicated 9/24/24](https://dsva.slack.com/archives/C0NGDDXME/p1727205735920459) | - | 
Links | [Links](https://design.va.gov/content-style-guide/links) | - | - | - | [Last updates communicated 9/24/24](https://dsva.slack.com/archives/C0NGDDXME/p1727205735920459)  | -|
Secondary navigation for MHV on VA.gov |  | Med/Med | Sara |  |  | | 
IA and SEO | [SEO best practices on GH](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/information-architecture/standards/seo-best-practices.md) <br> [Writing for SEO in content styleguide on VADS](https://design.va.gov/content-style-guide/seo) | Low/Low | Unassigned | | Future updates - dependent on IA section of VADS being figured out first | | |
IA and a11y | | Low/Low | Unassigned | | Future add - dependent on IA section of VADS being figured out first | | 
