...
Redirects | [Redirect standards in VADS](https://design.va.gov/components/url-standards/redirects) | --- | --- | --- | Standards published and communicated <br> Mikki to work with Public Websites on process and implementation documentation.
