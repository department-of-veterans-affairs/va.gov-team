...
Team has created user flows in [this Mural](https://app.mural.co/t/departmentofveteransaffairs9999/m/departmentofveteransaffairs9999/1694111229625/784141f7f136fcd481b4010e5ec0ca961434e5fe?sender=u79ee90295fdb006d7f463212). We added feedback below the user flows as well as added stickies directly on the flow. Those stickies represent feedback based on the [VA experience standards](https://depo-platform-documentation.scrollhelp.site/collaboration-cycle/va-gov-experience-standards).
...
User flows | Your content or feature supports all necessary user flows and scenarios. | Added stickies in the Mural to include the POA/third party flow as well as non-citizen flow |
...
2. **Records left nav** - Add
  - Placement description: Under “Get your records and documents”, 3rd option down. Below the records options that are currently available on the modernized site. Get Veteran IDs is 3rd down on the moment and so left nav order is off by 1.
  - Link label:
  - Link destination: 
  - Notes: 
