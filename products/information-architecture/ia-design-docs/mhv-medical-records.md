...
| Form / child pages under Download your medical records reports  | /my-health/medical-records/download/date-range ; /my-health/medical-records/download/record-type ; /my-health/medical-records/download/file-type                            | N/A                | <- Download medical records reports (first page) - successive pages of form should use <- Back       | VA.gov home > My HealtheVet > Medical records > Download medical records reports > Select Records And Download Report - Medical Records | Veterans Affairs (first page) - successive pages of form should use <- Back | Select Records And Download Report - Medical Record s\| Veterans Affairs |
