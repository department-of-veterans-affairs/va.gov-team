...
**Overview:** Pay.va.gov is being deprecated so the team is building a payment flow that's hosted on Pay.gov to make it easier for Veterans to make payments. The existing process makes Veterans go through a longer process of re-entering their information but the new hosted collections page aims to be simpler. 
