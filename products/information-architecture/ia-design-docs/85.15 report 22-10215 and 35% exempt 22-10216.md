...
## <a name="link from 'Not A Vetran?'"></a>LinkFromNotAVeteran<br>

Benefit hub pages can include a 'Not a Vetran?' section in the main hub page accordion. It provides links to content which is related to the benefit area, but is not intended for use by veterans themselves. The [Education and training benefits hub page](https://www.va.gov/education/) already includes a 'Not for Veterans?' link to the [School administrators page](https://www.va.gov/school-administrators/). All needed navigation is in place - no further work needed.
<img width="808" alt="school admins 1" src="https://github.com/user-attachments/assets/99beca8e-456d-47f3-ad66-2b56059c9687">

## <a name="Entry points outside the School Administrator page"></a>EntryPoints<br>
 
**1) Find a VA forme** - Add Navigation Link
...
![school admins 2](https://github.com/user-attachments/assets/11948dd8-912f-49f8-a7d9-1468a37eb95d)
...
## <a name="recirects"></a>Redirectss<br>
