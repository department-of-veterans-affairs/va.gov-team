# Research Plan: Organic Adoption Messaging (Usability)
*Login.gov Adoption Team, Organic Adoption, March 2023*
...
This initiative focuses on one migration pathway: the organic adoption of Login.gov. In this case, we're encouraging Veterans to adopt Login.gov as their primary credential, however we're not providing any specific binding or inheriting of identity data. Essentially, we're encouraging Veterans to set up a Login.gov from scratch. This [product outline](https://github.com/department-of-veterans-affairs/va.gov-team/tree/master/products/login.gov-adoption/products/login.gov) has more details on this product.
...
This research will validate and refine content that encourages a Veteran to set up a Login.gov from scratch (or without any migration of data from previous legacy credentials). We will aim to find solutions to any issues that are surfaced through testing.

This research will inform a staged rollout plan.

### Research questions

Review whether Veterans are motivated to set up a Login.gov account based on messaging

* Are Veterans motivated to set up a Login.gov account when prompted, why or why not?
* How confident do Veterans feel about their ability to set up a Login.gov account when prompted?
* Do Veterans have concerns about setting up a Login.gov account?
* Do Vetetans have concerns about their ability to continue accessing VA services if they do or don't set up Login.gov?

Review whether Veterans understand what we're asking them to do and why

* Do Veterans understand why they're being asked to set up a Login.gov account?
* Do Veterans understand that they should now stop using other credentials and use Login.gov to sign in moving forward?

### Hypotheses

These hypotheses still need to be updated.
...
## Methodology
This usability study will be conducted remotely on Zoom. We will test on desktop or mobile.

### Research materials

- Need to add Conversation Guide
- Need to add Prototype or other stimuli
...
We will use Perigean to recruit Veterans for this moderated study. We haven't submitted a Recruitment Request yet.
...
We need to update timeline with dates.

|Date|Milestone|
|:--|:--|
|TBD|Submit prototype for Midpoint Review|
...
We need to update with details about pilot session.
...
We still need to update with availability and research slots.

## Team Roles

We still need to update with agreed upon team roles.
