...
This initiative is one of a few migration pathways; here we are focused specifically on moving select DS Logon users to Login.gov without the need to reverify their identities, through “grandfathering” or deferred identity proofing.
