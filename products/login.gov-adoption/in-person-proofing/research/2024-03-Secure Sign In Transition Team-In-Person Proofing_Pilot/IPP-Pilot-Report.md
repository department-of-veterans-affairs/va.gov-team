# 2024-03-Secure Sign In Transition Team-In Person Proofing_Pilot_Intercept Interviews 

# 2024-03-Secure Sign In Transition Team-In-Person Proofing_Pilot

Sophia Philip, sophia@themostudio.com
Gus Schissler, gus@themostudio.com
...
* Tom Black, Identity Engineer Product Lead

**Secure Sign-In Transition Team**

* Gus Schissler, Product Lead
* Sophia Philip, Design Lead
* Mateo Salinas-Clark, Senior Software Engineer
* Anu Das, Software Engineer
...
Monday, June 10th-Thursday, June 13th, 2024
...
* Sophia Philip, Design Lead
* Sofia Kirkman, Service Designer
* Anu Das, Senior Software Engineer
...
3. How might we learn from Veterans and/or caregivers the likelihood of them using in-person identity verification as they are in the midst of accessing VA services?
4. How might we learn from Veterans and/or caregivers their receptivity to in-person identity verification  as they are in the midst of accessing VA services?
5. How might we identify pain points or improvements that are needed by getting feedback while a Veteran and/or caregiver are in a VA facility?
...
The following table shows the total number of research activities that were conducted across the methodologies used

||||
|--- |--- |--- |
|Research Methodology|Total Activities Completed|Notes|
|Moderated Pilot Sessions|5|Eight sessions were initially scheduled for the pilot, three participants canceled|
|Intercept Interviews|11|Conducted with Veterans or their Caregivers within the VA Medical Center. Participants were compensated by Perigean following completion of the interview. Intercept interviews took place in the waiting room for labs and the enrollment center|
|Shadowing Sessions|3|Took place in the enrollment center with the My HealtheVet Coordinator|
|Observational Studies|5|Conducted across the Baltimore VA Medical Center|

### 1. **Moderated pilot sessions**
...
![alt_text](media/moderated-session.JPG "Researchers positioned in the room where moderated sessions were conducted. Participants sat on the far left where the laptop is set up. The VA staff sat at the desk with the desktop set up and the researcher either stood or sat on the far right.")
...
![alt_text](media/observation-study.png "The waiting area for labs where intercept interviews were conducted")
...
### 4. **Shadowing sessions**
    ...
    A researcher shadowed the VA staff member as they assisted Veterans with account creation and identity verification. Written observations were collected.

    Observational studies and shadowing sessions were supporting activities to better understand the research goals and questions identified for moderated pilot sessions and intercept interviews.
...
#### 5. Veterans will be able to easily navigate through the custom application and complete verification.
...
#### 6. If verification is completed successfully, Veterans will experience either no change or positive change in attitudes toward the identity verification process.
...
#### 7. Veterans will understand why they are completing identity verification and what benefits it will provide to them. 
...
#### Moderated Session Survey Results
...
Insights are supported by evidence found in the moderated sessions, surveys completed by VA staff and Veterans, and the intercept interview data collected during the pilot.
