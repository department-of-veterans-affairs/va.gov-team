...
|Goal|Initiatives|
|:--|:--|
|How we work|Co-define a product vision with partners<br>Set up a workflow for tracking and prioritizing business line requests|
|User experience|Test concepts with submitters that involve automation<br>Design a page to explain the types of questions within a category<br>Do a comparative analysis of contact experiences<br>Do research to understand and observe agent processes<br>Update designs to use new VA Design System patterns|
