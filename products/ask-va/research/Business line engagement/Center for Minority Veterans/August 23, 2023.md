...
- Overall, they don't mind updating to the proposed names. But there's an opportunity to consolidate the topics, which they are going to follow up with the CRM team about:
- How do you feel about these changes? ""Don't mind the changes, either way."""
> Chris: Both of these route to the same place, would it be better to just have one topic?

> "Yes, it would be simpler if it was one thing: Programs and policies."
