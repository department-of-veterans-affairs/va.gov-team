...
|Category|Rule|
|:--|:--|
|`Benefits issues outside the U.S.`|This category forks and mimics `Disability compensation` and `Education benefits and work study`.|
|`Burials and memorials`|This category mimics `Disability compensation`.|
|`Center for Minority Veterans`|Refer to |
