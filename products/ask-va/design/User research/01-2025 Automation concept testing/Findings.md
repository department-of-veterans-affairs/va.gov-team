...
|People will choose to abandon Ask VA in favor of clicking a helpful link to get more information.|Likely True and False.|While everyone will explore helpful links when they're presented, some people will choose to continue with the form if they don't receive the answer they need from a link.|
...
7. Don't add an additional triage layer that's more than categories.
