# Business lines that allow attachments
...
|`Burials and memorials`|Allowed|
|`Center for Minority Veterans`|Not allowed|
|`Center for Women Veterans`|[Depends on topics](#attachment-rules-by-topics)|
|`Debt for benefit overpayments and health care copay bills`|Allowed|
|`Decision reviews and appeals`|Not allowed|
|`Defense Enrollment Eligibility Reporting System (DEERS)`|Allowed|
|`Disability compensation`|Not allowed|
|`Education benefits and work study`|✅|
|`Guardianship, custodianship, or fiduciary issues`|Allowed|
|`Health care`|Allowed|
|`Housing assistance and home loans`|Not allowed|
|`Life insurance`|Allowed|
|`Pension`|Not allowed|
|`Sign in and technical issues`|[Depends on topics](#attachment-rules-by-topics)|
|`Survivor benefits`|Allowed|
|`Veteran ID Card (VIC)`|Allowed|
|`Veteran Readiness and Employment`|Allowed|
...
|`Health care`|Caregiver support program|
|`Health care`|Eligibility and how to apply|
|`Health care`|Family member health benefits|
|`Health care`|Foreign Medical Program|✅|
|`Health care`|Getting care at a local VA medical center|
|`Health care`|Prosthetics|✅|
|`Health care`|Vet Centers and readjustment counseling|
