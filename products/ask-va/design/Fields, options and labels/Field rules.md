...
|All other categories|Authentication depends on response to `Who is your question about?`||
...
|Who is your question about? = `It's a general question`|Authentication is not required|Category rules above|
