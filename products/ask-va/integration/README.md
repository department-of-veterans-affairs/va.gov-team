...
Form | [GET /optionset?{name}](crm_api/Form_GetOptionSet.md) | Dynamics | 🟩 | 🟨 | development | CRM has handed off to AVA VA.gov team| 
Form | [GET /profile](crm_api/AVA_Profile.md) from AVA | Dynamics | 🟨 | ⬜ | development |  | 
