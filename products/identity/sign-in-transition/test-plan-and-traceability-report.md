...
| 2 | MHV credential user authenticates, and has **neither** [ID.me](http://id.me/) or [Login.gov](http://login.gov/) credential | 1. User navigates to https://staging.va.gov/sign-in-changes-reminder<br/> 1a. Use **DevTools Network response overrides**<br/> 2. User is prompted with the Create Account option for [Login.gov](http://login.gov/) AND [ID.me](http://id.me/)<br/> | Pass | Ian Magenta | 06/05/2025 | {} |
