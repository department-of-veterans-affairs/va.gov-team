...
- As a Veteran, I should have to wait no longer than ***TBD*** to get a result when I try to logout from va.gov, as measured continuously by the _SIS Logout_ dashboard in datadog. If the continuously average logout time goes above ***TBD***, we will ***TBD***
...
- As a Veteran, I should be able to logout from va.gov 99.9999% of the time as, measured continuously by the _SSOe Logout_ dashboard in datadog. If the endpoint goes down, it will be treated as a P1, and fixed ***TBD***. If the average time drops below 99.999%, the root cause will be investigated and resolved.
