...
MHV Unified Sign In inherits the rules from the standard user attribute processing in vets-api. Below is an exhaustive list of the exceptions made only to the application=mhv.
