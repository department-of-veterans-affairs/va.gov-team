# System Recovery Plan - Terms of Use (ToU)
...
1. Confirm logs
    1. Confirm Terms of Use actions are occuring in DataDog 
1. Authenticate using both authentication brokers to test the following
    1. Navigate to `/terms-of-use` and click "Decline" button => Confirm no errors have occurred and you are logged out
    2. Re-authenticate => Confirm you are shown the `/terms-of-use` page
    3. Click the "Accept" button => Confirm you are redirected to the auth callback page
2. Navigate to Oracle Health direct login `/sign-in/?application=myvahealth` (replace)
  
5.  State in the [`#identity-support`](https://dsva.slack.com/archives/CSFV4QTKN) channel that Terms of Use funcitonality have been restored and confirmed to be working.
