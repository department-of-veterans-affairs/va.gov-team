...
- **TOU: When are we launching on VA.gov?**
- Continue to support other in-flight efforts (eg. accredited rep, etc)

### General platform support

- Provide support to VFS teams as needed
- Identity SDK project & CAIA issues **is this continuing into next sprint?**
- SLA work **is this continuing into next sprint?**
...
- Finish discovery
- Create Github summary of our findings that outlines key areas for improvement.
