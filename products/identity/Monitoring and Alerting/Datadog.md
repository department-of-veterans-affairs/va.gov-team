...
| Alert Name | Env: Production| Env: Staging| Env: Dev| Type: Inbound|Type: Outbound| <div style="width:290px">Description</div> | Threshold | <div style="width:290px">Metric used</div> |
|-----------------------------------------------|--------|--------|--------|------|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|--------------------------------------------|
