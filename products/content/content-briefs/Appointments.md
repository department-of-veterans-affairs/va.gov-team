...
| **request vs. schedule** | Veterans can self-schedule **some** types of appointments online. They can request other types of appointments. The option to self-schedule or request is not uniform across all types of care and VAMCs because it is controlled locally.  |
...
| **type of care** | Type of care refers to the specialty, i.e. primary care, mental health. 
