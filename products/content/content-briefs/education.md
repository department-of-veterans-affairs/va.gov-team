...
| Dependents’ Educational Assistance (DEA) | This VA education benefit used to be called Survivors' and Dependents' Educational Assistance (DEA). Now the name no longer includes "Survivors." (Note that "Dependents" is plural so the apostrophe goes on the right side of the "s") | | | We'll update this entry in the style guide
