# UX, FE, BE, CMS requirements for the 'view all articles in X' LC category landing page
...
- The H1 of this page will be templatized: "All articles in: <LC category name>"
