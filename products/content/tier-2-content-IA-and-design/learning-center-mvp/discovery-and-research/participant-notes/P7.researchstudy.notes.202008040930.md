...
> Yes. You can either click on Disability, because they fall into two different pages, links pages, for the disability, for health care and then it’s supposed to  get the Vietnam Veterans as the audience.
- Okay, can you elaborate - what would you expect to happen if you clicked on one? 
> It should take you back to those topics. The topics of disability. The topics of health care. How to take care of different things that are Agent orange related or exposure related. 

 It would take you to those topics. Take care of those things that are Agent Orange related or exposure related. You can either click on the disability, cause they fall into two different categories, 
...
>  Oh, lots of information! Storage facilities, Indiana. Few years ago they had a leak there. 
- That’s scary. 
> Yeah, it was. I lived in Indiana at the time. 
- oooh. How does this line up from what you expected going from the previous page to this one? 
> It does. But I would also, If the audience is more than just Vietnam Veterns, I would put them in there too. Like the directory of Environmental Health Coordinators. 
- Right 
> Burn pit. Radiation. That wasn’t just Vietnam. That was Desert Storm. That was Iraq. That was Afganistin. That was Korea. They burnt the honey pots in Korea. 
- Okay, so it should have broader labeling or something like that? 
> Yeah.
- Okay, got it.   
> Because if the directory is for the Environmental Health Coordinators.
- Right, okay. 
> So, the way I’m reading it as the only audience is for the Vietnam Vets. Even though you’re on the Agent Orange page. 
- Okay 
> But we do have Vietnam Veterans that were Desert Storm Veterans and we also have Vietnam Veterans that are Iraq and Afghanistan Veterans 
- Okay, I understand 

- Did you notice any articles that sound like they could be the same?
  > Yeah, the question and answer and the FAQs. Because isn’t that the same thing? Blue Water Navy Veteran, Vietnam Veteran law, and then the Blue Water Navy/Vietnam Veteran Act…
- Yeah, I see what you are saying - they are not clickable - what would you expect the different between those if any? 
> Well, both are questions and answers. One just has the family members in with it.
- Right
> Surviving family member 
- Okay. Okay, good, that is helpful 
> And the video is really good for the older ones, that may not be able to sit and just read 
- Right. Really, could be helpful for anyone that doesn’t want to sit and read…

## Post-Task Interview - 8 minutes

- Excellent, this has all been so helpful. Just a few more questions for you before we wrap up. Do you have a few more minutes to talk or do we need to wrap it up? 
> No, I’ve got time. 
-  Okay, this should only take five more minutes, if even that

- From this screen, talk me through how you would apply for a benefit you don't already have - home loan, something that you have not applied to yet. 

> Well, down here it says the Blue Water Navy and VA Home Loan changes - Housing assistance as a topic, so you go to Housing Assitance. 
- OKay. And what about if it was something like education benefits
> Probably the Veterans Benefits Administration. 
- Okay, So, you would expect to find the information there?
> Yes 
- Okay, great. 
> Either that, or you back to the top, where it says, home, Learning Center...and go back to the Learning Center and go from there. 
- Okay, if you did that, you can click on that (learning center breadcrumb). So from here…So you would look under the topics? 
> Housing. Assistance and VA home loans
- Okay, great 

 - We have not discussed search - Have you noticed a way to search since we’ve gone through this?  
  > Yeah
- Okay, and you talk me through this search function and what the different options are as you understand them. 
> You can put a keyword into the search. And like right now it says, search learning center, so it would take you here but if you wanted to find out on the VA.gov you hit the VA.gov to search it. For the key word. 
- And how do you understand that to be different from the overall site search? 
> The difference between the learning center and VA.gov? 
- Umm, yeah 
> Or just overall search in general?
- Overall search, like if you, there’s a search option on the website, that’s for the whole thing, up in the navigation. I am not sure if you ever used that…Have you ever used that feature? 
> No 
- Okay. How would you imagine that work differently from the search in this? 
> I think the one at the very top would take you to the VA.gov search 
- Okay 
> The header for the VA itself, I would say it would take you to VA.gov. To where the one down here, is the reason “search learning center” is highlighted. 
- Okay, and if you changed to Search VA.gov instead of Search Learning Center do you think that would be different from the thing at the top? 
> No 
- Okay. That’s really helpful to know. 
> No, but I think people would use this - the search box - more than the search on the top. 
- And why is that? 
> Because it stands out more to you. It catches your attention. 
- Yeah, it’s not hidden 
> Yeah, because up at the top and the “sign in” is in big blue and white and so you sign in.  
- Right. Okay. 
> And you start looking, you know, the search is kind of there. The “contact us” is kind of there. Most people don’t use the “contact us” unless they really have a problem. 
- Right, right. 
> The search with it being a little lower down, under the heading, and it’s highlighted that way - it’s kind of like, come use me. Here I am. 
- Okay. Yeah, that makes sense and that is really helpful to have you feedback on that. 

-  A couple other questions. We don't know what to call the product you reviewed yet. Now that you have a better idea of the type of information that's here, what you think of the name `Learning Center`?

> Learning Center is good. Vet Scope. Cause you are scoping out information on different…
- Yeah, on different Topics. Okay, cool. 
> Sorry, I have nerve damage in my hand and it makes it itch. 
[Repeats]

- And if you went to VA.gov today and knew we had launched this product. How would you find it on the website?

> If I went today? On VA.gov? I would probably use their little bitty tiny search. 
-  Okay
> Learning Center, or check the page to see if there was a link going to from VA.gov over  to the Learning Center 
- Okay, alright - got it. 
> Again, it, with being larger letters it stands out. Some of the stuff could be in italics. Thank you for the word, I couldn’t get it in my head. To make it stand out. Because after you read for a while everything looks the same.
- Right, right. That’s helpful to know too.   

- Overall, what, if anything, do you find valuable or not helpful about this learning center concept as a whole?

> I just wish the VA was using the money that they are putting into this program on the Veterans 
- Okay 
> There’s a lot of Veterans in need and they, yes it would be helpful to people but to me taking care of my fellow brothers and sisters is more important. 
- Yeah, there is a greater need there. 
> That’s like with CORONAVirus. We always do a homeless stand down. We can’t do one this year. So, we have no way of getting the stuff to the homeless Veterans without going into their camps. And they don’t want you to go into their camps because they don’t want you bringing CORONAVirus
- Yeah, right. I am surprised they haven’t come up with an alternative way to do that. 
> My group always made up food bags that had the easy open cans of fruits and vegetables and bottles of water and nuts. And the first time we did a Veteran said, “What am I supposed to do with these vegetables. I can’t eat an entire can at one time.” ANd I said, “You can’t. But you have a buddy, right? Share your fruit and vegetables today and tomorrow you share his can of vegetables. 
- Yeah
> Or you can of fruit. Share it. There’s enough servings in there for 3 or 4 people. Do it to it. He said, he hadn’t thought about it that way. And I said, well, you know
- Honestly, I don’t know if I would either. 
> Well, with a larger size can that can 3 to 4 people - you are keeping the waste down instead of having say 4 individual servings   
- Exactly. 

- What do you think could be improved about what we've reviewed today?

> Have a place for the local VA, like I am Vision 8 (?), have a place where they can put where their homeless stand downs are. 
- Okay. 
> Because, this sounds weird, but a lot of the homeless Veterans have cellphones. They go on and find out where homeless stand down is. Because some of them do a three day standown and put them up for the night.  And give them showers. And have a dentist check their teeth, you know, all of that stuff. It would be helpful to know where a homeless stand down is and also if other Veterans would like to donante. They know where to take the stuff to give  out to homeless Veteran. 
- Right, so more resources. Highlighting those resources. 
> Resources, and networking. 

- Okay, great. That is a really great suggestion.  
