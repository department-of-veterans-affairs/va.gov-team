...
|-------------------|------------------|-------------------|
| Content editor sees informational text about the new 7 day timeframe for Full-width banners | **AS A** Content Editor, **I WANT** to know that there is a new 7 day timeframe expectation for Full-width banners, **SO THAT** I’m aware I will receive notifications within that timeframe alerting me that I should update and extend the time, or archive the banner. | The Start/End date fields will be required. The "Start" date will be editable, but the "End" (end) date will not be editable. |
...
| Developer edits the date range of full-width banners | **AS A** drupal developer, **I NEED** the ability to change the date range of full-width banners to 14 days, or 21 days, or any range that's been decided upon, **SO THAT** the published date range is now the new date range, **AND** notificiation emails are still sent on the 3 day, morning of last day, (and when archived) cadence. | |
