...
Use our content placement criteria to determine if your content belongs in the Veteran benefit content experience. If the content you're evaluating has multiple pieces to it (for example, eligibility criteria for a VA benefit + related questions and answers about eligibility), use the criteria to evaluate each piece of content on its own.
...
If yes, your content belongs in the Veteran benefit experience. If not, your content may belong somewhere else within the VA content ecosystem.

Now, use our additional content placement criteria to determine if your content's primary home should be a VA.gov benefit hub or the VA.gov Resources and Support section.
...
Search the Resources and Support library to make sure there isn't already content on this topic. If there is...[fill in]
...
_Note: Provide Word doc templates for these_

- **Step-by-step to template:** Choose this template if your content describes a process that has a series of steps that must happen in order.
...
## Step 3: Determine your H1 page header
