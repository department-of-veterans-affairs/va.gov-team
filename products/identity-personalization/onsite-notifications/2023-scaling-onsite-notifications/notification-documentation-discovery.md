...
We should document the different types of notifications/alerts that commonly power web products, and whether we are already utilizing those on VA.gov or not. The goal of this work is to start viewing the VA.gov notification landscape more holistically, and to highlight opportunites for expanding on it.
