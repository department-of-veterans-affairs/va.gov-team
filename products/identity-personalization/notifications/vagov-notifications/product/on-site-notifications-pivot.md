...
## An action item is a type of content; On-site alerts/email/text are vehicles for delivery. Action items don't necessarily need to be shown as on-site notifications. 
