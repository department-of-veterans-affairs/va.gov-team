...
The third and final pillar -- notifications that show to logged-in users on VA.gov -- is finally ready for MVP development by the auth. experience team. For our MVP, we plan to prioritize action items, ie. tasks which require veteran action to move a process forward, as well as other notifications that currently have email support in VANotify. Our work will be supported by the VANotify platform so that all notifications (email, text, on VA.gov) can be managed in a single place as part of a coordinated communication effort.

## Problem Statement

- As a customer of the VA, I need to know if there are tasks I need to complete so that I can receive or manage my benefits.
- As a customer of the VA, I need to know if the VA has updated something related to a benefit application or my existing benefits.
...
- VA.gov users will also have a better sense of the current status of their benefits and information.
...
- It will be easier for the VA to get necessary action items and notifications in front of users than it is now.
...
We have already completed design discovery, which will inform our technical discovery and MVP planning. We will be building on the VANotify platform to ensure a unified communication experience.
