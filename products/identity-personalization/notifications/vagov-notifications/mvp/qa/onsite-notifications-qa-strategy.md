...
|2. For QA on Staging, how many test accounts do we need to set up?|Tze needs 10 accounts (ideally; min 6) with 1 notification, and 10 (ideally, min 6) with 3 notifications.   [Slack](https://dsva.slack.com/archives/C909ZG2BB/p1654273406114689?thread_ts=1654266535.783549&cid=C909ZG2BB)|
