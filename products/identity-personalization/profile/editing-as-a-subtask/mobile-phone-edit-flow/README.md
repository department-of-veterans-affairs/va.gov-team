...
|----------|:-:|:-:|:-:|:-:|:-:|
|Number of saves of the add a mobile number form (success)|177|465||||
|Number of saves of the add a mobile number form (failures)|1|7||||
|Save success as a %| 99.44% |98.52%||||
