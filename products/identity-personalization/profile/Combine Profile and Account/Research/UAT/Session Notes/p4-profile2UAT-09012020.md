...
have to click on the arrows in the DD form, doesn't work properly
pulling the wrong routing number, even if it's right
link in update email address doesn't work (MHV)
...
4. Do you know your username and password? cbreese63@windstream.net
...
- Next, scroll to the 'Contact email address' section. Click on the link 'Update email address on ...'.
  - [ ] **UAT TASK:** Link goes to the website where they manage their information - does not work with MHV
...
- Great. Let's go back to the profile. Now, can you scroll back up to the navigation on the left and click on 'Military information'. Does this information look correct?
  - [ ] **UAT TASK:** Military Information page shows up and appears to be formatted correctly. - missing navy
...
- Let's go back to the profile. Can you click on 'Update sign in email address on ...'? also not working
