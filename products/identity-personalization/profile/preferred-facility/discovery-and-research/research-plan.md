`DRAFT`
# Research Plan for Authenticated Experience, Profile "My VA health facilities", June 2021
...
Link to VAOS research folder TBD.
...
- How do veterans understand the message “Note: You're registered at 4 other facilities where you've received care in the past....”?
...
- Do Veterans encounter any usability problems or confusion when going from VAOS to profile?
  - If a Veteran marks a facility as preferred or current in VAOS, and then visits their profile, do they understand why their facility list has a facility marked as current and others are hidden?
