...
| 1. User navigates to **Gender identity** section<br />2. User clicks the Edit button<br />3. User selects "Woman" <br />3. User clicks the Update button | 1. The newly-saved value appears immediately below the **Gender identity** section heading.<br />2. An "Update saved." confirmation message appears immediately below the newly-saved value. | Any LOA3 user | [Mobile] :same as above screenshot:<br />[Desktop] :triangular_flag_on_post: |
