...
- [Veteran ID Card User Experience Research](https://github.com/department-of-veterans-affairs/va.gov-team/tree/master/products/veteran-id-cards/research) (January, 2018)
	...
	- Our recommendation
		- Determine what a user would want to do with their ID card online via Profile: apply/renew, download, etc.
- [Dependency Verification Process](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/dependents/dependency_verification/research_plan_11_2020.md) (December, 2020)
	- Takeaways relevant to Profile
		- This research provided information on where to cross link to this process int eh larger VA.gov navigation, so there is precedent in considering linking to this tool from within Profile
	- Our recommendation
		- Show current dependent (and possibly previous) information in Profile as an MVP. Additionally, cross link to the online tool, as veterans must complete VA Form 21-686c to submit a claim for additional benefits for a dependent, or to request to remove a dependent from their benefits.
- [Decision Letter Download](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/claim-appeal-status/research/2022-08-Decision-Letter-Download/research-plan.md) (September, 2022)
	...
	- Our recommendation
		- Thoroughly examine the taxonomy of letters that veterans receive (benefit letters, claim letters, decision letters, etc.)
		- Use what we learn to inform the information architecture of the Letters page
...
- [MHV Medical Records Generative Research](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/health-care/digital-health-modernization/mhv-to-va.gov/medical-records/research/2022-10_Generative-research/2022-10-medical-records-research-plan.md) (November, 2022)
	...
	- Our recommendation
		- Determine what actions we would want to enable users to take with letters in Profile as an MVP.
...
Continue forward with designing and testing an MVP of Profile that includes dependents, letters, and ID card.

#### Next steps

- Make mockups for MPV (how it would look in profile: note with IA, where it would fit in profile)
