...
**All data was correct except for notes below.**
...
* **This information was not correct, which set off alarm bells after the first user also had problems here. The difference was that this user was sure she had updated her home address on the medical side of things and for VBA through eBenefits.**
* **Info here updated much more quickly than it did for the first user, though they still saw the blue "we're working on it" copy.**
  
- Please click into your Home Phone Number, make any changes you want (or not), and then click **Save**. 
  - [x] **UAT TASK:** *Confirm that user is able to click edit and make changes to contact information.*
  - [x] **UAT TASK:** *Confirm that user's updates show correctly after hitting Save.*    
 
 * **Like with Participant 1, we had this participant delete their phone number and add it back in. It appeared to delete more quickly and was removed from the profile, but we got an error when she tried to add it back in. I am assuming this is because it hadn't fully processed on the backend. Once she refreshed the page and we waited a few seconds, she was able to add her phone number back. However, then that took multiple refreshes and 20+ seconds to show up in the profile again.**
