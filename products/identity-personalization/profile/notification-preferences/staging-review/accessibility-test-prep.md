...
WAVE tool spot checks | [read more about the WebAIM WAVE tool](https://wave.webaim.org/)| Yes | Complained about the `fieldset`s missing `legend`s. [I will address this.](https://github.com/department-of-veterans-affairs/va.gov-team/issues/31225) | Erik Hansen |
