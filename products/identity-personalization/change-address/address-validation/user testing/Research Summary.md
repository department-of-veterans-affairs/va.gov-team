...
First, participants seemed overly focused on choosing the "right" address in flows where we determined the original address entered was problematic and they had the option to choose a "suggested addresses." Testing was not about choosing the right or wrong address; it was about testing whether participants would understand what to do with the information given if they encountered this scenario in real life. I don't think we would have seen this preoccupation with choosing the right address if participants were seeing real data instead of made up data. This caused them to get caught up in arbitrary details.
