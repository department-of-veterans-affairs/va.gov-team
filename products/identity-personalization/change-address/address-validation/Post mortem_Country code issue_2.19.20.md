...
However, our code on staging is currently different than the code on production since we are actively developing the address validation feature. Lihan forgot that the code was currently different and did not account for this in his testing. 
