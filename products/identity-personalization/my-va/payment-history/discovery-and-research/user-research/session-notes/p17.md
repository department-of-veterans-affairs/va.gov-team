...
* Um I don’t normally look at that to often. I guess I didn’t know that you could, I haven’t paid attention to it. I am starting from zero then. It is direct deposited; she checks the bank statement. My wife. Don’t hear a word from VA.
...
Screen reader: it is off now because it gets annoying. The screen reader I wouldn’t be able to hear you. If I don’t use it then I make it bigger so I can read it, other than that it is constantly reading. 
...
What from here: It says sign in or create an account so I would need to do that because I don’t think I have an account. I have changed my email address but that is what I use for all of my va stuff. So now I have sign in with id.me, ds logon, myhealthevet. If I do the ds logon it would be the same as when I check my claim and go through two dancing bears but if I go through myhealthevet. I think I signed in, oh now I have to get a code. Why would I have to do that, oh that’s what they are changing right. I clicked call me. 
...
* They have boxes on myhealthevet with appointments and messages and all that. For someone that can’t see something, less is more. You don’t need the pictures and fancy stuff. 
...
Well I like the size of print they have. That’s good, you can have it the screen cut down so you can see more of it. Sometimes with fine print you have to enlarge the screen much that you can’t see much but the bold type on there is really nice. 

*So you’re able to read that with more on the screen than normal* 

correct. 

I like this one /scrolls back up to the top of the page/, I didn’t know about it. 
...
I daresay the healthcare is the most important sections, you use that all the time. Claims and appeals, sooner or later that’s going to go away. Health care will be there forever.
