...
Participants who refill many meds want batch/refill-all flows and ability to check boxes for multiple meds (P3).
...
Problems & pain points
The word “debt” causes anxiety and anxiety‑driven reactions. Participants want payments/debts to be higher on the page and/or labeled in ways that are less alarming (e.g., “Payments & balances” or “Payment history” + a clear indicator for amounts due) (P3, P13).
...
Recommendations (prioritized: Quick wins → Mid → Long‑term). Each recommendation includes rationale and rough effort signal.
...
Mid‑term (moderate effort) 6. Enhance appointment & refill flows:
