...
|Test case|Intended outcome|Staging User|Prototype link|
|----|----|----|----|
|User DOES have a disability rating|User will see their disability rating under their name (Your disability rating: X% service connected>), it should link to the [disability rating overview page](https://staging.va.gov/disability/view-disability-rating/rating)|**226**|
|User DOES NOT have a disability rating|User will NOT see a disability rating under their name |**10**|
...
|Test case|Intended outcome|Staging User|Prototype link|
|----|----|----|----|
|View details (in the specific claims details card)| Link to the specific claim shown on My VA|**226**|
|Manage all claims and appeals| Link to the main claims and appeals tool page |**226**|
...
|Test case|Intended outcome|Staging User|Prototype link|
|----|----|----|----|
|User IS enrolled in healthcare|User sees healthcare section|**377**|
...
User is NOT enrolled in health care and has NEVER applied for healthcare|User sees "Learn how to apply for healthcare" link, then applies, the link/blurb goes away and it shows as an application in-progress |**Tze to recreate using existing user**|
User HAS filed a claim|User sees "Learn how to file a claim for disability" link|**226**|
User HAS NOT filed a claim|User sees "Learn how to file a claim for disability" link|**10**|
User receives DD4edu payments|User does NOT see "Apply for education benefits" link|**378**|
|User has started an application for education benefits|User will see the "Learn how to apply for Education Benefits" link |**Tze to add education benefit application to an existing user**|
|User DOES NOT receive DD4edu payments|User will see the "Learn how to apply for Education Benefits" link|**TBD**|


#### Apply for VA benefits links
|Test case|Intended outcome|Staging User|Prototype link|
|----|----|----|----|
|Continue your application|Links to the specific unfinished application represented in My VA|**100**|
|Learn how to apply for health care| Links to health care 'how to apply' page|**Tze to recreate using existing user**|
|Learn how to file a claim for disability|Links to disability claim 'how to apply' page| **226**|
|Learn how to apply for education benefits|Links to education 'how to apply' page| **TBD**|
