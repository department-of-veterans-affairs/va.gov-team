...
The goal of this research is to understand what information/how much information needs to be elevated on the MyVA page.   This includes:

- can the user find the personal information that they are looking for effectively
- does the page structure (scrolling vs navigation) effect ease of visibility
- can the user easily understand actionable items
...
- are we showing enough information to be valuable to a user?
- is the 'numbered' section approach enough information? 
- do they prefer upcoming appointments being elevated? is there any other information they want to be elevated?
- 
- what information needs to be spelled out?
- how does the user prefer to view updates?
- what structure makes the most sense to the user? (C or D)
