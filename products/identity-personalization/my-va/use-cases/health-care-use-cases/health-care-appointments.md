...
- Verify that you see secondary links to “Send a secure message to your health care team” (only if the user has no unread messages), “Refill and track your prescriptions”, “Request travel reimbursement”, and “Get your VA medical records and lab and test results” that link to their respective pages in My HealtheVet and on VA.gov.
