...
- If the user does not have unread messages, they will see a link to “Send a secure message to your health care team” that links them to the [secure messaging portal in My HealtheVet](https://eauth.va.gov/mhv-portal-web/web/myhealthevet/secure-messaging). 
...
- Verify that if the user does not have any upcoming appointments, you see text stating as such under the Health care header or below the unread messages alert.
- Verify that you see secondary links to “Send a secure message to your health care team” (only if the user has no unread messages), “Refill and track your prescriptions”, “Request travel reimbursement”, and “Get your VA medical records and lab and test results” that link to their respective pages in My HealtheVet.
