...
- An LOA1 user who signs into VA.gov will see:
  ...
  - A section for "Benefit applications and forms" where any saved in progress forms will appear as cards.
- When a user has a benefit application draft saved in progress, they will see a card in the "Benefit applications and forms" section that tells them the form code, application type, an expiration date for the application, the date that they last opened it, and a link to continue the application.
...
- If a user has multiple benefit application drafts saved, they will see a card for each of them in this section and they are displayed in a column with 1 card per row.
