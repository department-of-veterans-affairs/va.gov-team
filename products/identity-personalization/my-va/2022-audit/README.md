...
|KPI/metric|Baseline: [One month pre-launch to 25%]  <br />(3/10/23 - 4/10/23)|Post-launch: [One month post-launch to 100%] <br />(mm/dd/yy - mm/dd/yy)| Post-launch: [Second month post-launch to 100%] <br />(mm/dd/yy - mm/dd/yy)|
|----------|-------------|---------------|-------------------|
