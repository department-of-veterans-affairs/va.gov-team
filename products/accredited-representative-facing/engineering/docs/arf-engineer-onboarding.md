...
- [ ] [#benefits-accredited-reps-crew](https://dsva.slack.com/archives/C07V7FLLULC)


### Background Research / SEP Demos

One of the near-term goals of ARP is to allow the deprecation of a predecessor system called Stakeholder Enterprise Portal (SEP). 
