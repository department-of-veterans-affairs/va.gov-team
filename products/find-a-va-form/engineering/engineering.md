...
The rate limit for this API Key is shared across all of those APIs, and if one API has a spike in traffic that will affect the rate limit for all other APIs using the same key. 

**This API key is shared** [Background on shared API keys (Slack)](https://dsva.slack.com/archives/CUB5X5MGF/p1695666665300929)
