...
# Research questions
- How satisfied are Veterans with the MVP feature set and overall app UI/UX design?
- What usability issues exist specifically within the following 3 areas: 
  - Authentication 
  - Navigation
  - My VA (Profile, Direct deposit, Letters) 
- What is confusing or unclear about these 3 areas?
...
- The bottom toolbar navigation elements will be usable and clear to Veterans.
  - - "Your VA" might be a confusing navigation title.
...
Remote user interviews with 6-8 of Veterans over the course of 1 week. Each of these interviews will be moderated and conducted remotely using Zoom. The sessions will be led by targeted tasks and flows that lightly cover the prototype overall, but will focus on the 3 areas of Authentication, Navigation, and My VA. We will test a prototype of an iPhone SE within a desktop browser. 

## Why this method?
This method will allow members of the VA Mobile App team, and the teams we are overlapping with, to observe sessions. It will also allow us to speak with a diverse population of Veterans located across the United States. Specifically testing the prototype on desktop rather than on mobile devices will allow us to learn most quickly about what is and isn't working before investing in cross-platform prototypes and prototypes built for devices with unique safe areas.   

## Where are you planning to do your research?
We will use the Perigean zoom account. We will ask participants to join the Zoom via mobile and send a link to the Invision prototype via the Zoom chat for participants to open. Once participants have opened the prototype, we will ask them to share their screen with us.

## What will you be testing?
- Interactive high-fidelity Invision prototype of the MVP VA mobile app (iPhone SE size, 320px width)
