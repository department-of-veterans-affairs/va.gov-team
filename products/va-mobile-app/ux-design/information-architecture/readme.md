...
The sitemap/flow diagram outlines the information architecture that the current (post-MVP) VA Mobile App's navigation follows. The goal of this diagram is to outline all the current screens and actions in the app. As of February 2022 this diagram is a living artifact. As the app changes, updates will be made and reflected here.
