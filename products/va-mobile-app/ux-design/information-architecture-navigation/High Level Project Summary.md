...
* **Phase III** of this work is evaluative research, including a **[usability study of the proposed navigation model and sitemap](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/va-mobile-app/research/ux/navigation/new%20navigation%20usability/usability-findings.md)**. It gives insight on the usability and comprehension of the proposed navigation model and IA, and confirm whether we can move forward with the proposed navigation model to high-fidelity design.
