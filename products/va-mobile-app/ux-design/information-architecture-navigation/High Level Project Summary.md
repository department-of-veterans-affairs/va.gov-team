...
* **Phase III** of this work is evaluative research, including a **usability study of the proposed navigation model and sitemap**. It gives insight on the usability and comprehension of the proposed navigation model and IA, and confirm whether we can move forward with the proposed navigation model to high-fidelity design.
