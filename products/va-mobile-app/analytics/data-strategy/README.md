...
- We captured the [current state data infrastructure](./Mobile%20current%20state%20data%20pipeline.png) for the VAHB mobile app, including how data is collected and the supporting analytics infrastructure. An editable version of the diagram is in [FigJam here](https://www.figma.com/board/V0rDE80KylZ5jod3SWxAzC/Mobile-Surge-Support---Measurement---Data-Strategy?node-id=45-455&t=vAcBHQIYfPXqgIEI-4).
