...
In preparation for the anticipated increase in traffic in the mobile app, we want to make data-informed improvements to Claims. To do that, we want to better understand and organize the metrics we collect for the Claims tool: refining success metrics beyond event counts and API calls and setting baselines prior to making changes so we can track the impact of intended improvements. The recommendations below are informed by a synthesis of [existing quantitative](https://lookerstudio.google.com/u/0/reporting/dea3ede1-2d2e-4401-abd7-a44beada8a35/page/p_2j3o3kvy4c) and [qualitative data](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/va-mobile-app/ux-research/claims/research%20review%20-%20claims%20status%20tool.md).
