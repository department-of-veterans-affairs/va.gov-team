...
-	CLPs will have a dedicated directory - va.gov/initiatives. Since there will be no /initiative landing page, we will redirect the root URL va.gov/initiative to the va.gov homepage as this a better experience for users than getting a 404 error. This changes supports the approach that all CLPs are meant to be temporary and not evergreen, and not to be intermingled within the core site.
...
- Vanity URLs will be used as needed, and the requesting party should indicate their preferred vanity URL. All vanity URLs must meet our URL standards and  requirements. Vanity URLs will need to be reviewed and approved by Platform IA.  More guidance here: https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/platform/information-architecture/vanity-url-guidelines.md
