...
the first couple of acr that looked dead set ehat . i think they ere 5-10 minutes to answeer. some were are you having symptomes. i dont think they were short answers
...
- primacty care 1 month before tother, 2-3 days before mental health 2 days before appointment.

  - Do you feel that you were given enough time or not enough time to answer the questions prior to your appointment?
  -  enough time for bother of them
  ...
  - for pc 1 month before was a litlle early, 2 weeks before, if they were sync with labs.
  - behavorial health, 2 or 1 day.
  - any sooner like day of would be frustrating.
 
  - 

  - Please review the information in this notification and share your overall impressions. Think aloud as you review. 
the first 1 is consent that looks fine (consent). it looks like the one i have before. i would like wich provider because sometimes i have 2 appoinments a week and even tell me which department like behavioral health.

no if took away too many words wouldn be enought.
...
- [On each screen] Are there any terms that seem unfamiliar or confusing to you? no
...
please describes the other exposures should be on the previoius screen, because she has not context on this screen and she will have to refer back to the prevoius page for context.
follow-up questions- if I chose top 4 options i guess im going to trigger to other departments. I would not want me to click on something and it goes no where. I'll have to do more research. why am I filling out questionaire if not triggering a follow up. I want it to sned me somtheing or have someone call me up. if no direct contact following up, then i don't want to see this question.

who would eligibility vs enrolled different. why are you asksing me sinnce I think that elliglbe and enrolled are the same thing and dont undertand how are they differentl questions.  

what kind of registry questions: they are makeing a white list of someone of toxic exposure, whtat does that registry become?
regirty questions- what does it mean and why?

it would choose hemath/medical question , have questions about other but dont know hwo woyld chose ,but if i new i would have follow up questtions then oi would choose benefits and registry. if they seend me a panphetl then I would before a hyper link. i would want direct com with someone very qiuclikluy

-the fir expesore, this page should come before the prvous question, it feels like so many onanswered things.  scale 1-5 probaly a 4 because context is out of order if i get to next screen oh i d have to change my answer to prevoius screen. 

im confused why the smoke page does not have a time frame one it. not alt all for me though. strange no time frmae. maybe this qustion is not for eclectronic it weird that they call it  might as well ask a question likek that.
never for used to tobacco?
1 very easy on tabacco quest.
tbi-the last how is it no and? I am confused as to why 2 know, no should be /negative screeening or no scrteening, it should be. tbi tramatic brain injusry knows 2 because the second had no there 2 times. 
during deployemtns⬇ whoudl we talk about shelling or under explosuion . i would pick first one (blast). it seems more limiting if mine wasnt in there then it would be confusing.
like why some have alot of context oand other have none .like "fall" no context, she needs more context. 
symptoms immediatley afterwards: there are altest 2 that are also head injuryes, would like more context cousl they is a head injury options.
get worse afterwrds: the list bis pretty straighforward.
embbedded fragments:there is alot of words, have a fatigue going through all of them, it could be summarized better, duplication of effort,a little wordy (make it short).  it was a 2.

retained fragments: it says no first though, no, the text and the paranthesis is kind of confusing , I would say blast or explowsion.
thank page: okay that the end of questions set. it would be nice to see answers flagged like a summary of respeonse, likes email me a copy of my ansers, paranioa that doc will not follow up with these.

end of prototype: i would expect the provider that would trigger it , i would expect this questionarie was the first thing we talked bout, convo about it, then move on to the rest of appoinemtn. i want it t to be in my general file.

the intake nurse mentioned questionaire but doctors did not. Mental helath provider never discussed questionaiire, BH never seems to get follow up wich i don't .

If can change 1 thing out anything today; I would have more do you think qualigy with hyper links.  I just dont want the ansers i want the questions also. some kind of summary of the questions

response on own time: on my own I may be more honest on severity or depth or I am worred I'm that they are not going to accept my ansewers if I sayit during the provider they provider will not take it serously how w sever it has bee, but if i answer on my own i will sya it has been awfule ( observer bias)

to many question, can be shortend and combined.
preferable time : shoild be less than 10 minutes. I feel there were 2 parts to that. about 20 questions and less than 10 min. if questionsssss I see all the time like BH, then it should be shorter. most likley they are the same everytime.

i like getting questions by text instead of email.how many people people are in the research study. questions how many people are involved in this reseach. 
