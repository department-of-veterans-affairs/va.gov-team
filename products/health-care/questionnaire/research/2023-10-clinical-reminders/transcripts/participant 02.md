...
You should have been sent [text or email] by Perigean for today's session. Please bring up the [text or email], then share your screen. [Moderator Note: Help participant open the link and screen share if necessary. If the participant is unable to share their screen, then share your screen and follow the participant’s instructions.] Mobile screen sharing instructions
