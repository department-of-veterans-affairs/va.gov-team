...
1.	Before we start looking at the prototype, do you recall some of the pre-appointment questions my colleague asked you back in January during your last session with us? Some of them. 
...
The experience over all was good, I felt I was listened to. There were some things on the pre-appointment that I said I didn’t like. It seems like they took good notes and went from there. 
    - 1b. Do you recall if the experience was positive or negative? Why?
I said it was neither positive nor negative, in that some respect the con was once you got to the VA face to face you’re not greeted, it’s very impersonable. The positive side was if I had to update anything I could do that instead of taking up time at the reception. 
...
1. Since your enrollment in VA healthcare, do you recall ever receiving notifications from the VA asking you to fill out healthcare related questionnaires that were not related to a specific healthcare appointment? I’m not sure. I may have, I know when I receive them I do them. 
...
In some respects I see that a possibly a good thing because you may have some issues and you haven’t gotten into your doctor. Hopefully they will annotate them and you would get a phone call so you could get in and those problem be addressed.    
    - 2b. Would you prefer to answer this type of questionnaire online or in-person at the time of your healthcare appointment. If I had a health care appointment, I would prefer it there. But if I had nothing in the future online would be okay. 
    - 2c. How would you like receive this notification, is it through a text messaging or email?
I would prefer email.
    - 2d. What would make you hesitant, or uneasy to click on the VA notification, or its content due to it potentially being spam, or not from the VA? Because there is so much spam and phishing I would rather it say click on the VA notification. 
    ...
    - 2f. How long would the questionnaire have to be for you to consider it to be a reasonable amount of time to complete? No more than 10 minutes.
    - 2g. How do you feel about answering healthcare related questionnaires-do you feel that they are worth your time to fill out, not worth your time, or you have neutral feelings about filling them out? Why or why not? I feel it will be worth my time if it is addressed by the next appointment I have, or if it sends alarm bells that my PCP might email e or one of my specialists says hey let’s get you in we see this… 
    - 2h. What do you expect to happen after you fill out healthcare related questionnaire(s).
    - 2i. What cadence in receiving a questionnaire do you consider to be just the right amount of time? Maybe quarterly.
    - 2j. Suppose the VA sent a batch of 3-6 healthcare related questionnaires all at once?
    - 2k	How would you like to receive the batch, via email or text notification? I would prefer email.
    - 2l. How many questionnaires in a batch would you consider to be:
    - 2m. a reasonable amount to respond to at once?
Probably 4 to 4 weeks, it just depends on how long the questioner is. I don’t want to devote that much time to it. 
...
1. Ok great, we will move on to an image of a notification. Would you please tell me what device you are using for this session-are you using a desktop/laptop, tablet, or a mobile phone? My computer
...
3. If you received this notification via email (or text), would you trust that it was sent from the VA? Why or why not? I would want to because it has all the set up that the VA send out including their logo. I would also want to look at VA.gov to see if my provider sent it out. 
- 3a. What would you add, delete, or change about the content to make you feel more confident that this notification came from the VA? Which provider is wanting to know this. I have my PCP, my specialist, so I would want to know which provider. If they knew the name of the provider it would be more valid. I would also like to know how long they expect this ti take.
  
4. On a scale from 1 to 5 (with 1 being very easy and 5 being very difficult), how easy or difficult is it to read or understand this notification? 1 pretty simple English and understandable to read. 

- Moderator: move to Task 2.

## Task 2: Prototype Welcome screen-5 minutes

1. Okay, great. Now I’m going to send you the prototype link in the Zoom chat. If you would please click on the link and share your screen.- But please, don’t click on anything on the questionnaire  page until I give you further instructions. I’m not because it says suspicious link. It says suspicious link do you want to visit or not. 
...
3. Is it clear or unclear as to why the VA is asking you toxic exposure questions and Why?
 They are asking me due to the PACT Act law and because of my service, I may be eligible for compensation or recognition.

4. In the second paragraph, the sentence, ‘This screening is optional, what do you think of the content?
   I think it’s okay. It’s being sent to the veteran, if they don’t answer it they don’t answer it so technically it is optional. They’ll connect us with information about the services and that’s a nice thing for them. Then they can seek out their local BSO, and go from there. 
5. Without clicking on anything, in the question Do you want to continue with this toxic exposure screening, can you to tell me what the word “screening’ means to you? They are checking for certain points that you answer  that would qualify you for those benefits.
...
To me knowing what myself knowing what the scientific studies that it is because of what happened at a certain time. e PACT act is and yes it did expand to many veterans who were affected by toxic exposure during their service. It would mean some of the especially when they say every 5 years that some of the conditions may take years to show up, but they are related and they have been related through possible studies it’s because what has happened at a certain time. 
7. Can you tell me your thoughts about the “View Privacy Act Statement”
Where at? It’s good to hear that you were not able to locate that. That’s good feedback. It’s blue with a border. Oh yeah, it’s not very clear it’s there. 
It’s good to know that they are not going to sell my information, or that they are going to use it for a study. I would like to know. 
...
2. Is there anything on here that is unclear?
   No it’s very to the point and good examples. 
3. What is your impression of the toxic exposure examples given in this list? It’s very clear and good examples
    - 3a. Are there enough options for you to answer this question accurately, or do you believe there are not enough? Why or why not? Yes.
    - 3b. Do you feel that this question relates to you and your time of service, or not? Why or why not? It does, I had Gulf war related exposures.

- Moderator: If the Veteran feels that the question does not relate to them or their time of service: 

    - 3c. What would you add, delete, or change about this question to make it more relatable to you and your time of service? No I’m glad they put I’m not sure, there could then be follow-up and more detailed questions provided at their next checkup. 
...
4. On a scale from 1 to 5 (with 1 being very easy and 5 being very difficult), how easy or difficult was it to answer these questions about? A 1
   A 1.
...
2. Is there anything on here that is unclear?`
It basically expanded on the other page. And basically it’s trying to narrow down of those exposures it asks you yes or no on it is trying to narrow down which category you fit in. 
3. What about the first paragraph, anything confusing or unclear?
I wouldn’t use the word concerns, because you are just answering questions that you were asked if you wanted to answer. I would just end it at exposure. 
...
5. On a scale from 1 to 5 (with 1 being very easy and 5 being very difficult), how easy or difficult was it to answer these questions?  It’s 1. 
...
1. What do you think of this page?
   It’s asking if I could elaborate on what I may want to know about the possible toxic exposure. It gives me the option of text or email which is nice. 
2. What would you add, delete, or change about this question?
   Looking at the answers I believe it is very useful. I think the fact they’ll have someone contact you to talk about it or send you information regarding it is best to educate yourself about your health and your body to know as much as you can. 
...
They are very different. Claim exams going to get you possible compensation or registry exams is just going to get you into different categories of exposure veterans for when they may or may not have a study. 
...
I’m wondering how they’re going to know how you want to be contacted. It keeps going text or email so how do they know how you want to be contacted. 
    - b. How soon after you submit this questionnaire do you expect to receive a text or email with toxic exposure information and resources? I think a week at max but really maybe 3 days. 
    - c.	What do you expect to find in the information and resources? I would hope to find 1. Information of conditions they are already aware of. Or knowing what toxins or environmental hazards were in the area and what to possibly look for. 
    - d.	What else would you like to receive after completing this questionnaire?
    - e.	What do expect to happen next as a result of completing this questionnaire? I would expect my provider to talk about it next time I go in. 
    - f.	Do you expect this questionnaire to affect your future healthcare in anyway, yes or no? Why or why not? I would hope it can, it should make my provider or specialty providers to know about things I have or may have to be on the look out for. 
...
- Moderator: If the Veteran selects “additional information”, then they will be directed to the next screen 4c- “Thank you for completing this screener…” page, then ask the following:
    - a. Is there anything unclear?
I know they are not going to be reviewed in real time. I would like to know how long it takes to get reviewed. 
...
Nope
    - i. On a scale from 1 to 5 (with 1 being very easy and 5 being very difficult), how easy or is it to understand this page? A One
