# Research Plan: Health Record (Allergies), February 2021

## Goals	
This research is to explore what Veterans find valuable about reviewing and updating their allergies list when completing a health questionnaire prior to a primary care appointment.
...
**Research questions**
- What data and features do Veterans find valuable when reviewing and updating their allergies list?
- What current pain points do Veterans experience when communicating allergy changes to their providers?

**Hypothesis & assumptions**
- Adding the ability to view and update allergies within the questionnaire help solve some of the Veteran's current pain points.
- Veterans will find some of the alergy data and proposed features valuable as well as be able to provide a prioritization between the items. 
...
- Do you have any allergies? (pass = yes)
