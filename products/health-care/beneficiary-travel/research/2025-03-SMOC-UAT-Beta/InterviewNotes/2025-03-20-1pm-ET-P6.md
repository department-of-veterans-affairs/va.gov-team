...
**5.** If you have submitted for travel pay in the past, how have you done so?
  - How often have you submitted for travel pay?
    - Yes, in-person with forms 
    - They needed the receipts for tolls. No receipts, use easypasss account 
...
**6.** If you wanted to submit for reimbursement for traveling for your appointment, where would you expect to do that?
  - When it comes to your travel reimbursement claims, what would you expect to be able to do on VA.gov?
    - they encourage to go to AccessVA, he thinks it's VA.gov
...
- What are you looking for?
  - click "request travel reimbursement"link  - expect to input information 
  - I complete claim within 24-48 hours 
...
- Probe: what do you think would happen if you clicked that?
  - Click "check claims" - past claims
- Moderator prompt participant to go to MHV home page
- Noticed payments section
  - click "check travel link"
  - "yes, there it is" (recent appt travel claim)
- Went emergency room after the appt, but wasn't a seperate trip - there were 2 almost identical claims
- Took a second, then realized one is milage and one is toll
- He said he was paid one way for emergency room visit, which he didn't understand and was surprised 
...
-	Probe: What would you expect to happen if you clicked that?
  - Past appts details
    - he said it would say - submitted for payments, before doing anything 
  - Unrelated note: Check-in with smartphone never worked 
...
- Instruction page
  - click on file link - he's confident he's eligible 
- All 3 questions
  - "it's easier (than BTSSS), obvious"- he's fast at going through all the questions
- Review page
  - read through and submit
- Confirmation page
  - clear it's submitted
  - he knew he could click on the link to check claim statuses. 
...
- 5 or 6 (10 being the most difficult), BTSSS is a 9. 
- Needs proper terminology to know which box to click on 

**7.** What would you change about this process? What makes you say so?
- Making more obvious and bolder
  - Eligibility is confusing (I ignore that, but others may and need to know if they are) - referred to the eligibility link on the instruction page. 

**8.** What would you keep and why?
- Compare to how it is now, all the pages after instruction are clear. 
...
- Went back to Appointments list page, then he was confused and lost on how to kick off the travel pay claim
- Not sure why it's (file link) under Payments on MHV home. If it's paid, then it should be there, not if it's for filing. 
