# WIP - Team Onboarding Checklist

Reference the [VA Platform Tools site](https://depo-platform-documentation.scrollhelp.site/getting-started/platform-tools) for detailed information and more links for gaining access
...
- [ ] Add to [ZenHub](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/platform/working-with-vsp/orientation/zenhub.md) (if applicable)
     ...
     - Chrome extension (if desired/needed)
- [ ] Add to DSVA Slack instance - [request ticket](https://depo-platform-documentation.scrollhelp.site/getting-started/Request-access-to-tools.969605215.html#Requestaccesstotools-Slack)
     - [ ] 1010-health-apps
...
- [ ] Testing
     - [ ] [TestRail](https://dsvavsp.testrail.io/index.php?/auth/login/)
          - Team has a shared account, check with PM
          - [User Guide](https://www.gurock.com/testrail/docs/user-guide/getting-started/)
