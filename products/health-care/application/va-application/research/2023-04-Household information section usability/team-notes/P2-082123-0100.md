...
Five is fine. It's easy to manuever. Likes that you can save it and come back. Handy if you don't have information on hand. Remembers applying for benefits and had to gather paperwork to finish.
...
Birth date error triggered accidentally.

Didn't notice fields were optional.

Questions have three lines for address. Mentions it being for overseas.

Address error triggered accidentally.

Email error message is weird. See screenshot.
...
Triggers error messages. Is pressing enter after many of the fields.
...
Have a copy of DD214 on phone. Would use that. And upload it. Would find a scanner if couldn't get it on the phone.
...
Would put yes. If I wasn't over 50 percent to get some service from the VA.
...
Added dependents on her own. Pressed enter and error message appeared. Seems to be doing that with several fields.
...
Collects SSDI and looked at add info for income. Surprised that other income doesn't include SSDI.
...
No trouble with this section. Mentions using keyboard to navigate the select menu. Mentions not in alphabetical order. For facility menu. Usually people don't go by clinic, but the big medical center. Would rather contact the VA, more of a preference; Doesn't know when they would call.
...
If I had anything incomplete. Assuming I had everything right.
...
Would double check info and make sure it's accurate. Changes state to other because of PR not listed. Territories not listed. Mentions people being born on bases.
...
Seemed pretty easy. Cool that you can print a copy. Likes the highlighted sections. Wants to print the conf. page. Always good to have a hard copy of application. Wants a time frame on the process.

## Post-Task Interview - 5 minutes

- [NPS Question]
- How likely are you to recommend this online application to another Veteran? [Scale of 0 - 10] 10

- Did any of the questions stand out to you as unnecessary?
- Did anything seem to be missing?
- Audio broke up. Mentions SSDI not being counted as income and how that wasn't clear. Maybe a photo ID too so people know it's the right person.
