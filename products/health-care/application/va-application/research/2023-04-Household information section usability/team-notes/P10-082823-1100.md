...
- **Are you comfortable if we decide to use a recorded clip from our discussion today to share with other VA partners, if we remove any information that can be used to identify you?**
   ...
   > Zoomtext screenreader, enlarged text. Unable to get the screen reader. Above 50% disability rating.
...
- [If participant says they would sign in] What method/login would you use to sign in? How often do you sign in to VA.gov?
   ...
   > Generally, would sign in to a normal application.
   > 
   > "Information is fine and linear"
   >
   > Lots of information at the bottom, the help at the footer, there would be an information fatigue.
   >
   > Rating of 3/5, looks like there are multiple options.
   > 
...
- Could you please complete this section of the form and talk aloud about what you would need to do as you go.
   ...
   > He likes that the red text came up when he didn't put in the correct information.
   > 
   > He likes the progression bar since it gives him an idea of how long the application will take.
   >
   > Wants text such as "City" and "State" to be bold and wants things to be of higher contrast.
   >
   > The Required in Red is helpful to catch his attention. He likes it.
   > 
   > Would be ready to start the application right away.
   >
   > Use the pre-fill to fill out the email and phone number.
   >
   > Normally would check on Yes for over 50% disability
   >
   > 
...
- Can you tell me more about what you would have to do to get this document and complete this task?
   ...
   > Have the item scanned into the computer harddrive and it would not be a long process since he already has the information in the computer.
   >
...
- Talk through what the content means to you and what you would do.
   ...
   > The first thing in his mind is tax information.
   >
   > Noticed that the page loaded to the bottom of the screen.
   >
   > Would normally share financial information to apply. And since he is an avid computer user, he scans and saves his financial information when he receives it. 
...
- Please answer the questions on this page and proceed through that scenario. You can use fake information for fields like SSN and I can help prompt you with information if needed.
   ...
   > Tax forms would be where he gathers this information and where the dependent's information would be.
   >
   > The information is repetitive but he would carefully read the information.
   >
   > No probably edited the dependent's information. And likes that when he hovers over Remove, it turns the remove into a hover state. The warning box really captured his attention.
   > 
...
- In real life, how long would it take you to gather and make sure you were entering the correct information here?
   ...
   > He would pull up this information on the tax forms.
   >
   > College; he pays close attention to word usage to ensure that it is him versus his dependent the form is referring to. 
...
- What are your impressions of what this page is asking for and why it is needed for this application?
   ...
   > He would not select essential coverage since he already has it. He would make the text underneath to be larger.
   >
   > He has used the VA location before and expects a USA map where he can locate the facility when he had 20/20 vision.
   > 
...
- Before submitting, let's say you wanted to review what you entered for your dependents and correct some informaiton there. Can you walk me through how you would do that?
   ...
   > Would use the expand button to look through whether the information he has entered is correct prior to submitting his application.
...
- Would you do anything on this page or pause before moving on?
   ...
   > He feels good that he has submitted and the green check is a good indicator.
   >
   > He would not print the confirmation but save a PDF. Then log off and close the browser.
...
- Any questions for me?
   ...
   > Rates it 10/10
   >
   > Unnecessary question? Everything was sufficient
   >
   > Anything missing? Every question was sufficient
   >
