...
| 6/27/2024 | EZ/CG internal team | We'll deploy the updates to the EZ TERA questions in three major deployments: one for the branching logic and any content updates that must be incorporating with that; one for updates to the Gulf War question; and one for the rest of the content updates | The team wants to explore how to make smaller deployments to avoid a lot of errors and show impact faster. In our team retro [Mural](https://app.mural.co/t/emilysworkspace0583/m/emilysworkspace0583/1701109383836/74304ab51e18f488e47f8ad0de64bfdd376c932c?sender=u6fff32ce5369ba9338a16331), we decided to split the EZ TERA updates into separate deployments. |
| 7/30/2024 | EZ/CG internal team | We'll have to base TERA branching logic on birth date instead of service dates for now. | The 10-10EZ currently only gathers the last branch of service and the 10-10EZR doesn't gather any service dates. We would have to ask the user to include all service dates just to show or hide certain TERA questions and it'll be faster for the user to just go through all TERA questions. Since we gather birth date in step 1 of the forms, that can at least eliminate some questions that obviously do not apply to the user. |
| 7/31/2024 | HEC stakeholders | We'll use the age of 15 as the youngest age a user may have entered service to base our branching logic on. | HEC stakeholders said this age is safe to assume is the youngest age someone may have entered the military as far back as the Vietnam War era. They said in those times, many service members were able to falsify records and reort that they were older than they actually were. |
