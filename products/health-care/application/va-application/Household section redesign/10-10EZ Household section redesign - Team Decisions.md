...
- After reviewing metrics, previous usability and call center feedback, the team agreed that a redesign on the Household section of the 10-10EZ would help make the form easier and less painful to complete.  Nick provided an overview of suggestions for the section, and Heather provided metrics showing applicant dropoffs (page exits) higher for the pages in the Household section, than any other pages in the application.  
