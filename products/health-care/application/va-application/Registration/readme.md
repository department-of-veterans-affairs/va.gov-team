...
- Reference [Bi-weekly Stakeholder meeting notes from 6/22/22](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/health-care/application/va-application/product/Bi-weekly%20Stakeholder%20Mtg%20notes/6-22-22%20Biweekly%20Health%20Care%20app%20update.md)
...
These are the following confirmed use cases for registration over enrollment.  Most of these are not applicable to the 10-10EZ online application.
...
|Event|1 Month of Data|2 Months of Data|3 Months of Data|
|--------------------|-------------------|--------------|---------------|
|Future Discharge Data| TBD | TBD | TBD |
