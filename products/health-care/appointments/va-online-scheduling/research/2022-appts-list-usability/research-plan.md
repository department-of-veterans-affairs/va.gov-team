...
At the same time, the Health Apartment team has been working on designs to integrate MyHealtheVet into VA.gov. These include a side navigation with scheduling options that will show on the VAOS home page.

Finally, the VAOS team wants to evaluate potential changes to the appointment details page content and navigation.

Building on those activities, this research will evaluate:

-   The usability of the redesigned appointment list

-   Options in the new navigation to be introduced by the Health Apartment team
...
-   Provide recommendations about the Health Apartment navigation to that team.
...
We'll run a moderated usability test on the appointments list redesign and health apartment side navigation.
...
Perigean will recruit 15 total participants for this study. We will ask Perigean to treat each of three groups as a separate recruitment effort: mobile, desktop, and screenreader users.
...
[TODO add demographic screening criteria]
