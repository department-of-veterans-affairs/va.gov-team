# Research Plan for VAOS Appointments and After-visit Summary Usability 
...
Futhermore, Within VA today, Veterans at certain clinics are handed a printed AVS when leaving their appointment, providers can review an AVS with them during their appointment from CPRS, and select Veterans can view a PDF version of AVS on My HealtheVet. We created a new AVS MVP experience on VA.gov.

- [AVS UT presentation 9-15-16 final.pdf](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/health-care/digital-health-modernization/mhv-to-va.gov/avs/research/AVS%20UT%20presentation%20%209-15-16%20final.pdf)

- [Research Plan for AVS on VA.gov MVP May, 2023](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/health-care/digital-health-modernization/mhv-to-va.gov/avs/research/2023-04-MVP-Usability/research-plan.md)
...
The goal of this research is to twofold: verify that logged in Veterans are able to utilize recently added features, the After-visit summary MVP, (UAT) and also to understand their mental models as they navigate through Appointments with the updated navigation and UI chanages (Usability). 

Goal 1: (UAT) Verify that logged in Veterans are able to utilize recently added features and data is populating as expected.

Goal 2: (Usability) Understand their mental models as they navigate through Appointments and the After-visit summary MVP with the updated navigation and UI chanages. 
...
2.	Are participants able to navigate through the after-visit summary feature? Do users mention any information within the AVS as confusing when unprompted? 
3.	Does each interactive element of the AVS behave as intended? 
4.	Is all AVS information displayed as intended?
...
7.	Can screen reader and low vision users access and easily navigate the AVS? 
...
- Validate the After-visit summary's interactive elements are behaving as intended.
- Validate the After-visit summary is accessaible for screen reader and low vision users.
...
-   They will be able to navigate to a past appointment's after-visit summary as expected.
...
We'll run a moderated usability test on the appointments list redesign and the newly added after-visit summary MVP feature.
...
4.	Have you had any VA facility healthcare appointment between the dates of TBD and TBD?
...
1.5 hours for Screen reader and low vision users.
...
-   Research guide writing and task development (usually but not always same as moderator): Melissa Lefevre, Ciera Maddox, and Nina Anusavice.
