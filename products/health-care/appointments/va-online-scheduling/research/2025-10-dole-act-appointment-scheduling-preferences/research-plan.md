...
Currently, Veterans lack streamlined, user-friendly self-service options to specify and update their health care preferences. This limitation leads to inefficient scheduling processes, increased administrative workload for VA staff, more frequent missed appointments, and a less personalized experience for Veterans. The creation and implementation of self-service appointment preference options on VA.gov delivers significant business value by enhancing operational efficiency, compliance, and Veteran satisfaction.

Empowering Veterans to directly manage their appointment preferences streamlines the scheduling process, reduces administrative burden on VA staff, and minimizes scheduling errors. Real-time integration between VA.gov, the Integrated Scheduling Solution (ISS), and VA Profile ensures accurate, up-to-date information, supporting timely and effective care delivery. This initiative aligns with the VA’s priorities to modernize and simplify access to benefits and care, while ensuring compliance with the Senator Elizabeth Dole 21st Century Veterans Healthcare and Benefits Improvement Act of 2025. Ultimately, this request strengthens trust in VA services, improves health outcomes, and positions the VA as a leader in Veteran-centered digital health solutions
...
## Product Brief
**E. Dole Act, Section 145 Appointment Scheduling Preferences product brief** 
...
- Understand how Veterans expect VA to utilize their preferences, such as what workflow do they expect to be adjusted based upon their answer
...
- In what scenarios or use cases would Veterans prefer to use the self-scheduling feature vs. having a scheduler make the appointment for them and why?   
...
- What would Veterans change about the MVP?
- Prototype: Do Veterans mention any problems or use cases that the prototype solves or does not address?
- Do Veterans want to see any metadata about changes to a preference? 
- Do Veterans propose additional preference types?  
...
## Methodology
- Moderated, one-hour interviews/concept testing prototypes.
- To mitigate potential bias in how interview questions might affect participants' interactions with the MVP prototype, or vice versa, the 12 participants will be divided into 2 main groups. Group 1 (6 participants) will first answer interview questions before interacting with the prototype, while Group 2 (6 participants) will interact with the MVP prototype first and then answer the same interview questions.
- Within each of the 2 main groups, participants will be further divided into 3 sub-groups, with 2 participants in each sub-group.
 
- Group 1: Interview then MyVA landing page prototype interaction
...
- POC: Slack feed-back channel and MS Teams chat
    ...
    - Tim Licitra
    - Kristen McConnell 
- Equipment: Veterans may choose to use their assistive devices during sessions; subject to participant recruitment.    
...
## Recruitment
- We will partner with Perigean to recruit 16 Veterans; all efforts will be made to recruit a diverse sample, with participants from the following demographics:
    - Education
    - Sex
...
- Total participants requested: 16   
...
4. Have you been diagnosed with (formally or informally) a cognitive disability? This includes any intellectual disability, ADHD, Autism Spectrum Disorder, severe, persistent mental illness, brain injury, stroke, Alzheimer's disease and other dementias, or others not listed. This question helps us make sure we get feedback from all the people we serve.
   ...
   - If "Yes", then recruit at least 2 for cognitive disabilites.
   - If "No", then recruit for other demographic requirements.
   - If, "I prefer not to answer", then recruit for other demographic requirements.
