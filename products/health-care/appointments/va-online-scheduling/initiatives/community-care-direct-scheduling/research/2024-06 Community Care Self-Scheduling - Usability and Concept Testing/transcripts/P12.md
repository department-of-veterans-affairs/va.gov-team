...
- Have you used the Appointments tool on VA.gov to schedule and manage your health appointments before? Yes I have, for scheduling and cancelling. 

- And what device are you using to join this session today? iphone

- So, I will be sharing a web page link with you during this session. How would you prefer to receive the link? For example, I could send it through the Zoom (messages) chat or email it to you.   Chat

- _If the participant is using a screen reader: 
...
- _If the participant is using screen magnification: 
...
- First off, have you received care from a community care provider before? (You don’t need to talk about what it was for.) Yes.
  - _If yes: Could you talk me through how you got that (or typically get that) appointment scheduled? Usually it’s a pain, you have to tell your provider and they send it to someone for authorization, and it can take two to three months before you get an appointment.
I use secure message to message my doctor
...
- What documentation would you expect to receive from your VA provider to receive care by another provider? Two separate documents authorizing a doctor that I don’t get a choice in, and it says for whatever length of time. I received it in the mail. I appreciate having the hard copy. I’ve never seen it digitally, I would like to have it. 

- And, what information would you expect to be included in that document (or documents)?

- Where would you expect to be able to find a record of that document on VA.gov, especially if it required you to self-schedule an appointment as a next step?  My health e-vet.
...
- Ok, I’ll have you stop here. Could you tell me if this is where you were you expecting to end up after selecting the link in the text message? Yep, it led me right exactly to where I thought it would.
...
- Now let’s review what’s on this page. Can you briefly review the page and tell me about it?
  ...
  - _Things to watch for:_
    ...
    - _Do they mention the expiration date of the referral?_ It says right here it expires in 310 days so you know how much you have. I think that is too many days, if it is something we need care for we need immediately I would say 60 to 100 days. It is an immediate need. Sometimes people have things so 180 days might be good but 310 days is a lot of time. 
...
That’s the preferred provider for the VA. Does that mean who they would cover? If I choose someone else is my referral still going to be covered. 
- _If expiration date was not mentioned:
...
The date is better than the 310 days, it makes it more concrete. 
I would click on schedule your appointment. 
I like that it shows male or female, the distance next available appointment. 
---
...
- Ok thanks. And, what would you do if you wanted to search for a specific group or category of providers? Filter
...
- Tell me about this page.
It’s easy to use. Online scheduling is good we play phone tag with people often. The filter gives me a better choice of who I want. 
- Is there anything confusing about this page and the information included here?
  Same address for providers but drive time is different. 
...
It’s all pretty good, who the provider is, their credentials, their location and availability. 
...
- Is there anything confusing about this page and the information included here?
  No this is everything I would like to see. 
- Is there anything missing you’d expect to find on this page?
Details shared with your referring VA provider,, just saying back hurts is not enough. More detail why you are here. Like broke back a few years ago, there should be more information. 
...
No this is my thing; I do everything online. I love doing these studies I’ve done them before and I love helping.
- Without selecting anything, what would you do if you wanted to change some of your appointment details?
I like that I can edit it if I didn’t meant to choose that provider. 
Could you move to cancel appointment up to review your appointment, schedule appointments in the green box. 
- And what would you expect to happen after selecting the edit link?
Would like to be able to go back when you click the back button, but it takes you back to the scheduling page. 
...
- Earlier, you mentioned that _______. **_(RECAP where the participant expected to find referrals from their earlier responses.)_**. Blue Doc, or my health e-vet
...
It shows dental has been approved, podiatry is going to be a video, primary care and cardiology are not ready to be scheduled. It says pending, but it also says details so I wonder if I click on details would it show that it was scheduled, and I didn’t know it. 
...
- Do you have any other questions for me or additional comments about what we’ve reviewed today together? No! That was good, thank you so much. I really enjoy trying to make things easier for veterans. 
  I wish I had known when I first got out about what the VA has. I didn’t know until like 25 years after I got out what there was. 
- Ok, and just curious, would you expect VA to contact you if you haven't self-scheduled your first appointment leading up the referral's expiration date? Most of the time they are so short-staffed they can’t reach out to you. I am sure they don’t even see it. I am still waiting on a referral from 6 weeks ago. 
...
- _If the participant agreed to record this session:
