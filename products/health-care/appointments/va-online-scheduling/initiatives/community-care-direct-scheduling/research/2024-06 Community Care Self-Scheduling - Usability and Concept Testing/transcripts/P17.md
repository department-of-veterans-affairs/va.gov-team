...
- Have you used the Appointments tool on VA.gov to schedule and manage your health appointments before? No, I’ve tried, and I just kept getting lost. I can check and cancel appointments but it’s too cumbersome to try to schedule an appointment. 

- And, what device are you using to join this session today? iPhone
...
- _If the participant is using a screen reader:_
  - Are you using a screen reader or other assistive technology today? If so, what type? (For example, VoiceOver.)   I use VoiceOver
  - And, how would you rate your level of experience with using that technology - beginner, intermediate, advanced or expert? Intermediate, I know how to move it around and do things, I sometimes get lost.
  - How long have you been using that technology? Off and on for a couple of years, I get mad at it and then switch over to my computer. Maybe 4 years on the phone.

- _If the participant is using screen magnification: _
  - Are you using a screen magnification tool today? If so, what type? (For example, Zoom.) I use it sometimes if I am in a spot. Seeing AI, Be my eyes
  - And, how would you rate your level of experience with using that technology - beginner, intermediate, advanced or expert? I use it all the time.
...
- First off, have you received care from a community care provider before? (You don’t need to talk about what it was for.)Yes
  - _If yes:_ Could you talk me through how you got that (or typically get that) appointment scheduled? With the primary care doctor, then the community care person contacted me. It was all via phone. It took several weeks, the whole process up to the appointment it took a month or so.
I got a letter from the provider, and the community care provider called around the same time. The letter said that I was approved for community care but no information of who, or what or why. 
The letter basically told me what community care was, that I had been approved, and a PO number or a number. It was basic information like that. It did not say where, who or what type of care.
...
- Where would you expect to be able to find a record of that document on VA.gov, especially if it required you to self-schedule an appointment as a next step? The only way I know to find the letter is to go into the Blue whatever, that’s the only place I know to find that letter. Then to schedule the appointment, all I know is to go to appointments. Then it lists my appointments. But I don’t know how to schedule the appointment. 
...
The bottom part is laid out like my stuff is already laid out, like the list of appointments. I use this down here where you can look at your appointments, and I look at details, but this one doesn’t work. It’s asking me to schedule my appointment for community care, and at the bottom it tells me if I need help who to contact, 
It tells me who the appointment is with, community care, and to schedule it.
  ...
  - _If needed:_
    - What did you expect to be on this page? Yes, I think that this is good. 
Knowing the date is out there I would schedule it right away, it is something that I talked to my doctor about, and it is important to my health so I would schedule it right away. 
...
So far it looks… We have the details about the referral, it’s telling me if the appointment has already been made to go to my appointments. 
...
Preferred provider, is this my VA provider, or preferred person in the community? I don’t know. I would like it to say preferred community care provider. 
...
*** Participant played around and navigated through the scheduling system on her own, skipping a lot of the questions and process. After playing around for a bit; Ben referred back to a comment made by participant about how when Dr. Mike was listed with the next available date it did not show a time. Ben asked if it would be beneficial to have a list of times available. Participant stated that the process is a bit tedious trying to navigate to the time. That it would be helpful to show the times and a statement that says click to choose a time and schedule the appointment. 
I am the type of person that likes things short and sweet. I have worked with blinded veterans that get frustrated and wanna throw the phone, or computer across the room. 

_**Participant is on choose time and date page:**_
- Is there anything confusing about this page and the information included here?
  The screen reader was not picking up the continue button.  There is a glitch that goes from back, to optional and then continue so it is a little confusing. 
Participant’s only confusion is a glitch between prototype and screen reader. 
...
All the information is there that I need, I like that the time zone is in there. There is an option to edit if I need to change anything. 
...
Schedule New appointment. Is that a different appointment or do I need to change that appointment? Am I scheduling a follow up appointment? It says new appointment which is good, and I would figure this out. I’m thinking about all veterans and their perception. It needs to say something other than schedule a new appointment. 
...
- Great. So, earlier, I asked you an open-ended question about where you would expect to find a list of your referrals. So, now, I’d like to get your feedback on an early concept for where those referrals might be located in this tool. I would probably just go down through here and see if I saw a link to referrals under my appointments. Under appointments I think I would be looking for referrals to be scheduled. 
...
- And again, without selecting anything yet, where would you go on this page to review your older referrals from appointments you already completed? That’s another thing I have ran into with appointments, if I want to go back and see there is no search, you just have to go through and look at past appointments.
...
At dental referral ,it says schedule appointment. It doesn’t say who it is with so I have to scroll through to find who it is with. 
Participant goes back through and realizes she skipped over the dental part. After rereading it makes more sense.
Continuing to review the page, where the podiatry appointment says video, she explains that all appointments should say in person or video. Their screen reader technology get’s very detailed and this would be of benefit to them. 
...
- Ok, and just curious, would you expect VA to contact you if you haven't self-scheduled your first appointment leading up the referral's expiration date? Yes I would expect to receive a call, even if  it was a robo cal. 
   - And, when and how would you expect for VA to contact you? (_If needed: For example, one week before the expiration date, one week after the referral was approved? For example, on VA.gov, by phone, by letter?_) I think within 7 days, if you haven’t heard anything from them they should call or email. I think it should be a call, some older veterans or caregiver might not see the text message. 
