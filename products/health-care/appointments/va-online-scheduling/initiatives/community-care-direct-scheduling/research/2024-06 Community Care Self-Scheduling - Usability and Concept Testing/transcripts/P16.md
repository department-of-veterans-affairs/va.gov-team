...
- First off, have you received care from a community care provider before? (You don’t need to talk about what it was for.) Yes I have
  - _If yes:_ Could you talk me through how you got that (or typically get that) appointment scheduled? I put in a request with my primary care physician. Someone from my home base VA hospital contacted me and gave me a list to choose from. 
For specialist no paperwork, for chiropractor I did get some paperwork. It was an introductory thing that said I was scheduled to see a chiropractor, and when who to contact if I needed to. 
...
I have my wife do that, it is frustrating and not easy to use with JAWS
-------
...
```
We were unable to get his screen share to work. 
---
...
Appointments, start scheduling, it says expires in 310 days. 
What do you think expires in 310 days? Either the App or me I don’t know. 
Did you notice where it asks you to start scheduling? I did originally but it’s jumped to something else now. Right now… Participant keeps cutting in and out. 
...
It says choose your therapist. It seems pretty straight forward. 
...
- **Did you notice the "Filter and sort" link? Okay, now go ahead and select that link.**
  I’m not finding it. It says preferred provider but it doesn’t have a link… Continues to cut out.
Ben has him navigate down to Dr. Christina Jones and the link to review appointments. 
---
...
- Is there anything confusing about this page and the information included here?
  I don’t know what’s going on… cuts in and out.
- Is there anything missing you’d expect to find on this page?
...
Participant is struggling with the link and also cutting in and out. He does not know if he is even in the web browser. We tried to email him the link. 
At this point Ben decides to stop the session. 
