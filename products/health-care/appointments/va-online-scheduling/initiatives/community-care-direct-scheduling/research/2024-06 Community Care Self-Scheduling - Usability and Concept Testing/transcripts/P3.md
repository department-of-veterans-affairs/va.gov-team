...
- Have you used the Appointments tool on VA.gov to schedule and manage your health appointments before? No, I have looked at it but I don’t care for it. I don’t like it for prescriptions or anything else, I will use it for my letters but that is it. 
...
I guess so yeah, it goes straight to appointments, Start scheduling. Schedule an appointment, it expires in 310 days. I’ve got 3 appointments pending for August 1st, and August 5th and I don’t know what the third one is it doesn’t show me. 
- Now let’s review what’s on this page. Can you briefly review the page and tell me about it?
I should be able to go to schedule your appointment and schedule my appointment form there. 
...
If it is for physical therapy like this says, that isn’t true. Physical therapy had 60 days and you get 9 appointments. I have never had one last this long. 
  - _If needed:_
...
Click on the schedule the appointment. 
- _If task card was not mentioned:_ 
  - Did you notice anything about a scheduling an appointment? 
Expires September 1 physical therapy 10 visits normally it’s 15, the referral number, then I would go schedule the appointment. 
...
No, if I had questions about the date or what it was for I could review the referral. 
...
- Ok, and before you do anything here, I have a few more questions: 
   ...
   - What are the most important factors to you when choosing a provider? Let's say, to find a new primary care provider for routine care? I get no option, I have whoever is local. For PT there are 4 or 5 different options. But my primary is the only one and it takes 6 months to see her. I use secure messaging with my primary and they send a consult, I don’t even go see her. 
I go to ones I have gone to before and liked them, or if I have never had someone in that particular area of care, I ask friends for who they like. I live in a small area and have to drive 90 miles for most things. 
...
I think it is set up with Mike, but there are other providers I can go to. If what they give me for Dr. Mike doesn’t work for me ,I could look at view available appointments and go from there. I don’t know anything about any of these providers so I would look at availability that works for me. But if my friends use Dr. Jason I would click on review available appointments to see if there is something that works for me. 
...
- Ok thanks. And, what would you do if you wanted to search for a specific group or category of providers? I don’t know. 

- Go ahead and walk me through how you'd do that.
  I could filter based on distance. I want one that is closest to me. I can also do practice, male or female
...
- Is there anything confusing about this page and the information included here?
  Not necessarily. Show providers with only online scheduling.  I would like to have their contact information not just the address. 
...
Health first medical group, female provider, and show providers with online scheduling.
---

_**Participant is on 2nd provider page:**_
- Tell me about this page now.
  4 providers all female and all at the same practice. Now I can schedule an appointment. 
...
I would click on the 26th and then pick whatever time you have it programmed to. 
---

_**Participant is on review/confirm choices page:**_
- Is there anything confusing about this page?
You have a default for 8:30 am on here. If that didn’t work I would click on edit and change it.
...
I could go back and change the time. 
...
This is exactly what I would expect. Your preset information is different then what I picked but if it was real it would all work out. 
- How is this similar to or different from what you expected to find after you just confirmed the appointment?
I would expect the VA to be able to send the right documentation to my provider as well as to me. 
