...
- First off, have you received care from a community care provider before? (You don’t need to talk about what it was for.) Yes. 
  - _If yes:_ Could you talk me through how you got that (or typically get that) appointment scheduled? I believe the last situation I had because the VA was out a little far they authorized me to use Community care. They told me to stand by and the provider would call me once they got the referral. 
...
- What documentation would you expect to receive from your VA provider to receive care by another provider? I would probably need an authorization document.

- And, what information would you expect to be included in that document (or documents)?
The authorization document would include what I am being seen for, my demographic information and an authorization code. 
...
Probably go to my appointments. That’s where I would first look.
...
I would go to my health to start and see if it is there. There is also a search box if I need to search it out.
If you used a search what would verbiage you search for? Authorization see if that popped up on my account. 
-------
...
No this is super straight forward. 
...
Yes. It says my name and my information.
- Now let’s review what’s on this page. Can you briefly review the page and tell me about it?
The first thing I see is the newest it says start scheduling.  It shows me previous appointments and contact information if I need help.
...
- _If expiration date was not mentioned:_
  - Did you notice the expiration date for scheduling an appointment? And, what was your reaction when reviewing it? Yes it was a long amount of time. I have plenty of time I don’t have to worry. I would schedule it now or later. I would schedule it now. Sooner vs. Later                  
...
No it’s straightforward to me, I like it tells me how many visits I can schedule. It tells me the provider and the location.
- Is there anything missing you’d expect to find on this page?
No not necessarily.
- How clear are the steps for what you should do next?
The green arrow that says schedule the appointment. 
- Ok, and before you do anything here, I have a few more questions: 

   - What are the most important factors to you when choosing a provider? Let's say, to find a new primary care provider for routine care? Not a long wait, ease of getting in there, location to either work or home. 
...
I see preferred provider is at the top with all of their information. I like that the distance is there I can see how far away they are and they show the next availability. 
...
- Ok thanks. And, what would you do if you wanted to search for a specific group or category of providers?
	The filter and sort button would be my best bet.
...
- Tell me about this page.
I can sort by distance, practice, on line scheduling, and provider gender.
...
No not really but for me everything I think I need is right there. 
[ONLINE SCHEDULING FILTER]

- _If online scheduling option was not mentioned:_ And what about the third filter on the screen? what does that mean to you? If I only want to do it online I would click the box, but if not then I could just pick a provider but I might have to call the office. 
 
- _If not yet mentioned:_ And, if the provider you knew you wanted to schedule with did NOT have online scheduling, would you still expect to find information on that provider in this tool? If I click on the box then no. 
    - _If yes:_ What information would you expect to find for that provider?
    - _If no:_ Could you tell me more about that? Why not? 
 
- And if the provider you preferred to schedule with didn't offer online scheduling at this time, would that change your decision on who to schedule with? Circumstantial, not necessarily I don’t mind making a call.
...
- Tell me about this page now.
  It’s still showing the preferred provider, and 4 aditional providers that match the filter I selected. It shows me their address and gives me a list of dates. It provides a link to schedule an appointment. 
- What's your understanding of the provider list now that you selected those filter choices?
  - _If needed:_ How has the page changed? It shows the 4 people that match my filter.
  - _If needed:_ How do you know that those choices were selected? It shows the criteria 
...
- Is there anything confusing about this page and the information included here?
  I don’t see anything super confusing. It shows the provider's name, available dates, location, and a calendar that I can schedule from. 
- Is there anything missing you’d expect to find on this page?
So far just shows the date, no time but I guess when I click it, it shows time. 
...
Review page, shows date and time, the reason I am being referred, physical therapist. I like that if I remember I had something going on I can click back to the date and time. 
---
...
- Thank you. And lastly, how would you expect to be able to cancel or reschedule this appointment if you needed to?
  I would just click on this an die would walk me through it.
- Do you think you would have to call the community care provider to cancel the appointment? 

I would expect it to notify her. 
...
At the top it says upcoming,  past,  or pending I would expect I could look there. 
...
I would click on the past appointments.
...
It shows the appointment and the information and canceled appointments. I like the canceled ones are crossed out. 
- How is this similar to or different from what you expected to find?
  I look at the stuff at the top as what needs to be dealt with. 
...
- Ok, and just curious, would you expect VA to contact you if you haven't self-scheduled your first appointment leading up the referral's expiration date? I use the VA app and get notifications.

   - And, when and how would you expect for VA to contact you? (_If needed: For example, one week before the expiration date, one week after the referral was approved? For example, on VA.gov, by phone, by letter?_)  A push notification.
