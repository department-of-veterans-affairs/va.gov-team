# Initiative Brief- Add Cerner Navigation Option on Appointments page in MHV on VA.gov
## Overview

The team will be adding the content instructions for when a Veteran will need to navigate to the Cerner portal and will re-direct th Veteran back to Cerner to manage their health appointments.

## Outcome Summary a

A user has clear guidance on how they will be re-direct to the Cerner. 
