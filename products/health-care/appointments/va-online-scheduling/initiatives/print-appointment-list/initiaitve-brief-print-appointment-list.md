# Initiative Brief- Print Appointment List
## Overview

Looking to improve the user experience in VAOS by having an option to print the appointment list page.  The goal is to be able to print the appointments list which is also available in MyHealtheVet tool. 
