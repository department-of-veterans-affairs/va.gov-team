...
Notes on decisions for above criteria: We assume that the IA doesn't need to be tested specifically on a mobile device as it is the tree only, not a wireframe designed for mobile or desktop specifically. We recommend recruiting for participants to conduct testing on mobile devices at later stages.
