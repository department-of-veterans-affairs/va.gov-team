...
[Preview the tree test.](https://adhoc.optimalworkshop.com/treejack/4b5t64uj) **>> See feedback on tree test at bottom of this page.**
...
4. Familiar with MHV, have VA healthcare, segmented by caregiver and dependent needs: **<< See edits and comments above.** 
...
## Feedback on tree test (RECONCILED ON 10/25)

**Updates to the Treejack tree:**
* In the tree, let’s change “VA health care” on main nav (tree) to ‘Health care.” Thanks!
* In the tree under Appointments, “Views…” should be “View…”
* In the tree under Appointments, remove VAOS and appointment email reminders. (Some of these labels were site map notes not intended as page names. I caught some of these before — and some I don’t mind keeping, but not all make sense as pages.)
* Under Track and research health > Track health > Health tracking devices and apps, remove “(links to mobile.va.gov”).
* Under Help and resources > MHV news and community > Subscribe, change “Subscribe” to “Subscribe to news.” 

**RE: post-task questions:**
Having Yes, No, and Other fields for some post-task questions could confuse the results. For example, a Veteran’s answer might be Yes, but when seeing the open text field, the Veteran might answer Other instead if the Veteran feels the need to comment — or feels pressured to comment. This comment ^ pertains to the questions after these tasks: 
1 (These questions are very binary. If we want additional feedback, we can add the question “Any other comments?” with an open text field.)
9 (definitely want to add a comment field here)

**Task 1 (community care)** - 
The 1st post-task question is not quite accurate, so let’s reword it. 
* Now: Did you know that VA provides care to Veterans through community providers when VA cannot provide the care needed?
* Reworded: Did you know that Veterans with VA health care can schedule with non-VA providers in certain situations?

I think we need to split the 2nd post-task Q into 2 questions.
Now: Did you know this is called community care and is based on specific eligibility requirements, availability of VA care, and the needs and circumstances of individual Veterans?

Reworded as 2 questions: 
* Did you know this is called community care?
* Did you know that community care is based on specific eligibility requirements, availability of VA care, and the needs and circumstances of individual Veterans?

**Post-test question:**
On what page would you expect to find anything COVID-19 related?
This should be multiple choice. COVID info will be in multiple categories (including appts and research health). We’ll get more out of the findings for this question if we let users pick more than one. 
