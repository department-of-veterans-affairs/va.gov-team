...
[Preview the tree test.](https://adhoc.optimalworkshop.com/treejack/4b5t64uj) **>> On the intro page, let's make some text updates to help participants with cognitive issues. Let's simplify the last 2 paragraphs on the intro page to this: "This study shouldn't take you longer than 10-15 minutes. < new paragraph > Your responses will help us organize information related to health care on VA.gov. < new paragraph > To begin, click the "Continue" button below."**

**>> Let's make these edits to the Treejack test instructions:**
Here’s how it works:
1. You will be asked to find a certain item in a list of links, which are in gray boxes.
2. Click through the list until you get to the answer for the task.
3. If you take a wrong turn, just go back! You can do this by clicking one of the above links/gray boxes.
