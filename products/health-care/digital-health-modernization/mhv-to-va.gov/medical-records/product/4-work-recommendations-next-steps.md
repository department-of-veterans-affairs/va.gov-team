...
The purpose of the [VA Health Summary](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/health-care/digital-health-modernization/mhv-to-va.gov/medical-records/assets/VA-Health-Summary-CCD_MHVZZVISNTWENTY_20220124_1607.pdf) is to ensure continuity of care between providers. It's a snapshot of a Veteran's health at a point in time, compiled by VA. A Veteran can use this report to review their VA health care and to share information with community providers, family, or others who help them with their health. The VA Health Summary's purpose is very different from the purpose of the [Blue Button Report,](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/health-care/digital-health-modernization/mhv-to-va.gov/medical-records/assets/Blue-Button-Report_MHVZZVISNTWENTY_20220728_1525.pdf) which contains all of a Veteran's health information and is compiled by the Veteran. 
...
- Give Veterans typical scenarios for using each type of report.
...
On My HealtheVet today, there is not a clear user flow for sharing the health data you entered into the My HealtheVet website with your VA care team. Surprisingly, some ~10K Veterans (unclear of the time period for this) have managed to share their health data, which lives in the "vault," where the self-entered data is stored. 

This will also require data storage and an interface on the VA staff side. 
 
### 5) Enable Veterans to share data from devices 
...
The DHP Team (Digital Health Platform) is working on enabling Veterans to connect their health tracking devices to VA.gov so they can share their health data. 
...
- Look at the [records section of My HealtheVet](https://www.myhealth.va.gov/download-my-data) while signed in.
- Talk to engineers about what data can be displayed. Share your ideas for how to display specific data with them and get their feedback.
- Gather analytics on the current records UX on My HealtheVet, as well as the pathways to there from 1) the [records section on VA.gov,](https://www.va.gov/records/) and 2) the [medical records page.](https://www.va.gov/health-care/get-medical-records/)
...
- Look at past findings for the records prototype and iterate on the design. Also create concepts for the screens under the records landing page. See the [mobile prototype](https://www.sketch.com/s/908b453b-ef8b-4193-b955-ea00f9fd14aa/prototype/a/0F31920D-6FE8-4239-8207-3F129FCEA6E4?hotspots=false) and the [desktop prototype.](https://www.sketch.com/s/908b453b-ef8b-4193-b955-ea00f9fd14aa/prototype/a/44472CCE-CE14-4CED-9B07-E87CFED3EFE6)
- Share the designs with Jonathan Nelson and My HealtheVet engineers, then iterate on the design concepts. 
