...
Our team identified and analyzed 32 previous studies that we thought were most relevant to re-analysis in order to surface any previously identified pain points related to comprehension + navigation that may still persist in relation to the My HealtheVet health portal on VA.gov and the broader authenticated experience. These studies were initially conducted by a wide variety of teams working on VA.gov, and vary in methods from card-sort and tree-test studies, evaluative research, generative research. Some broadly consider authenticated experiences on VA.gov, information organization, user needs for personalization and help, and more. A full list of citations to the 32 studies that were reviewed are listed below in the "Sources cited" section. 
...
List of all 32 studies included in our metasynthesis evaluation: 
