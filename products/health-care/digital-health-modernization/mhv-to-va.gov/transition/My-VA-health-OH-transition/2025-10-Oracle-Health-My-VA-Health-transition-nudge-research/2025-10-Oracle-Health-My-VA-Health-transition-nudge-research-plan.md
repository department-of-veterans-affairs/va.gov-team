...
| Understand how these users felt about previous transitions, and whether or not that impacts their sentiment this time | Attitudes to change questions | **Part 2: react to prototypes** includes some qualitative questions that are structured to unpack any user fears/feelings/concerns around the patient portal transition, and we believe will uncover any concerns around adoption.|
