...
Example tree test questions 


### Hypotheses
_Hypothesis 1:_ name 
...
Explain why this method is best. Should relate to the type of research questions you're seeking to answer. Given the range of methods out there, why is an unmoderated tree test the best for getting your the information you need to move forward?  
...
### Research materials
[Unmoderated tree test](set up and link)
...
1. List screener questions. Example screener -  

  Have you used an online patient portal in the past 12 months? A patient portal is a secure website that gives you access to information about your health, such as past doctor visits, treatments, or medications. For example, MyChart or MyHealtheVet are patient portals. 
