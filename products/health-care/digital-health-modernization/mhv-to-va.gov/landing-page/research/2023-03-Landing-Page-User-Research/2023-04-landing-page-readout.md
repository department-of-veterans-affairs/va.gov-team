...
**7. When asked to update settings that would allow users to get appointment reminders and track refill notifications (currently are located in VA.gov Profile), participants looked to accomplish these tasks under the “Appointments” and “Medications” sections of the landing page (rather than the Profile).** 
