# Participant 7 Conversation Guide: AVS MVP to VA.gov, June 2023
...
2.	What would you call or name something like that?  ...A review of medical records.....
...
-	Now pretend that today is June 6th, 2023, and you are Hector.  You had an appointment this morning at 9:50 am with Dr. Nutt, your primary care physician, at the Puget Sound VA facility. A few hours have passed since your appointment, and you forgot what your doctor's instructions were. Use this prototype to find out what Dr. Nutt and you discussed at your appointment. Please think aloud as you are trying to find this information. 
    ...
    - [**Moderator Note:** Only assist if they have difficulty locating the After-visit summary. Continue with the below questions once the participant navigates to the After-visit summary page.]i find it veruy useful if I ...hyperrlepida...i dont know what this is....for trafel ...alllegies incase you end up in hospital incase ......yes this is very helful/
...
1.	Please review the info on this page and share your overall impressions. Think aloud as you review. 
    ...
    -	Would you use or not use this page and why? ...i would call the clininc and ask to speak to my nurse...i do, but something like that I would call the nurse or send a messgae ....I would go sown to health histroy...... (care summires and notes, participants alittle confused, Moderator helped to get to After visit summary)...  the are my diagnosis, it tells you kind of whats going on....it tells you my bloood pressure, they should probly put wight in pounds...the height and weight should be in US..because some peoplw won't knnpw what that is... oh body vat.....so hes referming to rhematologist, and prodcdeure...this is where they got the flu shot....when was the appoinment...other instrustions, call dr smith when you return... as of this apoointment, problem list should be high on the radar so it does not excaberate ....hypolendima.
...for me i am not going to use it for my phone i am not using it on my phone. if on my desk top thenm I will use it. if I was on vaction I would pull it up or 
2. Did Dr. Nutt want you to complete or do anything following your appointment? 
    ...
    ...why would you have medicals that your not using because that can be an exstensive list.... I dont understand why this would be here unless somewone had a blood dieadse if there was a medications if they have a blood diease...i dont know the benefit of the medications of why youre not taking......well for me i live in blloimnginto....so the main one in indiapolis, they outsource me to different medical providers, so when i go go Idian univserty heath, all my records , i would tell my doctro ...it would be in the record already,, unless they are not provactive or maybe not mentally competent then..O dpnt lnow how you can list all those medications.
(PARTICIPANT DID NOT UNDERSTAND WHAT MDOERATOR MENT WHAT DR NUTT PRESCRIBED AFTER APPOINMENT)
...
3.	If you could provide a definition of the information that is included within the “You were diagnosed with” section, how would you define that information?
    -	[**Moderator Note:** If the participant doesn't correctly describe the content's purpose, then ask:] What if the title of the section was “Health conditions you discussed?” How would you define this section then? YES TOU WERE DIAGNOSED with everything that he found today some of them were probpaly there prior.
    -	How valuable or not valuable do you find this section? Why? health discussions is different than what you were diagnosed with those sound as 2 different sections tome. for me i found the m valbiuable...so the more info the better...
...
5.	Ask participants to stop and open the medication glossary and review the information while they are talking aloud. [**Moderator Note:** Try to get general feedback on the glossary terms.] ...so i ask them to write it down blood pressure in purlse....weight and wight in us...i think body mass is good but i dont know hwat theat menas so it should list obese , morbidldy obses...meciations that they gave me in the clininc.
...
for me i wan t to know what i med i got and what shots i got..i would use computer i would not use telephone.

---it doesnt tell me what it is it just what is active or non active..i want to know why they gave me that information....
## Task 3: Your Treatment Plan from this Appointment - 7 minutes
Now, I would like you to focus on the “Your Treatment Plan from this appointment” section. Please review this section by slowly scrolling through and thinking outloud again. ...this is good ,,he leting me know if the calling me to schedule an tehtology appoinment....consultation for Rheaumatology.... okay...lab tests that good to know nolonger neded tofast ...so these would bbe...i think it would be helful if the lab will be blood or urine lab,,,if they are going to set me up for lab,,, i want to know if fast or non fast....
1.	How would you utilize the information within this section? the active and non active could go away iwould like to have the defintionof why this mediaction was precribed.
...
4.	Okay great, so how would you describe the information under “Medications and supplies”?
    -	How does the “Medications and supplies” information in this section differ from “Medications ordered for administration in clinic” under the previous “Your appointment on June 6th, 2023” section?**   ....only list changes to your medication(reading)
...
if administered in clinic its a 1 time thing or just to get you going if youre going to start soemthing.....
...what do these medicationterms meam. i dont understand this... fyou no longer need the medication, i may take you of this medication...i dont understand what this is saying....so these are health reminder to make you aware? is that are just general information, so If im up for my tenatince shot for 10 years that good
...
1.	Can you provide an example of how you might utilize the information within this section?  okay gives me the date...tells me who I sae...they next upcoming appointment....
2.	Are there any terms that seem unfamiliar or confusing to you?
...
3.  Okay, please continue to scroll further. [**Moderator Note:** Stop them at “Recall Appointments”] What is your understanding of “Recall Appointments?" ...i dont know its kind of confusing to me..it says it...so thats like appoiments, coming up. appoinments that someone have to come in alll the time ...come in every 2 weeks....to be reminded.....problem list...things the you really need.....i would thing smoking would be in the problem list also....I alo think is someine has anxiety or emtional issues that causes...it not so much a diagnoses but a problems list , i think obese should go inthe problem list...if somende drinks 10 drinks a day...that a problem.....
...
5.	Great, please slowly scroll down again. [**Moderator Note:** Stop them at “My medications”] How would you define the "My medications" section?...i  hoping for my medication, is this all my medications that I am on...what i am on long term...it has an rx number....well i go to my healthe vet to look at my precriptions.
...
## Task 6: Navigating to Another AVS – 10 minutes
Okay let’s view information from another appointment you had in the past. How would you go about doing that? (participants navigates to another AVS by trial and efforr )its only giving me 1 date.....I would..its taking me to long to find it ......(moderator helped to get to another AVS-Particiapnt was unable to find another avs while being on the prior avs)....i would say it problalby maybe 2 years the current year and the year prior....maybe have it in increments of 2 or 3 years....maybe do it by each year....
...
-On a scale from 1 to 5 (with 1 being very easy and 5 being very difficult), how easy or difficult was it to navigate to another summary from another day?   4 but its not diffifcult ( but participant was unable to navigate to another AVS-moderator helped)
...
- Do you find this notification helpful or not helpful? Why? i like notifications
- How would you prefer to receive this notification (email, text message, phone call, etc.)?I get them on my email, i can go on my computer or muy phone.
- If you had multiple appointments in one day, would you want one after-visit summary notification for each appointment that day or would you want all the appointments combined into one message? i'd want them all in the same message if they are all on the same day.
...
But wieght and weight in metric and US...put something in there about the goals the patient has...it would deepend on the mdical provider what youre goals,,,,i think I you gave goals your ellciate potentila.....i can see it veryuseful because everyone doesnt cary desktop and laptop around....
## Thank you - 2 minutes
