...
1.	Do you, or the Veteran you care for, recall receiving paperwork as you left your appointment, or reviewing online information that provided an overview of what occurred during your medical appointment or procedure? [**Moderator Note:** Use You, or the Veteran you care for, depending on who the participant is.]  
    ...
    -	**Participant:** I did receive the paper, and I went into MyHealtheVet.
   
    -	**Moderator:**  What information did you review? Do you recall if any particular appointment type or procedure made you take a closer look at this paperwork or              online information?
  
    -	**Participant:** As far as the VA, it was routine. I would go to MyHealtheVet and download blue button just too see...as soon as my appointment was over...
    -	The reason I checked was to make sure I didnt miss any...I used MyHealtheVetto track my vitals... also looking the medical terminology...
      
    -    **Moderator:** What would you call or name something like that?
  	
    -    **Participant:** it was through MyChart...it was called an After-visit summary...
...
-	 **Notetaker:** Participants navigated to AVS by "Appointments".
-    **Participant:** I am going to look under appoinments where it says schedule and manage appointments. And I'll click on the past... link.
...
12.	**Moderator:** How would useful or not useful do you find the information in “Medications ordered for administration in clinic”?
...
1.  **Moderator:**	How would you utilize the information within this section?
2.	**Moderator:** Are there any words that seem unfamiliar or confusing to you?
...
**Participant:** ...What does that mean...?  this section i would expect to see here anything after new was precribed to me..... the first one was specific to date... this is saying that after appointment this is what youll be using down.


3. **Moderator:** Are there any instructions that you should be aware of in this section? ...
    - [**Moderator Note:** Ask question 3 only if participant answered "No" in Question 2 of Task 1, otherwise move to Question 4.] 
     
4.**Moderator:** Okay great, so how would you describe the information under “Medications and supplies”?
    -	**Moderator:** How does the “Medications and supplies” information in this section differ from “Medications ordered for administration in clinic” under the previous “Your appointment on June 6th, 2023” section?**
    -	[**Moderator Note:** If what they describe doesn’t match the intention of the section, then share:] 
    
**Moderator:** Okay, this section was supposed to display only the medications that were added or changed during the appointment?
    -	How valuable, or not valuable, do you find this section to be? Why?
    **Participant:** ...

## Task 4: Your Health Information as of this Appointment– 10 minutes
**Moderator:** Now, I would like you to scroll to “Your health information as of this appointment–”.  And again, please review this section by talking aloud while you are scrolling through.
1.**Moderator:**	Can you provide an example of how you might utilize the information within this section?
 **Participant:**...I like this section alot.....mostly because i dont have to go down and dowload the blue button. I can see my labs right here...I would use this section to crosss reference with the outside provider....I also like because of the medicines I'm currently taking.
 
 **Moderator:** Are there any terms that seem unfamiliar or confusing to you?
    -   [**Moderator Note:** If participant encounters confusing or unfamiliar wording ask the following:]  **Moderator:** Using your own words, how would you define these terms? 
    
**Participant:**... No, its very user friendly.... If I didnt know ...I would click on terms...

3. **Moderator:** Okay, please continue to scroll further. [**Moderator Note:** Stop them at “Recall Appointments”] What is your understanding of “Recall Appointments?"
  
5. **Participant:**...recall appointments...I would like to know if any appointments that were cancelled, if they would be listed in this area. and also...I would probably change it from recall to follow up...

   **Moderator:** -	[**Moderator Note:** If what they describe doesn’t match the intention of the section, then direct them to the helper text underneath the title.]
    -	How helpful or not helpful is this information to you? Why?
6.	Okay please scroll down a little further. Under “Problem List”, what does this information tell you? 
...
**Moderator:** Okay, go ahead and click on it and look at the whole section, and then, please share aloud what you see

**Participant:**...for me this is just staing what other cllinics...as far as the other infromation is a way to follow what is going on or future appoitnments...

**Moderator:**
3.	Is there anything you see that is unclear or confusing?
4.	Is there anything you’d add or take away from that information? 

**Participant:**...no, I guess, I would put information on the Crisis Line...
...
- [**Moderator Note:** Only ask the following questions if they are in the appointments section, skip if they are in the “care summaries” section.] Please navigate back to the page with all of your appointments listed. I want to highlight some links of this page.
  ...
  **Participant:** ...I would go back to .... and look to see under past appointments...I would seeing all my after summaryis reports giving me ability to see past.
   ...
   **Moderator:** -	What do you expect to see if you click on the “Upcoming” link? Please don’t actually click on it, just describe what you would do.
**Participant:** I would see it would take me to the...
  
 **Moderator:** What do you expect to see if you click on the “Pending” link? And gain, please don’t actually click on it, just describe what you would do.
...
- **Moderator:** Do you find this notification helpful or not helpful? Why?
- **Participant:** ...helful. It reminds you that you can review your appointment incase you didnt receive handout...
  
- **Moderator:** How would you prefer to receive this notification (email, text message, phone call, etc.)?
- **Participant:** Email or text...
  
- **Moderator:** If you had multiple appointments in one day, would you want one after-visit summary notification for each appointment that day or would you want all the appointments combined into one message?
- **Participant:** I would 1 notification for all of them...

## Closing Questions – 3 minutes
-	**Moderator:** If you could change one thing about the After-visit summary, what would that be?
-	 **Participant:**...I don't see any....the colors are consistent and easy to reas, I wouldnt change anything...I would expect to see unnder the recall section, if it was something important, I want to see it highlighted in red...
  
-	**Moderator:** And lastly, do you have any questions for me?
  
-	 **Moderator:** Okay, great! That is all the questions I have for you today.

**Participant:**...it's actually better than I expected to see...
