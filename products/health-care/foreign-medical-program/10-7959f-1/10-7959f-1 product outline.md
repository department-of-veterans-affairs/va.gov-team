...
## Overview
Under the [IDEA Act](https://digital.gov/resources/delivering-digital-first-public-experience/), all user facing forms need to be digitized. For Veterans who are residing or traveling outside the US and are eligible for health coverage for a service-related condition, providing the Foreign Medical Program registration form online would allow them to more easily and quickly apply rather than go through the current paper process.
