...
- Data comes from `vets_api.statsd.api_rack_request`, filtered down to `source_app:10-10d-extended`, `controller:ivc_champva/v1/uploads`, and `action:submit_champva_app_merged`
...
- Data again comes from `vets_api.statsd.api_rack_request`, filtered down to `source_app:10-10d-extended`, `controller:ivc_champva/v1/uploads`, and `action:submit_supporting_documents`
