...
- 3/7/24 - **Testing**: 10-10d will be done in staging. 10-7959f-1 testing - user interviews + content to be done with Figma prototype (Looked at UXPin - accessibility concerns, CodePen involves too much coding, Figma is limited - would require VA to update, since Figma is new not a lot of precedent for testing). Going forward would want to do testing in staging (as other teams are doing).
