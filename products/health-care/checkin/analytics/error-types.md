...
| ----- | ----- | ----- | ----- |
| www.va.gov/health-care/appointment-pre-check-in/error?error=no-token | Veteran attempted to access pre-check-in without a UUID. This occurs when a Veteran reopens their mobile web browser and an expired pre-check-in session attempts to load. | Active |  |
