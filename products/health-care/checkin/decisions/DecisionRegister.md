...
| --------- | ----- | ---- | ----- | ---- |
| Priorities for the team are (1) editing capability for demographics, EC, and NOK (2) Spanish language translation for CI & PCI (3) PCI support for virtual appointments | Lori Pusey | 3/9/2022 | ----- | ---- |
