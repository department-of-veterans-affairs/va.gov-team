...
- **Production Support**
    ...
    - **Move to New AWS Instance**
      ...
      - ✔️ 🟨 [Renew `vista-api-dev` ALB Certificate](https://github.com/department-of-veterans-affairs/checkin-devops/issues/673)
      - ✔️ 🟨 [Create Terraform module in `cie-terraform-modules` for creating/managing a Node.js Lambda layer with the combined TLS certificate](https://github.com/department-of-veterans-affairs/checkin-devops/issues/260)
      - ✔️ 🟨 [Create API Gateway Module for VPC-Scoped REST APIs](https://github.com/department-of-veterans-affairs/checkin-devops/issues/689)
      - ✔️ 🟨 [[DevOps] Discovery into renewing Vista API TLS certificates](https://github.com/department-of-veterans-affairs/checkin-devops/issues/652)
      - ✔️ 🟨 [Create API Gateway REST API IaC for Staging Scheduler](https://github.com/department-of-veterans-affairs/checkin-devops/issues/688)
      - ✔️ 🟨 [Create Terraform Module for API Gateway Method and Lambda Integration](https://github.com/department-of-veterans-affairs/checkin-devops/issues/690)
      - ✔️ 🟨 [[DevOps] Discovery on getting `cie-staging-scheduler` into IaC.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/299)
      - ✔️ 🟨 [Create REST API Lambda function integrations for Staging Scheduler](https://github.com/department-of-veterans-affairs/checkin-devops/issues/691)
      - ✔️ 🟨 [[DevOps] Address Dependabot security alerts in `cie-staging-scheduler`.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/273)
      - ✔️ 🟨 [Migrate cie-staging-scheduler frontend to use NPM instead of Yarn.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/693)
      - ✔️ 🟨 [Remove all hardcoded strings from `cie-terraform-modules` tests.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/692)
      - ✔️ 🟨 [Remove `dev` and `stg` `codebuild_ghar` configurations from `checkin-devops`.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/694)
      - ✔️ 🟨 [Create `proxy_lambda` Lambda function and Terraform module.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/696)
- **OH Travel**
