...
- **Production Support**
    ...
    - **Move to New AWS Instance**
        ...
        - ✔️ 🟨 [[DevOps] Create address demographics CHIP schema.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/426)
        - ✔️ 🟨 [[DevOps] Create nextOfKin CHIP demographics schema](https://github.com/department-of-veterans-affairs/checkin-devops/issues/427)
        - ✔️ 🟨 [[DevOps] Create read.basic appointments CHIP schema.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/424)
        - ✔️ 🟨 [[DevOps] Create read.full appointments CHIP schema.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/425)
        - ✔️ 🟨 [[DevOps] Create the CHIP demographics schema](https://github.com/department-of-veterans-affairs/checkin-devops/issues/428)
        ...
        - ✔️ 🟨 [[DevOps] Implement LoROTA DynamoDB will-remove-an-expired-record test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/431)
        - ✔️ 🟨 [[DevOps] Implement LoROTA Token Expiry will-not-honor-an-expired-token system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/344)
        - ✔️ 🟨 [[DevOps] Implement LoROTA Unknown Issuer will-not-honor-an-unknown-issuer system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/345)
        ...
        - ✔️ 🟨 [[DevOps] Implement LoROTA `getData` will-not-retrieve-data-with-an-invalid-uuid system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/334)
        - ✔️ 🟨 [[DevOps] Implement LoROTA `getData` will-retrieve-basic-data system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/332)
        - ✔️ 🟨 [[DevOps] Implement LoROTA `getData` will-retrieve-full-data system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/333)
        ...
        - ✔️ 🟨 [[DevOps] Implement LoROTA `patchData` will-not-update-data-with-invalid-scope system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/336)
        - ✔️ 🟨 [[DevOps] Implement LoROTA `patchData` will-not-update-non-existent-data system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/337)
        - ✔️ 🟨 [[DevOps] Implement LoROTA `patchData` will-update-data-with-valid-scope system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/335)
        - ✔️ 🟨 [[DevOps] Implement LoROTA `postData` will-fail-to-create-an-entry-with-an-invalid-scope system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/331)
        - ✔️ 🟨 [[DevOps] Implement LoROTA `postData` will-fail-to-create-an-invalid-data-entry system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/330)
        ...
        - ✔️ 🟨 [[DevOps] Implement LoROTA `putData` will-not-update-data-with-invalid-scope system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/339)
        - ✔️ 🟨 [[DevOps] Implement LoROTA `putData` will-not-update-non-existent-data system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/338)
        - ✔️ 🟨 [[DevOps] Implement LoROTA `putData` will-update-data-with-valid-scope system test.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/340)
