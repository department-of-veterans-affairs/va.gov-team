...
- **Production Support**
    ...
    - **Move to New AWS Instance**
        ...
        - ✔️ 🟨 [[DevOps] Do we need to enable FISMA compliance for our Fargate clusters?](https://github.com/department-of-veterans-affairs/checkin-devops/issues/323)
        ...
        - ✔️ 🟨 [[DevOps] Create Datadog Lambda Layer Terraform module in `cie-terraform-modules`.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/593)
        - ✔️ 🟨 [[DevOps] Move `codebuild_ghar` Terraform module out of `checkin-devops` and into a separate repository.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/544)
        - ✔️ 🟨 [[DevOps] Create Node Lambda function Terraform module.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/594)
        - ✔️ 🟨 [[DevOps] Create OpenAPI spec s3 bucket Terraform module.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/596)
        - ✔️ 🟨 [[DevOps] Discovery on expanding usage of Datadog APM trace spans in LoROTA.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/497)
        - ✔️ 🟨 [[DevOps] Do we need to enable logInjection for trace IDs in LoROTA?](https://github.com/department-of-veterans-affairs/checkin-devops/issues/481)
        - ✔️ 🟨 [[DevOps] Add Datadog IAM role and policy assumable by VeTEXT Datadog to `vaec-cms`.](https://github.com/department-of-veterans-affairs/checkin-devops/issues/371)
