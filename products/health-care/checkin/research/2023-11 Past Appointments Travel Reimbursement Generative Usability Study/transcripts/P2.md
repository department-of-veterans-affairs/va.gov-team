...
> This is a lot easier than the way it is right now. For one, when you have different appointments, it pulled them all at the same time, instead of going one by one. 
