...
# Research Plan: Check-In (Veteran-Facing) Remote Discovery Research
## Goals
...
## Method
We will conduct remote moderated test via Zoom using the Perigean contract. The Veterans will be asked a series of interview questions about their check-in experiences. Certain visuals will be presented in order to facilitate discussions on particular kiosk-based check-in workflows and methods.
