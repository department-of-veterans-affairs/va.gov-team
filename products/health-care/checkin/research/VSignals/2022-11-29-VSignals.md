...
#### Negative Comments
- ***21 said the new process is difficult/they don't like PCI for themself, low vision, older, or low tech savvy Veterans.***
...
- 17 tried eCheck-in and weren't successful.
  - 5 thought they were checked in via eCheck-in and they weren't.
  - 3 tried to use it for a clinic that wasn't enabled, but they had no idea the clinic wasn't enabled.
  - 2 never got the QR code to work.
  - 1 stated that the number to text didn't work.
  - 1 receives other VeText messages, so they are confused why eCheck-in doesn't work for them. 
...
- 21 said that they ended up not actually checked in after checking in with staff.
- 13 believe that the check-in areas are not appropriately staffed for answering questions and the volume of Veterans checking in.
...
- 3 liked that the kiosks were removed/not being used.
- 2 feel that the kiosk machines still being in the waiting rooms is causing confusion. People are trying to check-in on them.
...
- 19 experienced wayfinding confusion when entering the facility. Some didn't know where to go to check-in. 
  - 1 misses the kiosk feature where wayfinding directions were provided.
...
- 4 said that the wait time to schedule/get an appointment was too long. 
  - Some didn't specify what "too long" was. 
