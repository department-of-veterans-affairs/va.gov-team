...
#### Negative Comments
-  *** 4 said new process is difficult for themself, low vision, older, or low tech savvy Veterans.***
-  *** 4 do not have a smart phone or don't want to use a smart phone to check-in***
-   5 tried eCheck-in and wasn't successful.
...
-   2 had questions about eCheck-in's security.
-   4 said they had no cell service or facility had no wifi/cell service. 
-   2 thought eCheck-in makes the check-in process longer.     

## Comments that Mentioned General Check-in

#### Positive Comments
-  9 said checking-in was easy 
    
#### Negative Comments
- ***31 had long wait times between arrival and check-out.***
  - 4 mentioned that the wait to check-in with a staff member was long.
  - 2 said the wait was so long that they left without completing their procedure/labs.
- ***11 sited short wait times between arrival and check-out.***
- 10 said that they ended up not actually checked in after originally checking in with staff.
  - 2 commented that this happened at a lab.
- 1 commented that a computer problem for staff delayed all check-ins.
- 5 were confused about how to check-in. 
...
-  2 didn't realized that check-in wasn't available on the kiosk.
...
#### Positive Comments
-  15 liked/loved/enjoyed the self check-in kiosk
-  1 commented that staff helped them with the kiosk.

#### Negative Comments
-  ***18 said they want the kiosk reinstated for check-in***
-  ***43 said they want the kiosk reinstated for travel pay***
-  4 said removing the kiosk made travel pay a lot harder. 
-  1 feels that the kiosk machine still be in the waiting rooms is causing confusion.
...
#### Negative Comments
-  25 experienced difficulty/weren't successful filing a claim through BTSSS. It isn't user friendly.  
...
- 24 described an overall wonderful experience from the time they checked to until the appointment was complete.
  - "Great job all around!"
- 6 experienced wayfinding confusion when entering. Some didn't know where to go to check-in. Sometimes staff aided in the confusion.
...
- 1 had difficulty finding parking.
