...
The purpose of this research is to *get feedback from Veterans on the new unified PCI experience* about ease of use and how well it met expectations. 

### Research Questions

#### Primary Questions 

1. How easy or difficult is it to confirm an appointment? 
...
11. How easy or difficult does it seem to start the check in process from viewing the check in poster?  
...
1. How easy or difficult is it to confirm an appointment? 
     - DEFINITELY TRUE: Veterans will think the process for confirming an appointment is easy. 
2. How easy or difficult is it to check in to an appointment? 
     - DEFINITELY TRUE: Veterans will think the process for checking in to an appointment is easy. 
3. Do Veterans think the check in confirmation page provides enough information about the status of their check in and what to do next?
...
4. How easy or difficult is it to understand if other upcoming appointments require attention? For example, another appointment needs to be confirmed or checked into. 
...
5. How easy or difficult is it to understand the difference between confirming an appointment and checking in to an appointment?
...
6. How easy or difficult is it to understand that you still need to complete the online check in process even if you’ve confirmed the appointment a few days prior? 
...
11. How easy or difficult does it seem to start the check in process from viewing the check in poster?
     - DEFINITELY TRUE: Veterans will find that the check in poster instructions are easy to understand.  
