...
### Before
<img width="613" alt="r-s-page" src="https://user-images.githubusercontent.com/5553542/150180983-c27fd3fd-97c1-469d-ae94-fc2f36435f7b.png">

### After
 ![proposed-updates](https://user-images.githubusercontent.com/5553542/150179197-dac738d5-ac6b-496e-acc1-d079e0e1bef5.png)

Updated sections styles:

**Related information:** 
Using the style, "Related Links, for navigating to related information outside a content section". 
While most links are within Resources and Support, there are times where from outside R&S are used. There could be an argument to use the "Major Links" section if links were restricted to only R&S links.
