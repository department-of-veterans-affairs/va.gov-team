...
> SMS Content: *"VA Benefits: You compensation/pension monthly payment of $[amount] is being processed. Reply STOP to unsubscribe, HELP for link to access VA payment history."*
- [Live 10/28/2024] Opt-in confirmation SMS was added to improve Veteran's experience. The text message is now being sent to the Veteran upon opting-in in the VA.gov portal, confirming their enrollment in Comp and Pen messaging and informing them about their first notification. Depending on the opt-in date - before or after the 10th of the month, enrollment text will specify current or next month respectively.
> SMS Content: *“VA Benefits: You are enrolled! Your notification is scheduled for [month-name]. Reply STOP to unsubscribe, HELP for link to access VA payment history.”*
