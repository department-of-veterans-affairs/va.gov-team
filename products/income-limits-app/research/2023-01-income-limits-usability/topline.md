...
4. All participants understood the income ranges and knew which one to select to open, based on the moderator's prompt.
2. All participants found it easy and intuitive to answer one question at a time (the subtask design pattern).
