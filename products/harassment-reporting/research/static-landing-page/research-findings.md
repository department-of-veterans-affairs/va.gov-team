...
The purpose of this research was to get user feedback on 

# Research Questions
1. How 

# Methodology 
We conducted hour-long remote moderated research sessions via Zoom on **March 14-18, 2022**. Research participants were asked about their experiences with... 

We talked to **14 Veterans** and asked them each to interact with the landing page on their device. 

# Hypotheses and Conclusions
1. Veterans 
    1. MOSTLY TRUE: 
1. Fil
    1. MAYBE TRUE: ent, and/or keyword (search).
3. Se
    1. PARTLY TRUE: 
