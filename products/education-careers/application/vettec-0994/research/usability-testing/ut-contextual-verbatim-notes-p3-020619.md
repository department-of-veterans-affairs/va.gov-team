...
>**I’d say I’d start reading what the page actually says. There’s a little bit of a lag every time I scroll. First, I would have to read the instructions. So, to apply, I would have to get these things. So the application seems simple enough, which is great. So after reading, what I have to do to get started, I would go up and click the button to start the application.**
...
>**So this is the personal information that’s on file for me. So after seeing that it’s all correct, I would click continue.**
...
>**Because I already have, I would click the yes button.** 
...
>**I’m not currently on active duty, so click the No button.**
...
>**So that’s assuming I’d already done my research on the programs. Hopefully I did some preparation before actually completing this form, so if I did, and I actually had some idea of what I wanted to do and where I wanted to go, I’d say Yes.**
...
>**Ok, so that’s good. Everything is preloaded, so that’s easy enough.**
...
>**So I like that information because obviously you want to get your money, and I don’t want to have to worry about where it’s going to go.**
...
>**I like having the opportunity to edit everything on the page itself. I would expect it to take me back to the former page. I think it would be easier to have it loaded on this page, and just change it here.** 
...
>**Intro page: what are your thoughts on the intro page? It’s very simple. I like the fact that it basically tells you everything you’re going to need, so if I don’t have that information on hand, I can prepare, and once I have it, I can actually start to fill out the information.** 

>**Something I think would be helpful is if there would be some sort of link like an option to be able to redirect if I don’t have the va form 22-1990 filled out. If there would be an option to be able to click on something that would take me to the form, and then I can fill it out and submit. That would be very helpful because I wouldn’t have to go google after google to figure out where the form is. So if I would be able to click on something and fill out. So that one would have to be filled out after this one is submitted?** 

>**[banking information: would you expect your info to come in automatically?] if they just applied for their va benefits, that information should already be loaded on the website, correct? So if the 1990 is already submitted before this one, then that info should already be pre-loaded, but if not, they should input their information.** 

>**How do you think you’d find out about the programs you could attend if you didn’t know about them?
You could put options about what people could do on the app and what they could do as far as high tech programs go. [he would do his own research]**

>**How do you think program selection process works? It really depends on the person, and at what point they applied for this program. I assume that if someone has been doing this for a period of time, they’d have an idea of what to do. If not, they might not know what they want to do, and they might take a different route and do something else.** 

>**How would you find out about vet tec? Hopefully it would be listed on the va educational website. I was thinking if there’s a va app, it could be listed there. You could also utilize TAPS. They can inform veterans who are getting out of the service on having this available to them. What they could do to is possibly pass out some sort of document at that point that takes many screenshots of the actual app itself and that tells people how to go through the process, in case they have questions, they can find out at that point.** 
