...
>**I would read everything, try to figure out exactly what I needed. I see that it’s a specific form. Sometimes the forms will be older or newer, but I’m assuming it’s newer, this one. Then I would read the steps, make sure…so with that I would get all the infoemation I need, my dd info, my education info, and then I would complete the form, and then I’d hit the button at the top that says… so I would just hit that.**
...
>**So I would just continue, looks like I’m (Test User). **
...
>**For me, I would hit YES, most likely.** 
...
>**I would hit NO for that one. Do you anticipate…? I would hit NO.**
...
>**It seems like standard, VA application so far. The questions aren’t complex. I like the simple design, the question and answer, then hit continue. The finish this application link is right there, too.**
...
>**It’s really just straightforward. **
...
>**I would hit the edit button right here [to update info]. 
Ok, that’s cool. I don’t know exactly about the va records. Sometimes I’ll update something and it won’t update everything, but it’s saying it’ll update all of them? 
[the call for help number] It’s nice that it’s right there, and you can call for help.** 
...
>**It does explain what you need and why you need it, and it gives you context information right there so you don’t have to go searching for it if you run into a problem.**
...
>**It’s good that the edit button is right here. I like that it has the Add Another Program button right here, too.** 
...
>**What are your thoughts on the overall process? I found it really easy. It told you what you needed beforehand so you could be prepared. It seemed really straightforward. Even if it’s your first va form, it seems easy to follow, a lot of forms take forever to fill out. [this one doesn’t]**

>**[?]That would be really convenient, especially since there are so many benefits out there.** 
