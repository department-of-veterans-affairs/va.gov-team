...
## Getting Access
In order to get access to the search.gov console, you have to have a log in and be approved. This process is best accomplished by emailing search@support.digitalgov.gov.  When you do so, be sure to CC your PO as part of the process, as they track VA approval for all credentialed accounts they distribute.
