...
- *Resources and support* is intended to provide more in-depth information/instructions around certain benefits and processes (both to provide the info and to lighten the content in the benefit hubs)
- *Resources and support* specifically addresses common issues such as signing in and verifying your identity

**SME:** Liz Lantz
- The "Learning center" is the same as the "Resources and support" hub, and they share the same [research repo](https://github.com/department-of-veterans-affairs/va.gov-team/tree/69833737d9fe22b8990bb987e7c50de13205c5d5/products/content/tier-2-content-IA-and-design/learning-center-mvp/discovery-and-research)
...
- Orginally two planned search methods: browse by topic, and browse by intended audience - only browsing by topic is currently available
...
2) **A few "Other" benefits services are present under Resources and support**
  - A few services seem to be described in *Resources and support* articles that aren't captured by the *Facility Locator* list of services (see detailed findings), and they are:
    - Language and translation help
    - Help with changing your legal name
    - Help filing a discrimination claim

### Next Steps / Suggestions

- Consider revisiting the categorization of articles and topics, as some seem misplaced (ie. the "Health Care" topic only contains articles about travel reimbursement)
- Benefits services (ie. assistance with services, as opposed to information about those services) seems to be mostly out of scope for *Resources and support*. Consider creating a new topic category that includes benefits services.
...
#### Education_Claim_Assistance
- (May not be directly related) [Call for help with a late GI Bill payment](https://www.va.gov/resources/gi-bill-and-other-va-education-benefit-payments-faqs/): Veterans can call the listed number to speak to someone about a education payment they should have received
#### Updating_Direct_Deposit_Informa
