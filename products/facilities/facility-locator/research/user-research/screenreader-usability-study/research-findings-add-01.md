...
-   3\. Third, navigates homepage by headings from the top of the page, and thinks that he is on a new page.  [[Figure P1.3](https://docs.google.com/document/d/1xOjW57RyZIBZwywfBdPK8Nc2P-j4oiVoojT6-MGbrIk/edit#heading=h.c7a5zkqibzkc)] 

-   4\. Moderator prompts user to try links list but still runs into issues [[Figure P1.4](https://docs.google.com/document/d/1xOjW57RyZIBZwywfBdPK8Nc2P-j4oiVoojT6-MGbrIk/edit#heading=h.g0ldckjueq6v)] 

-   5\. Moderator prompts user to try using the global nav menu  [[Figure P1.5](https://docs.google.com/document/d/1xOjW57RyZIBZwywfBdPK8Nc2P-j4oiVoojT6-MGbrIk/edit#heading=h.g0ldckjueq6v)]  This user experienced the mobile version of the menu and when he used JAWS 'Find' to type 'F' for 'Find a VA Location' he did not notice it until he repeated this method later while the global nav menu was in its expanded state.
...
[Later] "Closed button collapsed. What does that mean?"
