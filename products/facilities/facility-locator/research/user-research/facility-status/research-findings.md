...
2.  Zero participants classified a facility as ‘Facility Closed’ if any level of services were still available to them.
...
**5. Users understood that the terms 'virtual services' and 'telehealth' are sometimes used interchangeably and that they mean that some level of service might still be available to them.** In one participant’s own words, 
