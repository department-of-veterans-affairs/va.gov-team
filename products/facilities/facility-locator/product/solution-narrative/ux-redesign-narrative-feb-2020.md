...
MVP included urgent care as a **VA facility type** with two **service types**:
- VA urgent care
- Community urgent care providers (in VA's network): Searches for this service type returns results for URGENT CARE (if POS code = 20) and RETAIL/WALK-IN CARE (if POS code = 17). These urgent care facility types are designated on the search result card. 
...
Timeline continues:
- [Final MVP: March 2019](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/facilities/facility-locator/product/solution-narrative/ux-redesign-narrative-mar-2020.md)
