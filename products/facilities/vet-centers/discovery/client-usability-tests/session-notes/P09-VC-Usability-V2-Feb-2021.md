...
I served in Army special operations. 1 deployment to Iraq and 2 to Afghanistan.
...
I&#39;ve used both of those at a regular VA and at a Vet Center.
...
I probably wouldn&#39;t start with the internet; I would start with a peer – probably by texting someone. If I did try on the internet, then I would Google &quot;Veteran Mental Health Counseling&quot; and look for the first VA.gov site to come up.
...
The first thing I look at is locations. I see they also have a phone number and an email address. An email would be nice but I&#39;m sure there are HIPPA concerns. The hours of operation render this facility completely useless because that is during work hours.

\*scrolled through dropdowns and quickly/easily found &quot;mental health care&quot;\* I like the options for care here – the science-based options are what I&#39;m looking for, not the yoga options.

\*after seeing women care, minority care, and homeless care\* that makes me feel a little left out. I think that every group should receive their care. I&#39;d like to see specific care for veterans of combat. Maybe prioritize by level of sacrifice for your country.
...
Hated the Raleigh, NC Vet Center

Referred to the D.C. VA as a &quot;dumpster fire.&quot; \*Is there a difference?\*

I would break up the second sentence of the description under Orland Vet Center to be a bulleted list rather than a long sentence.
...
\*mental health care dropdown\* It gets the point across. My preference would be an email instead of phone number. I&#39;m sure there is a HIPPA restriction, but it would be so much easier to just send an email. About half of my day is consumed with phone calls and I don&#39;t want to have to set aside 15 minutes for a call when I can just shoot an email and have someone get back to me. If they have to reach back out by phone, then I&#39;d prefer they email me to schedule a time.
...
I wouldn&#39;t know what &quot;VA Connections&quot; means. \*after opening the dropdown\* that&#39;s good to know but I would go to a VSO for that. Maybe it could be called &quot;VA access&quot; or &quot;how to access VA benefits/healthcare.&quot;
...
\*clicked &quot;other locations&quot; link\* It would be nice to see a map that has pinpoints for each of the locations to give a visual representation.
...
I would assume they have the same or similar services but smaller staff. I would assume that the mobile center is an intake center for giving certain locations the opportunity to talk to a vet center.
...
\*used back button on phone/web browser\*
...
Since there isn&#39;t an email address, I have no other choice but to call or go into the Vet Center itself, so my next step would be to call.
...
Outside of prior experience, no.
...
I would say it is an off-site VA facility that provides mental health care and counseling.
