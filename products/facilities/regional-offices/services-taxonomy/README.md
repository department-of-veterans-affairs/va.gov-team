...
|	Family member claim help |	---	 ([Hub link](https://www.va.gov/family-member-benefits/))| ---	| ---	| ---	| ---	| ---	|
...
|	Integrated Disability Evaluation System Assistance (IDES) |	---	| ---	| ---	| ---	| ---	| ---	|
|	Pensions |	---	| ---	| ---	| ---	| ---	| This isn't actually part of VBA_facilities DB but is listed on Lighthouse (no data source tho)	|
