...
1. I understand you are a (*Veteran / Caregiver / Family member).* Is that right? Yes, Veteran. My wife and I are both caregivers for each other from the VA. 
	- *(If Caregiver, confirm:)* Are you a caregiver for a Veteran? Are you a Veteran?
	- Thanks for confirming that.

2. What kind of device are you using today? *(Computer / Tablet / Smartphone)* Desktop
...
4. What VA benefits, if any, do you have experience with? Healthcare, dental, Chapter 31. I Was not able to use a home loan. 
*(health care / education / career services / disability / housing loans / pension / life insurance / burial benefits / __________)*

5. How do you typically get information and benefits from the VA? Sometimes from emails, I live in Nabraska I get their emails, my healthy Vet, and Military one source. 
*(Google / Facebook / MHV / eBenefits / Contact center call or email / VA.gov / _________________)*

6. Are you familiar with VA regional benefit offices? Would that be their hotline..? ( Participant didn’t’ know.). 
...
### Task 1: [Wayfinding] 
If you wanted to visit a VA benefit office near you, what would you do? Google VA benefits office near me. And go to VSO and VA eligibility But I would mostly go to .gov ( participant would go to .gov for security)
- * wayfinding via google? VA.gov > facility locator?

Can you show me how you would find out whether a VA benefit office could help you apply for disability benefits? I would go through the VSO. 
...
What are your impressions of what you're looking at? *(RECORD)*It’s got hyperlinks- good. Looks the same as Nebraska’s. Everything looks in order. 
...
*(Veteran only)*
Imagine that you have some hearing loss that's related to your military service. You’re not currently receiving monthly disability payments from the VA, and you’d like some assistance applying for benefits. Using the information on this page, how could you get help from the Boston Regional Office? Looking for contact information, 2, apply for claim or something. Normally you have to be enrolled in order to ask.  Looking for healthcare- contact us, VSO or make an appointment. You have to have ID me to register. 
...
- *[if need prompting...]* 
  ...
  - How could you talk to someone? *[in-person]* No appointment necessary. Contact information is there. 8 am ( participant would show up). 
...
*(Veteran only)*
You’re interested in buying a house, and your lender asks for proof that you qualify for a VA home loan. From this page, where would you go for that? Looking for VA service number or benefits letters and decisions. 
I would print my letter and then go to home loan, just so I had proof before going. 
...
- *[if need prompting...]* 
  ...
  - Do you need an appointment? *[no but it’s preferred, per top-level accordion]* no appointment needed.
  - When will you go? *[check office hours for this task specifically]* I would go 9-10
    - *Record any comments about*
      - *multiple sets of office hours*
      - *multiple hour blocks per day*
      - *notes about Thursday closures*
...
- Is there anything else you need to know before taking the next step? I would research VA home loan on the realtor side or VA side and know what they require for paperwork. 
  - *(No / Yes: what?________________________)*
...
*(Veteran only)*
Now some time has passed since your visit to the regional office, and you’re still waiting to get proof that you qualify for a VA home loan. How would you find out what’s happening? Check claim status, that’s user friendly and have case number and talk to a live person, 461 number. 
...
Let's say that you’re exploring how to pay for college or other training, and you want to see if the VA can help. Using the information on this page, how can the Boston Regional Office help you? VA benefits- education benefits. Then go to benefit letters or records to be prepared.
...
Imagine that you’re thinking about how to pay for your kid to go to college. You want to learn about scholarships that might be available to kids of Veterans. Using the information on this page, how can the Boston Regional Office help you? Family member, caregiver, education benefits for family members. 

- *(Educ benefits for Veterans / **Educ benefits for family members** / __________)*

### Task 9: [Burial/memorial--accordion opens]

 If you wanted to honor a Veteran with a medallion on their headstone, could the Boston Regional Office help? I’m looking for burial services. Because I had to do that my brother-in-law's grandfather. I’m looking for a civilian cemetery. 

- *(Family member and caregiver benefits > Burial and memorials)*

- *[if need prompting...]* 
  - To make this happen, what would you do next? 
  - How could you talk to someone? *[in-person only]*There is a phone number
  - Do you need an appointment? *[yes]* No appointment needed. Room 62
...
*(Veteran only)*
Suppose that you just switched banks, and you want to tell the VA so that any payments you receive will go to your new bank instead of your old one. Could the Boston Regional Office help you do this? I loke at other services, direct deposit information. 
...
If you wanted help applying for life insurance through the VA, where would you go for that?  Veteran benefits, (scrolling up) I’m not seeing it. I would call the one thousand number (participant would scroll and if not found, would call). 
...
2. In your own words, what do you think you can do at from this VA office? Everything seemed available. 
3. What worked *well* for you? User-friendly, it had hyperlinks that opened the next window, and had power words, benefits, family, and finance, so the keywords were pinpointed. Phone numbers were blue. 
4. What was *unclear or didn't work well* for you? I don’t see transportation milage for claiming doctor appointments
5. What would you like to *change or add*? I don’t see the suicide hotline number, it’s at the top. Probably add the chaplain's number. 
