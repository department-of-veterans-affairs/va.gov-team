...
### Outcome
It will give us a fuller understanding of what Benefit Office clients need, and allow us to make design recommendations for the Regional Benefit Office MVP. 
...
1.  What benefit-related **tasks** do clients complete at Benefit Offices? 
    * We expect high variance by facility type and benefit service
      * FALSE: majority of Veterans were looking to engage with disability benefits.  
...
2.  What is the client experience of **visiting** a Benefit Office? - 
    * We expect high variance by facility type and geography
      * FALSE: most people had good experiences with the actual visit and little trouble finding the location, parking etc. 
...
1. Veterans want to speak with a human
2. Wants to complete tasks online
3. Problems encountered were never really connected to VBA website content issues.


# Details of Findings 

**Finding #1: Veterans want to speak with a human**

- "It's faster to just go in and hand them a paper form"
- Doesn't like being treated like a number. 
- Doesn't trust automated systems or is worried about the status of their application and not sure how to find that info. 
- Questions are dynamic and complex and not easily slotted into reviewing an FAQ page online. 


**Finding #2: Wants to complete tasks online**

- Lots of people rate online as their 1st preference for completeing task despite their actions of going in person. 
- Convenience was stressed. 
- Wants up to date access to all their paperwork and forms, and the status of everything. 
