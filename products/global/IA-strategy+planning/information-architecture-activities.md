...
The VA.gov team has not had the resources to focus on how things are organized **across the whole veteran experience.** Information architecture (IA), content, and design need to work together on **everything.** Any time a veteran interacts with the VA, it should be seamless.
...
* **Step 1:** Evaluate the health of VA.gov’s information architecture. **We'll focus on wayfinding and how users navigate the site, whether they are signed in or not.** We're planning and working on:  
  * baseline testing of top tasks;
  * [analytics for top tasks and mobile](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/global/IA-strategy%2Bplanning/analytics/top-task-analytics.md); and
...
* **Meetings:** We'll start the conversation about IA strategy in the new DEPO product sync breakout meeting on Wednesday, June 17. There we'll discuss next steps for sharing, getting feedback, and setting direction.
<br></br>
