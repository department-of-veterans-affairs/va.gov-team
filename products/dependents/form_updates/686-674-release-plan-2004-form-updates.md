...
|---|---|---|---|
|Phase 1: Staging testing |2 days|TBD| June 2024 |
|Phase 2: Canary production testing |3 hours|10 claims| June 2024 |
|Phase 2A: 25% of users |7 days|25% of users (auth users only)|June 2024|
|Phase 2B: 50% of users |7 days|50% of users (auth users only)|July 2024|
|Phase 23: 75% of users |7 days|75% of users (auth users only)|July 2024|
|Phase 2D: 100% of users| indefinite | 100% users (auth and non-auth) | July 2024 |
