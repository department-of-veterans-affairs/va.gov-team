...
|Phase 2A: 25% of users |7 days|25% of users (auth users only)|TBD|
|Phase 2B: 50% of users |7 days|50% of users (auth users only)|TBD|
...
6. Udpated confirmation page to show submission status to Veteran.
