...
There are two forms related to the process of updating a Veteran’s dependents . One is the  Application Request to Add and/or Remove Dependents ([About VA Form 21-686c | Veterans Affairs](https://www.va.gov/find-forms/about-form-21-686c/))  and the other the Status of Dependents Questionnaire, (https://www.va.gov/find-forms/about-form-21-0538/) . The latter (0538) is sent to Veterans via mail once every 8 years to encourage them to fill out the former (686-c). 
