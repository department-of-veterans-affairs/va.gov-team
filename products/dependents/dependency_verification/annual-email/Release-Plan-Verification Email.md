...
# Release Plan: Dependent Verification Email (Template)
...
|----------------------------------|--------------------|----------|--------|
| Deliverability rate| Service Completion | 100%     | 20%    |
| KPI                              | Ease of Use        |          |        |
| KPI                              | Trust/Satisfaction |          |        |
| % of submission failures         | Form Health        | ?        | <1%    |
    
- Links to the dashboard(s) showing "success criteria" metrics: [FILL_IN] with link to dashboards (example: Google Analytics dashboard)
- Who is monitoring the dashboard(s)?: [FILL_IN] **ask at kick off 1/10**
