...
**Injection will only work for standard TeamSites, with some standard markup available.** The header/footer cannot be injected into other VA sites/CMSs.
...
1. **Requesting team: domains -** Team should provide the domain or list of domains where the users will land and see the header/footer injected. Once provided, the owners of the VA.gov header will generate an [Injected Header/Footer - prep for testing ticket](https://github.com/department-of-veterans-affairs/va.gov-cms/issues/new?assignees=jilladams&labels=Injected+header%2C+Needs+refining%2C+Public+Websites%2C+VA.gov+frontend&projects=&template=pw-injected-header.md&title=Injected+header%2Ffooter%3A+%3Cdomain%28s%29%3E).
...
3. **Header owners: allowlists** - Header owners will add the domains to several allowlists. This change will allow your team to test the injected header/footer. We'll let you know when our updates are deployed and your testing can begin. 
