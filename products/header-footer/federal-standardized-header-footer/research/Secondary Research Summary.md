...
![screenshot of prototype tested]([http://url/to/img.png](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/header-footer/federal-standardized-header-footer/research/images/MHV-study-auth-menu.PNG))
