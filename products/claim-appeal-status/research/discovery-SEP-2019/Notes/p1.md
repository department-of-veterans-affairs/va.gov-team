...
I live in [City, State]. It’s roughly 15 min from [Location]. Originally from [Location]. Wife’s from here, so obviously she won *laughs* so that’s why we went back up here after my medical retirement. My branch of service was Marine Corps. I was a [Position] and a [Position] and all the [Position]… I was [Position] but part of a very small unit in the Marine Corps.[Description of job duties] [Description of injuries] 
...
[Moderator is controlling screen]
...
I like it. View status, that’s beautiful. Excuse me for being perhaps ignorant, but when you do your claims is there claims for dependency as well? [Yes, there’s claims for compensation and claims for dependency. Two diff kinds.] 
...
[There could be other things to help you in Evidence Gathering, Review, and Decision?]
...
[We appreciate and respect that. This is the kind of stuff we’re looking for]

[Let’s say you want to add a file if you need to provide more information. How would you do that?]
...
[Is this what you’d expect to see if you clicked View details?]
