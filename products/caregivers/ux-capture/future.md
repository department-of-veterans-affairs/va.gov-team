...
|API|400|Bad Request|The front-end made an invalid request to the back-end.|(TBD)|
|API|401|Unauthorized|The user is not authenticated (or has an invalid csrf cookie).|(TBD)|
|API|403|Forbidden|The user is not authorized to make this request.|(TBD)|
...
|API|500|Internal Server Error|Something (on the back-end) went wrong processing this request.|(TBD)|
