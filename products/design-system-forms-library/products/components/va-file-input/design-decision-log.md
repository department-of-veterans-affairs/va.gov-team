...
### Consequences
Teams will need to leverage centralized platform utilities for handling encrypted and password protected files. If they require further cusomtization, they will need to implement their own solution.
