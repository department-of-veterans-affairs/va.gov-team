# Release Plan HLR Confirmation Page Updates 

## Release Plan Overview

| Phase | Duration | Users | Dates |
|---|---|---|---|
|Phase 1: Production release |indefinite | 100% users | Feb 3, 2025  |


## Overview
The HLR confirmation page has been updated to show all of the submitted form data to enable Veterans who print the page to see the choices and data they submitted to the VA. These changes are behind a feature toggle hlr_confirmation_update
...
| ----------- | ----------- |
| hlr_confirmation_update | This toggle enables the HLR Conf page updates |
