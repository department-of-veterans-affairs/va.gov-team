# Release Plan SC Confirmation Page Updates 
...
## Overview
The SC confirmation page has been updated to show all of the submitted form data to enable Veterans who print the page to see the choices and data they submitted to the VA. These changes are behind a feature toggle sc_confirmation_update
...
| ----------- | ----------- |
| sc_confirmation_update | This toggle enables the SC Conf page updates |
