...
# Research Plan for NOD Enhancement Validation

During post-launch evaluation of the Board Appeal form, the decision reviews team identified the following post-release enhancements to improve form usability and effectiveness. This effort seeks to validate the relevance, usability, and desirability of proposed enhancements.
...
## Research Goals
1. Gather feedback surrounding the relevance of usability of proposed enhancements.
2. Gather user feedback surrounding the comparative user value and desirability of proposed enhancements.

## Outcomes
Research findings will be used to validate the readiness enhancements for development and release. Comparative user value and desirability of enhancements will be used to inform prioritization for development and release.
## Research questions
...
* All participants must have Zoom installed on their devices before the session and be able to view screen-shared content.

### Screener
1. Did you receive a claims decision within the last year? [Yes/No: Must answer 'Yes']
2. Are you planning to appeal that claim decision? [Yes/No: Must answer 'Yes']
3. Which of the following decision review options are you considering to pursue? [Multi-select: Must include 'Board Appeal']
	* Supplemental Claim
	* Higher Level Review
...
* Moderators: [Ruben Sun](mailto:ruben@coforma.io) ,  [Eileen Chi](mailto:eileen.chi@coforma.io) (secondary)
* Research guide writing and task development: [Ruben Sun](mailto:ruben@coforma.io)
* Participant recruiting & screening: Perigean
* Project point of contact: [Ruben Sun](mailto:ruben@coforma.io)
* Participant(s) for pilot test: [ tbd ]
* Observers: [Eileen Chi](mailto:eileen.chi@coforma.io),  [Sade Ragsdale](mailto:sade@coforma.io)
