...
People expect links in the wizard and step list to open in a new tab, so they can return to where they were and don't need to start over. When navigating away from the intro page, participants said they'd use their back button to get back to the intro page. They expected to go back to where they were, not a restart of the wizard. 
