...
2. Participants recruited as screen reader users don't always use screen readers for all of their web browsing, and **none of the four people in this study used a screen reader at all during the research session**. We tried to test with screen reader users, but it didn't happen.
...
1. Everyone recruited to join the research session had an account on VA.gov, even if Perigean thought some didn't. They recruited 4 people who said they didn't have accounts, one was a no-show, and the other 3 told me that they already had accounts. 
...
1. Do more usability testing with participants who don't have an account on VA.gov. We'd like to get user feedback on the *Create account* button, which wasn't used in this study, presumably because all participants already had an account on VA.gov. See if there's any confusion after the button is selected, in particular with the modal that has "Sign in" at the top and "Create an account" farther down.
...
3. Do more usability testing with participants using screen readers. In order to get such participants who will use screen readers during the research session, add a screener question for future studies: *Do you use a screen reader every time you browse the web? (recruit only if "yes")* 
4. Do more research with participants using smartphones and/or check analytics to what proportion of people scroll past the top of the dark blue VA news promo section to see whether this might be a new "false footer" for some users.
