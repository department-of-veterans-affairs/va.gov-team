...
| Satisfaction score (dependent on the return of the feedback button to the current VA.gov homepage) | new homepage satisfaction scores are equivalent or better than existing page			|	_pending implementation of feedback on homepage_ | Critical  |
| Scroll depth | Measurement of engagement with content "below the fold" | Compared to level assessed during usability research | Baseline from user research = | Comparable | Critical
| Interactions with benefit hubs | Measurement of engagement with content "below the fold" | Compared to level assessed during usability research | Baseline from user research = | Comparable  |Important but not a deal breaker
