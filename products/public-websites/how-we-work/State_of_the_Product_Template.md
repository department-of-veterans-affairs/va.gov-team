...
Describe the problem here and include any relevant screen shots
...
The *Product Name* **is**:
 ...
 - Describe what the product is, provides, does (what is in scope).

The CLP is **not**:

 - Describe what the product is **not** (what is out of scope).
...
|[Name of API or Service](https://app.zenhub.com/workspaces/vsp-5cedc9cce6e3335dc5a49fc4/issues/department-of-veterans-affairs/va.gov-team/4621) | Documentation for X service used in product|Team that manages a particular API or service
|[Data Source](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/content/tier-2-content-IA-and-design/campaign-landing-page-templates/content-requirements-spec/CLP-Maximal-markup-updated-060320.pdf)| Names of database or other source of data |VA data owner, database manager
