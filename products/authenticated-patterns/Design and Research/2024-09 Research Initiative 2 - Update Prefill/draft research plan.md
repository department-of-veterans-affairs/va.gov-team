# Research Plan for AEDP Prefill Study #2
...
- Understand if users want or need a confirmation step before submitting forms with prefilled data.
...
*Goal 1: Understanding how users expect the prefilled data to display.*
...
- 50% of participants must be willing to join from their mobile devices for the study
...
|At least 5|Are willing to join from a mobile device|
...
- Note-takers: Christine Steiffer, Lynn Stahl
