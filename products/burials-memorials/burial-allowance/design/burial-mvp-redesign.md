...
## Problem
After interviewing Pension and Burial SMEs, we learned that the 527 Pension and 530 Burial forms are so outdated that after anyone submits those digital forms online, they receive a letter in the mail telling them that they need to start a new application on paper. 

## Solution
We decided to 1) deactivate both forms as soon as possible to solve this. [You'll be able to read more about our deactivation plan](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/pension/design/pension-burial-deactivation.md). And 2) Identify the missing fields and redesign the forms to include those fields as an MVP. 

Our stakeholders were concerned about deactivating the Burial benefits form, so it was decided not to deactivate it and to pivot our focus to redesigning it. 
