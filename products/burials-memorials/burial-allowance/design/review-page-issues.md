...
## Issue 3
A claimant can add multiple blank previous names the deceased Veteran served under, without having to enter a previous name first. This behavior is different than the same section in Step 3. On Step 3 you are not allowed to add additional names unless you add a name first.
...
#### Possible Solution
1) Once "Yes" is selected for the "Did the Veteran serve under another name?" question and new fields appear, delete the "Add another name" until "Update" has been clicked
2) Once "Add another name" is clicked, triggered inline errors
