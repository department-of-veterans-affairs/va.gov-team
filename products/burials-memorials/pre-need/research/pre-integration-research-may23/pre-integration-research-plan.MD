...
The goals of this user research are to: 
  ...
  * Understand if the pre-need application is confusing for users in the entering of their details, as information is collected for up to three people in the form (applicant, sponsor, preparer), and determine which enhancements could improve their overall user experience to mitigate confusion and reduce form entry errors
