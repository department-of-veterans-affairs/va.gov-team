...
2. "What was your experience like with that process? What worked well? *I looked online on the VA.gov and had to navigate and found some phone numbers and called. In this particular case, we picked online help the more right questions to ask than not and that mitigated the responses. Finding the initial person to talk was cumbersome but then it was okay. It was for my father, his service records were burned in a fire but I had digital records. I had a cope of his DD214 and it helped that I’m a Veteran myself to navigate through. 
...
*I would sign in or create an account and start application. 
*The honest answer would be I don’t know for the pre-need. 
---

## Action 1: Determining your relationship to the Veteran * I was looking for a spouse, but I clicked sponsor from what you said earlier. But I was looking for a spouse. Sponsor seems to be open wide. 


- Please indicate your relationship to the Veteran.

**Rating:**  
On a scale of 1 (very difficult) to 5 (very easy), how would you rate the ease of determining and selecting your relationship to the Veteran? * Probably a 2 to being hard. 

1. "Did any of the labels or terms confuse you?" *I just want to know the difference between. The Sponsor is the Veteran and the Spouse. What would be the difference between the sponsor and personal representative. 
2. "What did the label "personal representative" mean to you?" * Initial thought from a legal perspective is how I would take a first glance at this. I guess you can be both but it’s a little confusing unless I read and it’s explained. 
   
<mark>**[Record rating and comments here]**</mark>

> [!NOTE]
> Things to watch for: - Does participant understand all relationship options?
...
**Rating:**  
On a scale of 1 (very difficult) to 5 (very easy), how would you rate the ease of entering a Veteran service period? *5, it was pretty easy.
<mark>**[Record rating and comments here]**</mark>
...
> [!NOTE]
> Things to watch for:
> - Did the participant understand what was being asked? *I didn’t know but If I had the records, it would be the same thing. 
...
**Rating:**  
On a scale of 1 (very difficult) to 5 (very easy), how would you rate the ease of finding a preferred national cemetery? *Pretty easy, 5. 
<mark>**[Record rating and comments here]**</mark>
...
Things to watch for:
- Does participant understand they're selecting a specific cemetery? * I would click cemetery that it says here.
...
Post-task probe:
- "How would you know which cemetery to select?" *The request to the deceased, and if not, the one closest to family members. I think there would be a waitlist and have to consider but I would rather wait. 
*I don’t need to have a funeral home involved, but I can’t leave it blank. We had used a Church. 
*This might be for eligibility purposes; I have never seen that. 
...
-Would you want to review it? **I would want to click through it and review it. 
...
- "What do you think happens now after you submit the form?" *Contact by a way of email. Hard copy as well. Within days or weeks or hours get a response of ye or no, or they need more information. 
- "What part of the process felt most overwhelming or confusing?" *Just a little confusing, the spouse, sponsor and understood the definitions were down below. 
- "Were there any parts of this form that you found to be unclear? *No, everything straightforward. 
- "Compared to calling the VA or an in-person visit, how would this compare?" *If we are using the 5 point scale, I would give it a 4/4.5 point scale. 
...
- "Did the length or complexity of the form feel manageable?" *There were 10 steps, which were a lot, but they were easy high-level. Maybe get down to 7-8 steps. I’m just used to that, especially with the VA. What I don’t like, it answering something and then use the back arrow to get back 
- "Were there any questions that felt intrusive or insensitive?" *The criminal stuff, I would have to do the research on my own. I wonder if it would kick you out of eligibility. I don’t remember being asked that with my Dad. 
- "Would you feel comfortable completing this on your own, or would you want help or support?" * I would feel comfortable doing it myself. 
  - "What additional information, help, or support would have made this process easier for you?"
- "Is there anything you wish were available on this form or in the process?" * Just the part on cremation. More definitions on that. I had only seen a casket or cremation option before. 
