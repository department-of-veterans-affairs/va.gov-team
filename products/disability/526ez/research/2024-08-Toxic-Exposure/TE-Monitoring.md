...
| % of submissions that use normal path| 99.04% | ≤99.04%  | 99.72% | 99.51% | | | | | database queries |
| % of uses of backup path | 0.94% | ≤0.94% | 0.04% | 10% | | | | | database queries |
| % of complete failure | 0.0001% | ≤0.0001% | 0% | 0% | | | | | database queries |
