...
> "They're both fours, but as far as [both components], but the second one...does go into further detail and is more accurate....Not more accurate, but it just makes it easier… easier to see where you are.” - P11 (Mobile)

> “When will this be available?” - P5 (Mobile) 

> “Yeah, I wish this was this way when I did mine.” (Referring to the inclusion of the navigation component) - P4 (Desktop)

**Finding #2: All participants preferred the Process List because it provided more explicit progress indicators.**

- While both designs met core navigation needs, participants consistently favored the Process List because the “In Progress” and “Complete” labels (combined with supporting visuals such as the subway map and blue highlight) gave participants greater confidence in their current position in the form, how many steps they had completed, and which step they were currently on.
...
> “I'm working on something, it must be bold. Well, blue. It's not black, yeah...Light blue is finished.” - P5 (Mobile)
...
- When the navigation component was collapsed into an accordion on mobile, most participants could not determine their current step or overall progress without expanding it, requiring an additional action to understand where they were in the form. The collapsed accordion copy says “Select a step,” which does not convey progress or current location.
...
**Finding #5: After interacting with the navigation component, all participants understood why inactive steps were unavailable.**
- All participants understood that inactive steps could not be selected because they had not yet reached them. Some participants expressed wanting to skip ahead in the form, and at least one participant said it was better that users are not allowed to skip ahead to avoid missing steps.
...
> “It's not letting me click on the one that says Step 6. It doesn't allow me to do so.
 Why I think that is, it wants you to fill out these steps, and because you really can't review anything without providing information to the VA...they don't want you to move on to the last step, because…it's kind of like a moot point, because without internal information [there would be no information to review].” - P8 (Mobile)

**Finding #6: Some participants had difficulty navigating back to edit answers when navigation steps did not clearly map to individual pages.**
- Some participants’ ability to navigate back and edit answers was affected by a mismatch between the steps shown in the navigation and the multiple pages contained within each step, making it harder to identify where to return to change specific information.
- Participants relied on recall and trial-and-error navigation, using the “Continue” button to advance through pages in order to find the location where they wanted to edit information.
