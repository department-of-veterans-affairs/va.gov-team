...
| Make it easy to complete the form        | User satisfaction                                     | **CSAT Score** - (TBD)                                       | [Medallia Data](https://depo-platform-documentation.scrollhelp.site/analytics-monitoring/accessing-and-utilizing-contact-center-data#AccessingandUtilizingVeteranSupportData-AccessingMedalliaData) > "Satisfaction Score"        |
