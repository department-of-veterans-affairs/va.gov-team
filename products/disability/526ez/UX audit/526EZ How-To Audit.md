...
| **Step 2: Conditions**      |~☐ Main Path~ <br> ~☐ Toxic Exposure~ <br> ☐ Prisoner of War <br> ☐ Additional Disability Benefits <br> ~☐ Individual Unemployability~ | The Conditions section is currently being redesigned and developed. If you are a new team member, you will still need to interact with this section of the form. Feel free to record any general findings. If you are an experienced team member, do not conduct a bug or UX audit on the crossed out parts of this section. Individual Unemployability pathway is only present in staging and not active in production. Do not audit.  |             
