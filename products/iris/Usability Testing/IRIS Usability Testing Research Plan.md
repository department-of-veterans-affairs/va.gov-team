...
This draft is in progress.

## Goals	TO FINISH
1. What product & team are you doing this research for?	

This usability testing will be for the IRIS product, which is being done by the ThoughtWorks IRIS team.
...
We will work with Perigean to have the same existing usrs we worked with (the same recruiting contract) wherever possible.


## When?
1.	Timeline: What dates do you plan to do research? 	- TO FINISH
