...
| medical_copays_zero_debt    | [details](#medical_copays_zero_debt)                |        |  x  |     0%    |   0%   |     x      |         |
| debts_copay_logging         | [details](#debts_copay_logging)                     |        |  x  |     0%    |  50%   |     x      |         |
...
| ------------------------------------------- | ---------------------------------------------------------- | :----: | :-: | :-------: | :----: | :--------: | :-----: |
| show_financial_status_report                | [details](#show_financial_status_report)                   |   x    |  x  |    100%   |  100%  |      x     |         |
| show_financial_status_report_wizard         | [details](#show_financial_status_report_wizard)            |   x    |  x  |    100%   |  100%  |            |         |
| show_financial_status_report_streamlined_waiver | [details](#show_financial_status_report_streamlined_waiver) | x  |  x  |    100%   |  100%  |      x     |         |
| financial_status_report_review_page_navigation | [details](#financial_status_report_review_page_navigation) | x  |  x  |    100%   |  100%  |      x     |         |
| fsr_confirmation_email                      | [details](#fsr_confirmation_email)                         |   x    |     |           |        |      x     |         |
| fsr_5655_server_side_transform              | [details](#fsr_5655_server_side_transform)                 |   x    |  x  |    100%   |  100%  |      x     |         |
| financial_management_vbs_only               | [details](#financial_management_vbs_only)                  |        |  x  |     0%    |  100%  |      x     |         |
| fsr_zero_silent_errors_in_progress_email    | [details](#fsr_zero_silent_errors_in_progress_email)       |        |  x  |    100%   |   25%  |      x     |         |
| combined_financial_status_report            | [details](#combined_financial_status_report)               |        |  x  |    100%   |  100%  |      x     |         |
| financial_status_report_debts_api_module    | [details](#financial_status_report_debts_api_module)       |   x    |  x  |    100%   |  100%  |            |         |
| fsr_wizard                                  | [details](#fsr_wizard)                                     |   x    |  x  |    100%   |  100%  |            |         |
| financial_status_report_expenses_update     | [details](#financial_status_report_expenses_update)        |   x    |  x  |    100%   |  100%  |      x     |         |
| debts_silent_failure_mailer                 | [details](#debts_silent_failure_mailer)                    |        |  x  |    100%   |   25%  |            |         |
...
| ---------------------------------- | ----------------------------------------------- | :----: | :-: | :-------: | :----: | :--------: | :-----: |
| digital_dispute_email_notifications| [details](#digital_dispute_email_notifications) |        |  x  |    100%   |  100%  |     x      |         |
| digital_dmc_dispute_service        | [details](#digital_dmc_dispute_service)         |        |  x  |    100%   |  100%  |     x      |         |
| dispute_debt                       | [details](#dispute_debt)                        |   x    |  x  |    100%   |  100%  |     x      |         |
| digital_dispute_duplicate_prevention | [details](#digital_dispute_duplicate_prevention) |      |  x  |     0%    |   0%   |      x     |         |
