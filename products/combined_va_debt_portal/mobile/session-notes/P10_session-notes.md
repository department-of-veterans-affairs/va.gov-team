...
* Mobile over website: the mobile I do 2fa with finger so it is quicker, you can do everyone expect travel claims. It is comparable to the website. Theres a few things you can’t do but you can do almost everything form the phone. 
...
* Don’t yet click on anything: show me where to find what money you currently owe: I would think it would be under last payment or under the payments page. 
...
* Find what you currently owe for overpayment debts It is clear and what I would expect to see here. I don’t know how you would be overpaid for books but it is listed. Yeah it is pretty straight forward. 
    * How clear was that to find?
    * What can you tell me about the other debts on this screen?
* If a new debt arises, how would you expect to be notified? Um some type of on payments, a lot of apps when there’s an update there’s a red dot so like a dot or number above payments that you can see like a notification you can click and see the information. 
...
* Other reasons to reach out: I would want to call to talk to someone if I didn’t understand why there was an overpayment. 
...
* [point to a specific debt] What can you tell me about your activity here?
    ...
    * Tell me about the Debt Letter section – what do you assume this is and how useful is it? If you can click it and see the history. 
...
* What else would you want to do here with regards to your debt?
    ...
    * If this were to be built in real life, how likely would you be to use it? It gives me enough to go off of so I would use it. You don’t need to look to far. You know exactly what you are being deducted by. It is very convenient. 
...
* Now I'm going to have you [open another prototype](https://www.figma.com/proto/kRA7JHbthNrSLxTQHrzH8T/MFS---Overpayments---Copays-%7C-VA-Mobile?page-id=2001%3A429&node-id=7372-28070&p=f&viewport=24600%2C-1348%2C0.59&t=RzEWQo0ZfxtjJRxF-1&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=7372%3A28070&show-proto-sidebar=1) to view a different version.
    * Thoughts: you can review details so I think it would give me itemized information and you can resolve debt here so you can pay it off here. I would think you could get to a payment screen. I like pay online, other ways to pay, and request help. It simplifies the process. If I want to take care of this I can click resolve debt I can pay or other ways to pay or request help to see the help they can provide if I don’t have the money. 
    ...
    * Talk to me about that experience of starting to make the payment (e.g. opening .gov, new sign-in, copying payment + account info): I have never seen this before. For the veteran information, payee number, maybe this information on the link on the app, it should auto filled because I wouldn’t know the file number or payee number or deduction code. It should be auto filled for convenience. I don’t even think you can copy and paste from the app. The first/last name and number are standard so that is straightforward. 
    * If it didn’t auto fill but you had this, how would it be: I don’t think you can copy and paste in the app. I don’t think you can. I would have to switch screen and remember it and type it in and hope that when you go back and fourth that it doesn't start you over. 
    * After you’ve made a payment, what would you expect to see? When would you expect to see an update?  Some type of confirmation, an email that the payment has been processed and when I go look at the balance that is has been reduced. 
    * Did you know this was an option: No I did not know. 
    * If this were to be built in real life, how likely would you be to use it? Well if that’s the only option then I would go through the process if it was the most convenient option father than talking to someone on the phone. It’s convenient enough. 
...
* Now that we’ve gone through this section, do you have any other thoughts about what is here and how the information is presented? The only thing that could be confusing for individuals that haven’t seen it is the deduction codes but if you have had school benefits you should be aware of all of the information. If you were overpaid and know what program you are using. 
...
* What would you look for: once I click it, I don’t know if it doesn’t click if there was a way that there was a way to confirm you received or deny that you received it. 
...
* Lets do online: Okay. The account number it’s the same thing as before having to remember that number. You can copy that number and enter it in but I will say when you copy it and paste it, will it try to add it all into one cell or separate it into the separate cells. I know websites can do it but I have seen it done where you have to delete.
* Anything else to add or to mention that could be useful: So on this page for copays it doesn’t have the account, it doesn’t have the information so partial payment or you forgot the total so it should have the total amount owed and the amount you want to pay, that information on the payment page would be easier I guess. . 
