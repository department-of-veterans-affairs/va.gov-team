...
|5/14/2025| **Awaiting a decision** | We are still working to understand if notifications of copayments and overpayments will be included in the MVP. This is currently being blocked by discussions that Ryan Thurlwell is understanding a migration that is occurring with the VEText team. We should only consider implementing this if the FM team has their new Lighthouse API for copayments.| 
