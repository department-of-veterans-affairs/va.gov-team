...
We (VSP) don't have an automated way to troubleshoot or identity issues that individuals are encountering during development.  Our current process is manual, which often includes a specific set of initial troubleshooting tasks.
...
## Assumptions
- Developers will use a command line tool to troubleshoot over documentation.
...
- Design/Discovery sprint to identity the highest value least effort initial parts
- Prototype the initial tool
- Test prototype with teams
- Iterate
...
- Lead Developer: Keifer Furzland
