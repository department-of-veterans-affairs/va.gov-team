...
Laptop - User could not establish an audio connection, so the Chat option was used.
...
*   Are you aware of any options that va.gov offers for providing feedback on the website? 
    ...
    *   If **YES**:
        ...
        *   Have you ever used any of these options?
            *   Yes
        *   Why / why not?
            *   Charlyn has logged on to the Website many times to compliment the services he/she receives via the website. 
...
*   Were they able to find the form and open it?
    *   Ian displayed his screen for the user to see the form.  
    *   Try and note how quickly the found the button (quickly, not so quickly, looked in wrong spot, clicked on wrong button, etc)
...
*   What questions do you have about how to fill out the form?
    *   User indicated that the form is self-explanatory
*   Which questions do you think could be clarified?
    *   User indicated that the form is self-explanatory
*   Would you, personally, fill out this form?
    *   User indicated that they would “absolutely”  fill out this form
...
*   Which of these two buttons are you most likely to click on?
    *   The user would use the (Blue Button / White Font)
    *   Note: for desktop, write either “new button” or “old button” since the order changes. **Do not write Button A or button B, since that changes for every other test.**
...
*   Have there been any experiences you’ve had on VA.gov that would cause you to want to provide feedback?
    *   The user indicated that “I have been most pleased with my care.  all positive input
*   Who do you think is responsible for creating this feedback form?
    *   Not answered
    *   Note: trying to understand if they think VA is responsible for creating this form
*   What do you think happens after you submit feedback?
    *   The user indicated that “my feedback is sent to a dedicated clearing area for dissemination to my va site
