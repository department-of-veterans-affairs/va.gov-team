...
## Phase 1 — Pre-Release: Testing in Staging 

_VSP & VFS test a limited release in staging_

### Planning
- Desired date range: Week of July 20, 2020
- Desired number of users: 2 VSP users & 2 VFS users 
- How you'll recruit: will recruit VFS users based on people who have given us feedback on forms library changes in the past
- How you'll conduct the testing: Dan will write automated & manual test plan to use and share with VFS team members
- How you'll give the test users access to the product: feature toggle (flipper)
...
## Phase 2 — Pre-Release: Testing in Staging

_Release to all of staging_

### Planning
- Desired date range: Week of July 20, 2020
- Desired number of users: all VFS developers building forms in staging (~10 users)
- How you'll recruit: notify all teams in Slack that change has been released in staging and how to report issues
- How you'll conduct the testing: wait ~3 days for any issues to be reported; re-notify teams
