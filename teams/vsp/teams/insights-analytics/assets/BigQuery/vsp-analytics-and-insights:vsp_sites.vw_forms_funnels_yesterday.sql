/***************************************************************
Name:         vsp_sites.vw_forms_funnels_yesterday
Created:      2021-04-12
  ...
  SELECT
      ...
      FROM
          (
              ...
              INNER JOIN `vsp-analytics-and-insights.vsp_sites.forms` AS f ON (hits.page.pagePath LIKE CONCAT('%',f.step_link,'%') OR hits.eventinfo.eventLabel = f.step_link)
              WHERE
