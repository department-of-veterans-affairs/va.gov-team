...
- **Team Name:** Digital Notifications
- **Short Name:** digital-notifications _(Used for directory URLs and should ideally match your GitHub team name below)_
...
- **Slack Channel:** [#vetext-production-support](https://dsva.slack.com/channels/vetext-production-support), [#va-notify-public](https://dsva.slack.com/channels/va-notify-public)
...
> Directory system will cross-reference these with product details.yml files containing `team: "digital-notifications"`
