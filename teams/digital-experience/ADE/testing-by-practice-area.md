...
Written by the Shared Services accessibility team, 2021

> [!NOTE]  
> ADE will consider using or adapting this document as the need arises. We felt that it concisely summarized how different disciplines should test for accessibility, and may use it for reference.
