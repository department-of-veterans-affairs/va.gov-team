...
- [ADE Services](ade-services.md)

## How to contact ADE
- Reach out via Slack using @accessibility-de on [#accessibility-help](https://dsva.slack.com/archives/C8E985R32)
- [Sign up](https://calendly.com/platform-office-hours/accessibility-office-hours?preview_source=et_card&month=2025-12) for our weekly office hours on Zoom (Wed 3-4 pm ET)
- [Submit an intake ticket in GitHub](https://github.com/department-of-veterans-affairs/va.gov-team/issues/new?template=Accessibility-Digital-Experience-Intake-Ticket.md)
