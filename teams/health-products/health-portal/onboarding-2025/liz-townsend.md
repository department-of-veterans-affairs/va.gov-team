# My HealtheVet - Orientation Checklist for Liz Townsend, Mobile Engineer for the Medical Records team

Hi Liz, and welcome to the My HealtheVet portal team.  We're glad you're here!
...
If you have questions, don't hesitate to reach out to your OCTO practice lead, daniel.cloud@va.gov, mark.dewey@va.gov, adrian.rollett@va.gov or your OCTO product lead marci.mcguire@va.gov.
...
- [x] Schedule 15 min to meet with each [member of your assigned team](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/teams/health-products/health-portal/health-portal-team.md#product-team-members) (One meeting for all team members)



## General MHV Info 
- [x] [Read an overview of My HealtheVet](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/health-care/digital-health-modernization/product/product-brief.md)
...
- [x] Get to know the MHV products
...
- [x] [General orientation](https://depo-platform-documentation.scrollhelp.site/getting-started/orientation-sessions#Orientationsessions-GeneralOrientation)
...
## Orientation Part 2
- [x] Once you've completed the Part 1 checklist and have access to the VA network and Slack, let your marci.mcguire@va.gov know so you can get info for Part 2!
