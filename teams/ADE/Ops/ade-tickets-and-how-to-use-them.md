...
This section contains field data that is important for filtering and tracking issues within the ADE pipeline.[^4] 
- [Required Fields](#Required-Fields)
- [Additional Fields](#Additional-Fields)

[^4]: **Anchor links and collapsed sections:** Anchor links will not activate on a collapsed details section, unless it is expanded on the page. In this example, be sure to expand the collapsed details section "Expand to view descriptions of custom ticket fields." to activate the anchor links above it. 
...
- **Estimate**: The level of effort we think will be required for a ticket.
    - Level of effort is determined using basic t-shirt sizing, based on the time it would take to complete the work itself (not including waiting on SMEs or stakeholders, back and forth with OCTO, etc.):
        ...
        - **Originator/Team**:[The team or stakeholder that requested the work](https://github.com/orgs/department-of-veterans-affairs/projects/1597/settings/fields/164855280) [^7]
