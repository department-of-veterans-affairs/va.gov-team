# VA.gov Applications Slack Guidance 
...
* **Bookmarks.** You can save a message that you need to come back to. In order to see all saved messages, click on the bookmark icon in the top left corner of Slack. You can also star channels to surface them higher in your list.
...
* Asking questions about how components are used across the whole site
