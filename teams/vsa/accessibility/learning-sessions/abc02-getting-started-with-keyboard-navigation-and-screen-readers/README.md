...
* [PDF, 223kb](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/teams/vsa/accessibility/learning-sessions/abc02-getting-started-with-keyboard-navigation-and-screen-readers/abc02-getting-started-with-keyboard-navigation-and-screen-readers.pdf)
...
Now, you try! Using VoiceOver or NVDA (links for more info on these screen readers in [#resources](https://dsva.slack.com/channels/resources)) and your keyboard, experiment with the generic and semantic demos provided below. The third bullet is an article illuminating why taking the time for manual testing is critically necessary. 
