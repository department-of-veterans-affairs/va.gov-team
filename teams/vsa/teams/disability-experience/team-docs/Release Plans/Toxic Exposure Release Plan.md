...
| Phase | Description | Flipper Status - Percentage | Form in Progress | Visible Form |
|---|---|---|---|---|
|4 | Submit |Off - 0% | No | 2022 |
|5 | GetPDF |Off - 0% | No | 2022 |
|6 | New TE Applications |On | No | 2022 |
|7 | Veterans with an IPF |On | Yes | 2022 |
