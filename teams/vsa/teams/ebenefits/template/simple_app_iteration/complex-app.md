# "Complex Application" Product Template (iteration)
...
## Table of Contents
1. [Scaffold component structure for 1 new task](/simple_app_iteration/templates/scaffold-component-structure.md) (a task is a thing to be accomplished by a user, it can be more than one disparate step)
