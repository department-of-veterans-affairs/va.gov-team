...
- Team: Ensuring that we are able to establish the right metrics for each product we transfrom, and ask the question: what else can we improve while we migrate.
