...
- The varying references to the programs and forms (e.g. Personalized Career Planning and Guidance, CH36, 21-8832) threw some users
- All users went fairly quickly to the wizard and started answering questions; no prompting was needed
...
- The users who went to the CH31 wizard qualified on their own merits
- Many users found the language around timeframe ("the past year") ambiguous and wanted clarification
...
- No user encountered the CH31 link within the wizard
- Jumping from one wizard/form to the next seemed to disorient participants, though two understood they were taken to another page
...
- Once in the 28-8832 (CH36), users easily navigated to submission
...
- The communication options in the 21-1900 gave users pause because of the amount of explanatory text; all users went straight to the questions themselves
...
This did seem to be the case, only one participant clearly understood there were two wizards and forms from end-to-end. One saw there were two programs and forms, but opted to complete only the 19-8832 (CH36). And two users saw links to the 21-1900 (CH31) at the end, with just one following the link and applying for CH31 benefits.

#### The forms themselves will be very easy for users to complete
This proved true. Once the users made it into the two forms, they proceeded quickly and easily to submission. Paricipants were generally satisfied with the confirmation page, though some users wanted a different presentation or more details.
...
- Users were uniformly tripped-up by language around timeframes; e.g. the "have you been discarged in the last year" question in the wizard; users wanted to know if this meant 2019 or within the last 12 months
