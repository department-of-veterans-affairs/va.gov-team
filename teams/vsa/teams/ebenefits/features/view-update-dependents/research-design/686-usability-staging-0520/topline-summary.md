...
## Success
This research effort will be successful if:
·   	Users understand and accept the multi-purpose nature of the form
·   	Guidance (instructional text, headers, etc.)  users will need to support successful completion of the form is provided
·   	Users understand when additional information is required; and how to upload it
·   	Any problematic workflow combinations due to length and/or information detail required would be noted
 
 
## Research Questions & Answers
 **1. Are the form instructions clear and complete?**</br>
 ...
 **4. What are the "sticking points" in the various form workflows?**</br>
...
- Participants thought the form was long and redundant. 
  > Why did you say aww come one: There are more questions
 ...
 **5. What workflow combinations cause users problems?**</br>
- Participants struggled with determining what boxes to select  when adding more than one similar type of child to the workflow; 
  ...
  > If there is not a difference between a child and stepchild then there should be a difference in the wording and if there is not a difference then it should say any child in the household. And if there is a difference I could not claim either and id be done.
 ...
 **6. Will users understand when and how to upload additional documentation?**</br>
...
- Most participants were confused by the what to upload for a step/biological child.
  > How do you think the page could be improved: Allowing people to know that you need documentations for stepchildren or adopted would be nice whereas if they are biological you do not need paperwork.
...
- Was not able to be tested becuase staging would not allow applications to be submitted.
...
- One participant used a new device and no mouse and still completed a multi-purpose form within 2 mins
