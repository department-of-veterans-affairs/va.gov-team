...
- And next, do you need to add or remove a dependent from your disability claim? 
  ...
  - (Some workflows/situation require documenation) Since you need to X, you may need to upload documentation. Do you have this handy? 
  - (is there a provision for providing documentation after submittling the form?)
