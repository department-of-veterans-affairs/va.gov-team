...
| View Specially Adapted Housing Grant Status         | vsa-ebenefits | Not started | -- | -- | -- | ~~Requires Discovery, possible new LGY integration required~~ **(confirmed to be shelved)**
| Apply for Specially Adapted Housing Grant (4555)    | vsa-ebenefits | Not started | -- | -- | -- | ~~Requires Discovery, possible new LGY integration required~~ **(confirmed to be shelved)**
