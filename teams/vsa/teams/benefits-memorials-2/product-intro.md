...
#### Notes about this project:
 - Lives under new separate URL from original debt portal, now `/manage-debt-and-bills`
...
#### Intended Improvements/Next Steps:
- Increase load time of original fetch for all debt data if possible
</br>
</br>
</br>
</br>
 ...
 **Engineering:** 
 - [Architecture Diagram](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/Debt%20Resolution/Combined%20FSR%20Rough%20Draft.pdf)(WIP)
...
#### Notes about this project:
 - VHA and VBA FSR requests are delievered to separate external services (DMC for VBA and VBS for VHA)
 - VHA PDFs are generated by VA.gov API
 - VHA requests to be delivered via JSON to VBS and PDF to VHA SharePoint
