...
|-------------|---------------|-----------------|---------------|  ---------------|  ---------------|    ---------------| 
| QP1 | Establish One VA Debt Letter PDF in production| [#84175](https://github.com/department-of-veterans-affairs/va.gov-team/issues/84175) | Discovery | Legislative Requirement:Veterans Benefit Transition​ Act of 2018 ( year 7) |  March 2025 |In Progress - The accessibility requirements for this effort were more complex than expected, requiring addtional time and testing to meet required compliance. This work will continue and release in production in Q3.|
