...
|Project|Status|
|----|----|
|[My VA 2.0 redesign](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/identity-personalization/logged-in-homepage/2.0-redesign/README.md) | QA |
...
These are considered high priority because other teams are actively planning development and My VA is a dependency.
...
|Project|Initiating team|Date of request| Status/Notes|
|----|----|----|----|
|My VA: Post-launch updates and enhancements | Auth exp. | N/A | We'd like to continue making small, incremental updates to My VA based on analytics data and small experiments.|
