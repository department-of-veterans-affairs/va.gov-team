...
### Story
As an authenticated experience Team member, I want to be able to define what endpoints are being used to send to the frontend
...
### Story
As a member of the authenticated experience Team, I want to be utilize the endpoints so that data is dynamic and relelvenat to the end user
...
### Story
As a member of the authenticated exprience Team, I want to test both the components and the full page of the feature we are working on.
