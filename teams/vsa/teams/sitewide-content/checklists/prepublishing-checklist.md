...
- [ ] Make sure the correct primary article category and additional article categories are selected in the Drupal file
- [ ] Confirm the correct benefit hub contacts are selected in the Drupal file
- [ ] Confirm that the appropriate audience and topic tags are selected in the Drupal file
- [ ] Confirm action links repeat on the bottom of the page if it's a long article
- [ ] **For a single Q&A:** Check the standalone button
- [ ] **For multiple FAQs:** First publish each single Q&A and then publish the multiple FAQ

**After publishing a Resources and Support article, make sure to complete these steps:**</br>
