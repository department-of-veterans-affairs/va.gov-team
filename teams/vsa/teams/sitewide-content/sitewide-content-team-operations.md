...
**Note:** If the ask is urgent and it's a simple change (updating a link, changing a phone number or address, etc.) we don't need to send a preview link to the stakeholder before we publish. We can publish the change and send the stakeholder a link to the live page once the update is live.

[Read the document we've shared with stakeholders explaining the collaboration between Sitewide Content and benefit offices for updating VA.gov pages](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/teams/vsa/teams/sitewide-content/processes/Content-updates-Drupal-editorial-process-032521.docx) [We need to update some of the info in this, including content team members and the CMS content release times]
