WITH goal AS (
    (
        ...
        SELECT 6, 'www.va.gov/education/other-va-education-benefits/stem-scholarship/apply-for-scholarship-form-22-10203/benefits/program-details', 'Program Details' UNION ALL
        SELECT 7, 'www.va.gov/education/other-va-education-benefits/stem-scholarship/apply-for-scholarship-form-22-10203/active-duty', 'Active Duty' UNION ALL
        SELECT 8, 'www.va.gov/education/other-va-education-benefits/stem-scholarship/apply-for-scholarship-form-22-10203/personal-information/contact-information', 'Contact Information' UNION ALL
        SELECT 9, 'www.va.gov/education/other-va-education-benefits/stem-scholarship/apply-for-scholarship-form-22-10203/personal-information/direct-deposit', 'Direct Deposit' UNION ALL
        SELECT 10, 'www.va.gov/education/other-va-education-benefits/stem-scholarship/apply-for-scholarship-form-22-10203/review-and-submit', 'Review and Submit' UNION ALL
        SELECT 11, 'www.va.gov/education/other-va-education-benefits/stem-scholarship/apply-for-scholarship-form-22-10203/confirmation', 'Confirmation'
    )
),
sessions AS (
    SELECT
