_This file was originally located [here](https://github.com/department-of-veterans-affairs/va.gov-team/blob/899077a00b3c0a705d953570e4eadd8dca7fdf29/teams/benefits-portfolio/benefits-intake-optimization/staging-reviews/21p-0537/logging-silent-failures.md)_
...
To ensure no silent failures occur when submitting to the Benefits Intake API form 21P-0537 or 21P-601 will make use of the existing silent failure tracking mechanisms in the `simple_forms` API. This ensures that
