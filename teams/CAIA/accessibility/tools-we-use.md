...
* [Highlight VA web components](https://codepen.io/eli-oat/pen/VwgmLwd) - a bookmarklet that highlights web components from the VA design system. Useful for identifying known patterns.
