...
[As I mention in the Mural](https://app.mural.co/t/departmentofveteransaffairs9999/m/departmentofveteransaffairs9999/1692888741111/2474c0612887653142ab991d234898b6968dbf0e?wid=0-1695389761934), this is really an issue for the CAIA IA team to dive into, but I suggest that the "Find a Local Representative" flow be pulled into the larger form flow. If I understand this flow correctly, a Vet **must** pick find a representative in order to complete the form process. As such, I don't see a reason to separate these two flows out, as they are currently. It's really one big process - log in, find a rep, confirm your personal info, give authorization, download the PDF - and I think it'd be easier for Vets to understand if it was designed that way. (If I'm misunderstanding the process here, let me know!)
