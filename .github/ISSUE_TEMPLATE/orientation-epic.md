...
labels: analytics-insights, analytics-request, governance-team, platform-orientation, new-vfs-team-member
assignees: ''
...
- [ ] [Schedule a PM intro via Calendly](https://calendly.com/collaboration-cycle/product-manager-intro) with Shira Goodman (Platform Governance team PM) via 
