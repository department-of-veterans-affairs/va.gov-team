...
- [ ] Assign to your team
- [ ] Assign to the sprint milestone you are planning
- [ ] Delete these instructions

## Sprint XX Priorities <VFS Team Name>
1. List Sprint Prioties Per-Planning Discussion
...
### <Product/Initiative Name>
- [ ] [Design] Create XX #17XXX

### Intake Request - Techical Debt
- [ ] [FE] Create XX #17XXX

### Discussion Topics/Grooming <Team Grooming Items>
- [ ] Explore and revisit XX #18XXX

<details><summary>Collab Cycle Tracking Template</summary>
...
<details><summary>Kanban Board Template</summary>
...
Please tag <PM> on tickets when moved to **Done** section for validation and closeout.  Please connect if you have any questions or concerns in the interim.  Welcome to **VFS team** (for this sprint) we're excited to have the help.  
