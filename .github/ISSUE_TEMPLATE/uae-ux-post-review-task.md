...
- [ ] Receive feedback from ____
- [ ] Implement feedback
- [ ] Update ____ (Latest Designs page, MVP scope, design specs, etc.)
- [ ] Create follow-up tickets (could be UX or FE)

## AC
[//]: # (Add criteria that need to be completed to consider this task done. Remove any that you don't need)

- [ ] ___ has reviewed designs/content/etc.
- [ ] Feedback addressed
