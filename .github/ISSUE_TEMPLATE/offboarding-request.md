...
*Performed by Platform team*
 ...
 - [ ] AWS Access removed  (if applicable. Search their name in [AWS IAM](https://github.com/department-of-veterans-affairs/devops/blob/master/ansible/global/config.yml))
