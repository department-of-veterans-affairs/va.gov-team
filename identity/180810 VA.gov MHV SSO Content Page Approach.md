...
Specifically, the blue box near the center can be used to handle the different states of how a user could land on this page.  In summary, the following scenarios can be encountered:
