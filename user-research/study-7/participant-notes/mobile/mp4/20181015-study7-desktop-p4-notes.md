...
- What are some reasons you would visit a VA website today?
 - Mostly for medical appointments. Uses VA gov, right?
- Would you typically use your phone or a computer?
 - Use the phone usually. Has an iPhone.
...
- What are your impressions of this site?
 ...
 - Everything is open. Things that you need. Check out your claims, etc.
 - Didn't know I could pull up medical records.
- What do you think of the layout of this page?
 - For us people with glasses, it's spacious
 -
...
- You mentioned in the beginning that you would go online to schedule an appointment. How would you do this on the website?

*We are interested in watching the user’s approach.*

- *What path do they use, HP link, navigation, etc?*
 - Would go to health care.
 - Click on health care Hub (?)
 - Clicked on "Schedule Appointment"
...
- What do you think about the information on this page?
 - (Scrolling).
 - Can find anything about your health here, pretty much.
- *where would you go if you needed help*
 - Would click on the links. How to apply. Apply online. (Seems to be floundering a bit?)
 - Seems like when you get out of one link, the next link you get to has the info.
...
- Please take a look at the navigation options on [MOBILE: under the more in this section menu].  
 - Did not find the menu easily
...
- Would you use this menu to navigate the website?
 - Yes.
 - Would look for search if he couldn't find something.
 - Found search immediately at the top of the page.
...
- Where would you go on this page to login to your account?
 - "Same. Would go to the top"

- - *Prompt them to sign in if they can, if not use a production account to log them in*
 - "Oh wow, now there are three choices" (looking at login modal)
 - "Don't know what ID.me is. New to that one."
