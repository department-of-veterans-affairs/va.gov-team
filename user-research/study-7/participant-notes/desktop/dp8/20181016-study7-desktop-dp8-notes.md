# Preview.VA.gov - Desktop, 10-16-2018, P8
- African American, Male, 80s, (Bob. Used to go to Stan's in DC and worked upstairs)
- Moderator: Jeff Barnes
- Notes: Chris Johnston
...
- What are some reasons you would visit a VA website today?
 - Oh yah use it all the time.
 - Dot Gov. And then I use MHV for appointment status.
 - Also was trying to start a business and wanted to see what grants they offered.
...
- What are your impressions of this site?
 - Thrown off by Chrome.
- What do you think of the layout of this page?
 - Seems somewhat simple. The other one has a lot of choices and options and "tab downs"
...
- What do would you do if you were in crisis and looking for help on this website?
 ...
 - "I would look for a link"
 - "Then I would look for something that says help or crisis."
 - User does not see anything. User clicks on Health and Benefits megamenu.
 - User scrolls down page. Past Zone 1. Past zone 2. Down to footer.
 - Finally finds VCL in footer
- *Prompt to read through the banner*
- What do you think this means?
 - If you need help at 3am and you're depressed you call this number
- Do you find this information useful?
 - Of course. For someone that needs it, yes, yes.
...
- Where would you go on this page to login to your account?  
 - Immediately finds sign in. Clicks button
 - "That's good. MHV is right there"
 - Clicks MHV button
 - Signs in with his own credentials.
 - (Got error in pop up modal.)
 - Enters his own credentials
 - Is presented with ID.me option to link ID.me account
 - "I think it's linking my VA account to my email account"
 - Enters his email address and clicks continue
 - Presented with 2FA Modal
  - "Oh man"
 - Enters his cell phone number (reluctantly)
...
- You mentioned in the beginning that you would go online to [look at appointments]. How would you do this on the website?

*We are interested in watching the user’s approach.*

- *What path do they use, HP link, navigation, etc?*
 - From home page, went to megamenu
 - Clicked Schedule appointment
 - Went to landing page
 - Clicked appointments, opened MHV in new tab
 - Now on MHV page, but comments that it looks different (there is an error on the MHV appointments page)
 - Scrolls down, sees his actual appointments, says that is what he expected to see.
