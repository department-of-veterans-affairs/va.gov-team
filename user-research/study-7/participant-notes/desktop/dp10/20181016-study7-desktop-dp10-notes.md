# Preview.VA.gov - Desktop, 10-16-2018, P10
- Caucasian, Male, 60s?, Marine
...
- What are some reasons you would visit a VA website today?
 - Checked website before coming in today to confirm appointment (lives 3+ hours away)
...
- What are your impressions of this site?
 - I can refill my RX online. Schedule, great. Labs, wow.
 - Lab and test results? Is that XRays too?
 - DD214 as well.

- What do you think of the layout of this page?
- *If they don’t mention it, ask about the Veteran images*
 - Don't see any marines there. You got Navy Coast guard. Air Force. WWII Army Air Corp. Don't see any marines.


## Task 6 Veterans Crisis Line Modal

- What do would you do if you were in crisis and looking for help on this website?
 - Looked right past crisis line banner. Scrolls down. "Let's see, health care." Scrolls to Zone 2.
 - Found VCL button, pointed it out. Then kept scrolling.
 - Found it in the footer as well.
 - Eventually clicked on the button in Zone 2
...
- Where would you go on this page to login to your account?
 - Immediately finds Sign In button.
 - "This is a one stop shop, right?"
 - Modal opens. Clicks on MHV Sign In option.

- *Moderator uses a production MHV account to log in*
- How would you get to your account homepage?
 - Sees, clicks on "Test" (user name)
 - Chooses "My Account" to see his dashboard (Not MyVA)

- What were you expecting to see?
 - Scrolls through page. Looking at account settings.
 - Says he would go to "secure my account" -> story about identity fraud and his ex-wife
...
- You mentioned in the beginning that you would go online to [appointments]. How would you do this on the website?

*We are interested in watching the user’s approach.*

- *What path do they use, HP link, navigation, etc?*
- *if you were looking for your appointments, where would you go?*
 - Clicked "My Health" in top right of nav
 - Then View My Appointments in MHV menu
 - Sees all his appointments
 - Story: i have an appointment for next august in fayetteville; i don't like it in my phone, i put it in my day planner, i was a Marine Core Ops planner, so we put it on.....
...
- Misc
 - Clicked "Prosthetic Socks"
 - Clicked "Go To eBenefits" (not working yet)

- Did you notice the contact numbers [DESKTOP: on the right side of the page]? What do you think about this information?
 - Maybe call the help desk (MHV Help Desk). Get frustrated trying to reset a password.
...
- How did that compare to your past experiences with VA websites?
 - "It's a new screen. Would have to crawl, walk, run. Once I get used to something I can get into it. "
- If this website went live tomorrow, what would you want other Veterans to know?
 - "Tell everyone via phone or email, send them an email saying this is the new VA website"
 - "One source login for everything, so you don't have to remember all the passwords"
 - 
