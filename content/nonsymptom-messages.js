...
You can always use the **Start over** button to start again and choose a different topic.
`,

choose_question: `
Please choose the question that best fits your needs.
...
You can also cancel or reschedule your appointment.
`,
...
Our health facilities have been testing Veterans who meet the CDC's criteria. We don't charge a fee for testing.
`,
...
Work with the provider to reschedule. We're extending VA authorizations for community care referrals so you can continue to work with your provider to meet your needs during this time.
...
cant_call_clinic: `
We apologize if you can't get through or are on hold for a long time. We’re currently receiving a very high number of calls, and our staff is working hard to handle the increase.
...
- **Try health chat (limited availability).** You may be able to use our health chat if your primary VA health facility is part of the VA health chat pilot.
