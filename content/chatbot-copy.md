...
**Before we get started, do you have any of the symptoms listed below?**
- Fever
- Cough
- Shortness of breath

[6. If yes: Go to 4. Handoff for CDC Symptom Checker] <br>
...
2. Same question as in above section on "come back" language.
3. We may not even need the "Please choose" language here. It may just be obvious with the design.
